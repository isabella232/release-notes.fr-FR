...
| Fonctionnalité | Description |
| -----------| ---------- |
| Cadre de transparence et de consentement du RGMD | Advertising Cloud met à niveau sa prise en charge du Cadre de transparence et de consentement de l&#39;IAB vers la version 2.0 d&#39;ici le 15 août 2020. Pour le moment, aucun changement n’est nécessaire du côté client.  En tant que processeur de données pour chacun de nos clients, Adobe Advertising Cloud a les capacités disponibles pour les clients pour remplir leurs obligations en vertu du RMPD qui sont applicables à l&#39;utilisation de nos produits et services. |
| Intégration des Audiences Manager | (Version bêta pour les clients Adobe Audience Manager avec Adobe Experience Platform uniquement) DSP peut envoyer des fichiers journaux exploitables contenant les données d’engagement publicitaire d’un annonceur dans l’Audience Manager par le biais du Adobe Experience Platform. En Audience Manager, les publicitaires peuvent utiliser les données pour une segmentation avancée et une utilisation dans les outils d’informations, tels que les rapports d’Audience Optimization. |
| Ciblage graphique sur plusieurs périphériques basé sur les personnes | Les clients en libre-service DSP peuvent utiliser un graphique de périphériques (Adobe Device Co-op ou LiveRamp) pour le ciblage basé sur les personnes et la gestion des fréquences dans les nouvelles campagnes. Ainsi, les annonceurs peuvent atteindre leurs audiences sur leurs appareils, mais limiter leur exposition. En outre, la modification en masse des paramètres de ciblage sur plusieurs périphériques pour tous les emplacements est désormais disponible en version bêta. Pour activer la version bêta de votre compte, contactez votre gestionnaire de compte d’Adobe. |
| Ciblage de site | Les termes &quot;Listes bloquées&quot; et &quot;listes autorisées&quot; ont été renommés en termes plus équitables &quot;bloquées (sites)&quot; et &quot;ciblées (sites)&quot;. |
| Annonces Flash | DSP insère désormais automatiquement les macros de clic pour toutes les balises publicitaires Flash via les workflows de création de publicités uniques et tierces en bloc. |
| Rapports | (bêta pour les clients Adobe Experience Platform uniquement) Un nouveau rapport sur les Canaux croisés de Advertising Cloud Search fournit une vue unifiée des dépenses de médias pour DSP et Recherche, avec des mesures clés quotidiennes pour DSP emplacements et les campagnes de recherche. |
