...
| ----------- | ----------- | ---------- | ---------- |  
| 26 juin 2020 | [Explorer l’interface utilisateur d’Adobe Campaign Classic](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/getting-started/exploring-the-adobe-campaign-classic-user-interface.html?lang=fr) | Campaign Classic | Cette vidéo décrit l’interface utilisateur principale d’Adobe Campaign Classic et vous explique comment accéder à la fonctionnalité principale. |
