...
>[!NOTE]
>
>Abonnez-vous au [[!DNL Adobe Priority Product Update]](https://www.adobe.com/subscription/priority-product-update.html) pour être averti par e-mail de la publication des prochaines versions.
...
* [[!DNL Target]](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html?lang=en) (liens vers la page d’aide de Target)
* [[!DNL Magento]](#magento)
* [[!DNL Marketo]](#marketo)
...
Besoin d’aide ? Visite [[!DNL Adobe Experience League]](https://experienceleague.adobe.com/?lang=fr#home) pour trouver des cours organisés par l&#39;Adobe, de la documentation technique, des réponses rapides, des renseignements sur la communauté et une formation dirigée par un instructeur.
...
* [Prise en charge des attributs du client pour le CCPA](https://experienceleague.adobe.com/docs/core-services/interface/customer-attributes/ccpa.html) (California Consumer Privacy Act)
* [Prise en charge des attributs du client pour le RGPD](https://experienceleague.adobe.com/docs/core-services/interface/customer-attributes/gdpr.html) (Règlement général sur la protection des données)
...
* [Tutoriels vidéo](https://experienceleague.adobe.com/docs/platform-learn/tutorials/journey-orchestration/introduction.html?lang=fr)
...
Voir [À propos du suivi de l’état du lecteur](https://experienceleague.adobe.com/docs/media-analytics/using/player-state-tracking/player-state-overview.html?lang=fr).
...
| -----------| ---------- | ---------- |
| Migration vers un domaine de produit unifié | Date d’entrée en vigueur : 28 mai 2020 | La migration vers un domaine de produit unifié pour Adobe Analytics, débutée en janvier 2020, s’est terminée le 28 mai 2020. Pendant qu’Adobe Analytics s’emploie à supprimer toutes les `omniture.com` références de domaine à partir de son architecture, il est important d’autoriser `omniture.com` comme cookie tiers. Nous vous informerons via les notes de mise à jour dès que la migration complète de l’architecture sera terminée (bientôt). L’étape de liste d’autorisation ne sera ainsi plus nécessaire. [Ici](https://helpx.adobe.com/fr/analytics/kb/adobe-ip-addresses.html) est une liste complète des adresses IP et domaines recommandés que vous devez autoriser.<br>Si votre entreprise bloque les cookies tiers, contactez l’assistance clientèle pour récupérer l’accès à votre compte Adobe Analytics. |
...
| [Extension du mode sombre pour Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/customizing-the-ui/dark-mode-extension-for-analysis-workspace.html) | Activez l’extension Chrome Dark Reader pour rendre Analysis Workspace sombre. |
...
* [Notes de mise à jour d’AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html?lang=fr)
...
* [Version Adobe Campaign Standard 20.3](https://experienceleague.adobe.com/docs/campaign-standard/using/release-notes/release-notes.html?lang=fr)
...
* [Adobe Campaign Classic 19.1.4](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/previous-releases/release--19-1.html?lang=fr#release-19-1-4-build-9032)
...
| [Prise en main des notifications Push pour Android-Tutoriel](https://experienceleague.adobe.com/docs/campaign-standard-learn/getting-started-with-push-notifications-android/introduction.html?lang=fr) | Ce tutoriel explique les étapes nécessaires à la configuration des notifications Push avec Campaign Standard et Android App. |

* Nouveaux tutoriels Campaign Classic

| Contenu | Description |
| -----------| ---------- |  
| [Gestion de données importante sur Snowflake](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/administrating/fda/big-data-segmentation-on-snowflake.html?lang=fr) | Découvrez comment tirer parti du connecteur Snowflake dans Adobe Campaign Classic. |
