...
L’Adobe est en train d’ajuster la variable `same-site` la définition des cookies pour préparer les modifications apportées à Chrome dans Chrome 80 (qui sera publié en février 2020).
...
L’orchestration du parcours est désormais GA. [En savoir plus](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html?lang=en)
...
| Abandon de l’option **[!UICONTROL Exiger des restrictions d’identification par IP]** | 30 octobre 2019 | Annonce de l’abandon en janvier 2020 de la Liste autorisée IP (**[!UICONTROL Exiger des restrictions d’identification par IP]**) sous le **[!UICONTROL Admin > Paramètres de la société > Sécurité]** . |
...
* **AEM Desktop App 2.0.1.1**
   ...
   * [Notes de mise à jour](https://experienceleague.adobe.com/docs/experience-manager-desktop-app/using/release-notes.html?lang=en)
