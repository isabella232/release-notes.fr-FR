...
| Fonction | [Disponibilité générale](https://docs.adobe.com/content/help/en/analytics/landing/an-releases.html) - Date cible | Description |
| -----------| ---------- | ---------- |
...
* **Accessibilité et directives WCAG 2.1**
   ...
   * [Adobe Experience Manager as a Cloud Service et directives d’accessibilité Web](https://docs.adobe.com/content/help/fr-FR/experience-manager-cloud-service/onboarding/accessibility/web-accessibility.html)
