...
* [[!DNL Primetime]](https://experienceleague.adobe.com/content/help/en/primetime/release-notes/home.html) (liens vers la page d’aide de Primetime)
...
* [Notes de mise à jour d’Experience Platform Launch](https://experienceleague.adobe.com/content/help/en/launch/using/intro/release-notes/current.html)
...
Pour obtenir les dernières mises à jour de la version, consultez les [Notes de mise à jour de Journey Orchestration](https://experienceleague.adobe.com/content/help/en/journeys/using/release-notes/release-notes.html)
...
| Fonction | [Disponibilité générale](https://experienceleague.adobe.com/content/help/en/analytics/landing/an-releases.html) - Date cible | Description |
| -----------| ---------- | ---------- |
...
* **AEM 6.5.5.0**
   ...
   * [Notes de mise à jour](https://experienceleague.adobe.com/content/help/en/experience-manager-65/release-notes/service-pack/sp-release-notes.html)
...
* **AEM as a Cloud Service**
   ...
   * Outils de transition destinés à la prise en charge de l’accélération dans le cloud.
   ...
   [Notes de mise à jour d’AEM as a Cloud Service 2020.6.0](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html)
...
* **Accessibilité et directives WCAG 2.1**
   ...
   * [Adobe Experience Manager as a Cloud Service et directives d’accessibilité Web](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/onboarding/accessibility/web-accessibility.html)
   * [Guide rapide relatif à WCAG 2.1](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/onboarding/accessibility/quick-guide-wcag.html)
   * [Création d’un contenu accessible (conformité WCAG 2.1)](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/sites/authoring/fundamentals/accessible-content.html)
...
| [Structure de projet AEM](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/implementing/developing/aem-project-content-package-structure.html) | Article | Décrit les modifications requises pour les projets Maven d’Adobe Experience Manager afin qu’ils soient compatibles avec AEM Cloud Service. |
...
| [Génération de documents par lots](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/forms/interactive-communications/batch-generation-interactive-communications.html) | Article | Apprenez à utiliser l’API Batch pour produire plusieurs communications interactives à partir d’un modèle. |
| [Création d’un document de canal d’impression dans AEM Forms](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/forms/ic-print-channel-tutorial/introduction.html) | Article | Découvrez les étapes nécessaires à la création d’une communication interactive pour le canal d’impression. |
...
| [Rendu For Placement Only pour AEM Assets](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/assets/adobe-asset-link/for-placement-only.html) | Tutoriel vidéo | Découvrez comment créer et utiliser un rendu FPO (For Placement Only) pour AEM Assets. |
| [Placer une copie](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/assets/adobe-asset-link/place-copy.html) | Tutoriel vidéo | Découvrez comment utiliser les ressources d’AEM Assets à l’aide de l’opération Placer une copie. |
| [Téléchargement et chargement](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/assets/adobe-asset-link/download-and-upload.html) | Tutoriel vidéo | Découvrez comment télécharger et charger des fichiers de ressources depuis et vers AEM Assets à l’aide du panneau Asset Link. |
| [Fichiers et collections](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/assets/adobe-asset-link/files-and-collections.html) | Tutoriel vidéo | Découvrez comment accéder rapidement et facilement aux fichiers et collections d’AEM Assets à partir du panneau Asset Link. |
| [Télécharger](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/assets/sharing/download.html) | Tutoriel vidéo | Découvrez comment télécharger des ressources et leurs rendus sur votre ordinateur local pour les utiliser et les partager. |

### Ressources supplémentaires

* [AEM en tant que Cloud Service](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/landing/home.html)
...
* [Notes de mise à jour de Dynamic Media](https://experienceleague.adobe.com/content/help/en/dynamic-media-developer-resources/release-notes/s7rn2017.html)
...
La [version Adobe Campaign Classic 20.2](https://experienceleague.adobe.com/content/help/en/campaign-classic/using/release-notes/latest-release.html) comprend :
...
* Panneau de contrôle Campaign : [Surveillance des profils actifs](https://experienceleague.adobe.com/content/help/en/control-panel/using/performance-monitoring/active-profiles-monitoring.html)
