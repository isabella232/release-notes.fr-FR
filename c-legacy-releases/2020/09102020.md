...
| 17 août 2020 | [Cours d’introduction Prise en main d’Adobe Experience Platform pour les architectes des données](https://video.tv.adobe.com/v/39477) | Vidéo | Cette vidéo présente un aperçu du cours [Prise en main d’Adobe Experience Platform pour les architectes des données](https://experienceleague.adobe.com/?recommended=ExperiencePlatform-D-1-2020.1). |
...
| 28 août 2020 | [Présentation du cours - Attribution de valeur aux points de contact numériques dans le parcours client](https://video.tv.adobe.com/v/39380) | Vidéo | Dans cette vidéo d’introduction, découvrez les conditions préalables et le contenu du cours [Attribution de valeur aux points de contact numériques dans le parcours client](https://experienceleague.adobe.com/?recommended=Analytics-U-1-2020.2). |
...
| 13 août 2020 | [Cours d’introduction - Création et stratégies de segments d’audience](https://video.tv.adobe.com/v/39091) | Vidéo | Dans cette vidéo, découvrez ce qui vous attend dans le cours Création et stratégies de segments d’audience. |
...
* **Invalidation du cache CDN dans [!UICONTROL Dynamic Media]**
   ...
   Voir [Invalidation du cache CDN à l’aide de [!UICONTROL Dynamic Media].](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/assets/dynamicmedia/invalidate-cdn-cache-dynamic-media.html)
...
| 17 août 2020 | [Configuration de l’accès à AEM](https://video.tv.adobe.com/v/39230) | Vidéo | Découvrez comment les utilisateurs s’authentifient à l’aide d’Adobe IMS pour [!UICONTROL AEM as a Cloud Service], et comment les utilisateurs, [!UICONTROL groupes d’utilisateurs] et [!UICONTROL Profils de produits] Adobes IMS sont utilisés pour contrôler l’accès à AEM et à ses fonctions et fonctionnalités. |
...
| 17 août 2020 | [Configurer AEM Assets pour les administrateurs](https://video.tv.adobe.com/v/37647) | Vidéo | Dans cette vidéo, les administrateurs peuvent en savoir plus sur la configuration d’[!UICONTROL AEM Assets]. |
...
* [Notes de mise à jour d’AEM 6.4 Cumulative Fix Pack](https://docs.adobe.com/content/help/en/experience-manager-64/release-notes/cfp-release-notes.html)
...
* [Notes de mise à jour d’AEM Brand Portal](https://docs.adobe.com/content/help/en/experience-manager-brand-portal/using/introduction/brand-portal-release-notes.html)
* [Notes de mise à jour de l’application de bureau AEM](https://docs.adobe.com/content/help/en/experience-manager-desktop-app/using/release-notes.html)
