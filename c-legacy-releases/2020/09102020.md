...
Voir [Statut d’Adobe - 21 mai 2020](https://experienceleague.adobe.com/content/help/en/release-notes/experience-cloud/previous/2020/05212020.html#status) pour obtenir les dernières informations de mise à jour.
...
* [Destinations](https://experienceleague.adobe.com/content/help/en/experience-platform/release-notes/latest.html#destinations)
* [Sources](https://experienceleague.adobe.com/content/help/en/experience-platform/release-notes/latest.html#sources)
...
* Version d’août - [En savoir plus](https://experienceleague.adobe.com/content/help/en/journeys/using/release-notes/release-notes.html#august-release)
...
| Publication | Nom | Type | Description |
| -----------| ---------- | ---------- | ---------- |
| 10 août 2020 | [Utilisation des événements de qualification de segment](https://experienceleague.adobe.com/content/help/en/journey-orchestration-learn/tutorials/using-segment-qualification-events.html) | Vidéo | Cette vidéo présente brièvement comment créer un parcours avec un événement de [!UICONTROL qualification de segment] comme point d’entrée ou de sortie. |
...
| ----------- | ---------- | ------- |
| [!UICONTROL Analyses entre appareils] : disponibilité dans les zones EMEA et APAC | 31 août 2020 | [Les analyses entre appareils](https://experienceleague.adobe.com/content/help/en/analytics/components/cda/overview.html) et les graphiques privés sont disponibles pour les clients des zones EMEA et APAC. |
...
AEM 6.4, Service Pack 8, Cumulative Fix Pack 2 (6.4.8.2 publiée le jeudi 3 septembre 2020) est une mise à jour importante qui inclut plusieurs correctifs internes et clients depuis la disponibilité générale d’AEM 6.4, Service Pack 8 (6.4.8.0), mars 2020.
   * [Notes de mise à jour](https://experienceleague.adobe.com/content/help/en/experience-manager-64/release-notes/cfp-release-notes.html)
...
* **[!UICONTROL AEM as a Cloud Service]**
   ...
   * Possibilité dans [!UICONTROL AEM as a Cloud Service] de [restaurer les pages et les sous-pages (arborescences de page) dans une version antérieure](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/sites/authoring/features/page-versions.html#reinstating-versions).
   * Le transcodage vidéo est désormais pris en charge avec les micro-services de ressources, avec une nouvelle section [!UICONTROL Vidéo] dans l’écran [!UICONTROL Profils de traitement] qui prend en charge la configuration du débit et des dimensions vidéo (le format de sortie est MP4 avec le codec H.264). Pour plus d’informations, voir [gérer les ressources vidéo.](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/assets/manage/manage-video-assets.html#transcode-video) Pour d’autres options de transcodage et la diffusion vidéo, vous pouvez utiliser le module complémentaire [!UICONTROL Dynamic Media].
...
Voir [Test de l’audit du contenu.](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/implementing/using-cloud-manager/test-results/content-audit-testing.html)
   ...
   * Voir les [notes de mise à jour d’AEM as a Cloud Service.](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html)
...
* **[!UICONTROL Application de bureau] Experience Manager 2.0.3.2**
   ...
   * Voir les [notes de mise à jour.](https://experienceleague.adobe.com/content/help/en/experience-manager-desktop-app/using/release-notes.html)
...
* **AEM [!UICONTROL Assets Brand Portal]**
   ...
   * Voir les [notes de mise à jour.](https://experienceleague.adobe.com/content/help/en/experience-manager-brand-portal/using/introduction/brand-portal-release-notes.html)
...
* Version 20.2.2 - [En savoir plus](https://experienceleague.adobe.com/content/help/en/campaign-classic/using/release-notes/latest-release.html#release-20-2-2-build-9180)
...
| ----------- | ----------- | ---------- | ---------- |
| 10 août 2020 | [Affinage des cibles en combinant les résultats des requêtes](https://experienceleague.adobe.com/content/help/en/campaign-classic-learn/tutorials/automating-with-workflows/refining-targets-by-combining-query-results.html) | Campaign Classic | Découvrez comment affiner votre cible en combinant les résultats des requêtes dans un workflow à l’aide de l’intersection ou des activités d’union. |
| 10 août 2020 | [Utilisation de l’activité de mise à jour de liste pour créer une liste avec un workflow](https://experienceleague.adobe.com/content/help/en/campaign-classic-learn/tutorials/automating-with-workflows/using-the-update-list-activity.html) | Campaign Classic | Découvrez le concept de listes dans Adobe Campaign Classic et comment créer une liste à l’aide de l’activité de mise à jour de liste dans un workflow. |
