...
* [[ !DNL Analytics]](#analytics) **(changement de date de publication - voir mise à jour le 15 avril)**
* [Audience Manager](#aam)
* [Experience Manager](#aem)
* [[!DNL Campaign]](#ac)
* [[ !Cible DNL]](https://docs.adobe.com/content/help/fr-FR/target/using/release-notes/target-release-notes.html) (liens vers la page d’aide de la Cible)
* [[!DNL Magento]](#magento)
* [[ !DNL Marketo]](#marketo)
