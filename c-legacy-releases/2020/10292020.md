...
Voir les [notes de mise à jour Experience Platform Launch](https://experienceleague.adobe.com/docs/experience-platform/tags/release-notes/current.html), pour plus d’informations sur Platform Launch.
...
* **AEM as a Cloud Service**
   ...
   * **Cloud Readiness Analyzer**
      ...
      * Cloud Readiness Analyzer (CRA) dispose d’une console d’état de démarrage qui affiche un bouton **[!UICONTROL Générer un rapport]** explicite que l’utilisateur peut sélectionner pour exécuter CRA.
