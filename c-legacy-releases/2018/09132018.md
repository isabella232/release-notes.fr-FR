...
Notes de mise à jour concernant l’interface d’Experience Cloud et les services principaux. Inclut [!UICONTROL Mobile] Services, Launch by Adobe, Dynamic Tag Management, l’API RGPD et le service Experience Cloud ID.
...
Nouvelles fonctionnalités et correctifs de [!DNL Adobe Experience Cloud] l&#39;interface, y compris [!UICONTROL les ressources], [!UICONTROL flux], [!UICONTROL notifications]et services principaux [!UICONTROL People] .
...
Date d&#39;ajout : 9 août 2018

Le 6 août 2018, Adobe a annoncé la prochaine fin de vie d’Ad Hoc Analysis, dont la date sera communiquée dès que possible. Pour obtenir de plus amples informations, voir le site [Discover Workspace](https://spark.adobe.com/page/S9Bhp66VJ2fEn/).
...
Date d&#39;ajout : 21 septembre 2017
...
Pour configurer les intégrations oAuth, le service de passerelle E/S d’Adobe est disponible à l’adresse [https://legacy-oauth.cloud.adobe.io](https://legacy-oauth.cloud.adobe.io/).

Adobe a retiré le service de l’adresse [https://marketing.adobe.com/](https://marketing.adobe.com/).
