...
* Correction d’un bogue en raison duquel le service Experience Cloud ID définissait incorrectement un cookie AMCV sur des domaines sans le point au début lorsque [!DNL  visitor.cookieDomain] comportait un point au début. Par exemple, un cookie [AMCV doit](https://marketing.adobe.com/resources/help/en_US/whitepapers/cookies/cookies_mc.html) [!DNL  sampledomain.com][!DNL  .sampledomain.com]être défini. (CORE-10634)
