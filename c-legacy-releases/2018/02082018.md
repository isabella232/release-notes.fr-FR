...
<table id="table_519893D8565A4D489CB13D5EAF1E9325"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Désaffectation <span class="wintitle"> Cible </span> workflows dans <span class="uicontrol"> Mobile </span> Services </p> </td> 
     <td colname="col2"> <p> À compter de mars 2018, dans le cadre de la désactivation des workflows <span class="wintitle"> Cible </span> de l'Adobe <span class="uicontrol"> Mobile </span> Services, la possibilité de créer de nouvelles Cibles/Activités, Cibles/Audiences et Cible/Contenu a été désactivée dans cette version. </p> <p> Vous pouvez continuer à consulter, modifier et supprimer les activités, les audiences et le contenu existants jusqu’à mars 2018. </p> <p>Pour plus d’informations, voir <a href="https://docs.adobe.com/content/help/en/mobile-services/using/home.htmlc_mob_remove-target-faqs.html" format="html" scope="external"> Workflows de désaffectation de Cible dans Mobile Services </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col02"> <p>8 février 2018 </p> </td> 
   <td colname="col2"> <p>Une modification apportée au mécanisme de recherche (système principal) va se répercuter de plusieurs façons sur le reporting. Veuillez noter que ces modifications entreront en vigueur vers la <b>fin février 2018</b> : </p> 
...
* API DCS : Nous avons ajouté un nouveau code d’erreur : 198 - Les demandes de ce pays sont bloquées par le partenaire. Pour en savoir plus, consultez la [Référence API DCS](https://docs.adobe.com/content/help/fr-FR/audience-manager/user-guide/api-and-sdk-code/dcs/dcs-api-reference/dcs-error-codes.html).
