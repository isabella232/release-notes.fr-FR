...
* Correction d’un problème empêchant l’utilisation du sélecteur de ressources sur les appareils tactiles hybrides. (CORE-9932)
* Ajout de la carte Auditor à l’interface utilisateur Activation pour les utilisateurs configurés. (CORE-3667)
...
<table id="table_519893D8565A4D489CB13D5EAF1E9325"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Désactivation des processus [!DNL Target] dans [!UICONTROL Mobile] </p> </td> 
     <td colname="col2"> <p> À compter de mars 2018, dans le cadre de la désactivation des processus Adobe [!DNL Target] dans Adobe [!UICONTROL Mobile] Services, cette version ne prendra plus en charge la création d’activités, d’audiences et de contenu [!DNL Target]. </p> <p> Vous pouvez continuer à consulter, modifier et supprimer les activités, les audiences et le contenu existants jusqu’à mars 2018. </p> <p>Pour en savoir plus, voir <a href="https://marketing.adobe.com/resources/help/en_US/mobile/c_mob_remove-target-faqs.html" format="html" scope="external">Désactivation des processus [!DNL Target] dans Mobile Services</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Correction de problèmes mineurs liés à des données incorrectes dans les rapports pour certains messages push et liens marketing.

Pour accéder à la documentation du produit, voir [Services d’Adobe Mobile](https://marketing.adobe.com/resources/help/en_US/mobile/) pour obtenir accéder à la la documentation du produit. Pour afficher les notes de mise à jour des versions précédentes, développez *Notes de mise à jour précédentes* dans le volet gauche.
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col02"> <p>8 février 2018 </p> </td> 
   <td colname="col2"> <p>Une modification apportée au mécanisme de recherche (système principal) va se répercuter de plusieurs façons sur le reporting. Veillez à ce que ces modifications soient mises en œuvre d’ici <b>fin février 2018</b> : </p> 
    <ul id="ul_7515E2E79FD94B8F8DFF4C2DBB9E6A84"> 
     ...
     <li id="li_C699A0328CFD4AC4839C481710FE29AA"> Les données de page ou de props d’avant janvier 2007 environ (2006 dans certains cas) ne seront pas prises en charge. Seuls les pages, props et événements de page seront concernés (c.-à-d. les liens personnalisés, les liens de sortie et les liens de téléchargement). <p>Remarque : Cette modification n’a aucune incidence sur le reporting dans [!UICONTROL Analysis Workspace] ou dans l’entrepôt de données. </p><p>Si vous avez des données antérieures à ces dates, attendez-vous à ce qui suit : </p> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Cliquez sur « Nouveau projet » pour ouvrir un nouvel écran vous permettant de démarrer à partir : </p> 
    <ul id="ul_FE90E6B9AF334A029D66A43901F8FA0B"> 
     ...
     <li id="li_23BD391D68674C299858A97BFE10598B">d’un modèle Workspace intégré ; </li> 
  ...
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Prise en charge du clic droit pour la copie </p> </td> 
   <td colname="col2"> <p>Nous avons ajouté une option « Copier dans le Presse-papiers » accessible par clic droit vous permettant de copier des cellules/tableaux. <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/t_freeform_project.html" format="html" scope="external"> Plus... </a></p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>L’application d’une mise en forme conditionnelle (couleurs, etc.) dans les tableaux à structure libre est désormais activée automatiquement sur les ventilations, sauf si les limites « personnalisées » sont sélectionnées. <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/column-settings.html" format="html" scope="external"> Plus... </a></p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Multiplie la précision du suivi des publicités par 10 lorsqu’un utilisateur cesse de regarder une publicité avant la fin. </p> <p>Avant cette mise à jour, vous pouviez perdre jusqu’à 10 secondes de suivi de la lecture des publicités lorsqu’un utilisateur fermait le lecteur avant la fin de la publicité. Grâce à la granularité du suivi des publicités d’une seconde, vous ne perdez qu’une seconde maximum de suivi de la lecture des publicités. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p> </p> </td> 
   <td colname="col1"> Amélioration de la gestion des états et de la récupération des erreurs du lecteur </td> 
   <td colname="col2"> <p>Ajout d’une logique supplémentaire pour une meilleure gestion des états du lecteur et la garantie de mesures précises, notamment l’identification de l’état fermé. </p> <p>Un lecteur peut désormais indiquer immédiatement qu’une session a pris fin lorsqu’un utilisateur ferme la session avant la fin du contenu. Avant cette mise à jour, l’abandon précoce d’une session était déterminé par un délai d’inactivité de 10 minutes au cours duquel aucune pulsation n’était reçue. </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_2F22339DDE4C475F89B53D0E6FF33183"> 
      <li id="li_687D8507130D4EDEAF6AA816673477EE">Correction de problèmes en raison desquels les paramètres de largeur de colonne d’un tableau à structure libre étaient réinitialisés à leur valeur par défaut après leur enregistrement. (AN-156105, AN-155806, AN-156093) </li> 
      <li id="li_2C28D135394C4B3599E0262BDE761ED5">Correction d’un problème en raison duquel </li> 
      <li id="li_74F93C3EAD7A4A75B966F906C8395212">Correction d’un problème en raison duquel il était impossible de télécharger ou d’envoyer des fichiers PDF par courrier électronique dans certaines situations. (AN-155892) </li> 
      <li id="li_0DF1D76CE5AB4C40A8237300A13CC2BD">Correction d’un problème en raison duquel certaines valeurs de dimension étaient affichées comme « inconnues » lors de l’extraction des données avec une période différente dans les tableaux à structure libre. (AN-153597) </li> 
      ...
      <li id="li_3527347040424B5FB3FE7B7A5000D07F">Correction d’un projet en raison duquel la mise en forme était parfois incorrecte sur certains graphiques en barres. (AN-151452) </li> 
      <li id="li_49BF61697F6449BA80DAD50BB9F501F7">Correction d’un problème en raison duquel de nouvelles visualisations (créées par clic droit) s’affichaient sous le tableau, plutôt qu’au-dessus. (AN-156533) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_D26E3F16A12846FBB46033D57441E574"> 
      <li id="li_9CBEBD1F35094705A89373140DC1991E">Correctifs de stabilité : améliorations mineures des performances des SDK. </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_EB8261E817054C2F8B17C09D16DB3412"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Gestion des utilisateurs dans Admin Console </p> </td> 
   <td colname="col2"> <p> <b>Outil de migration des ID utilisateur</b> </p> <p>La migration des ID utilisateur Analytics permet aux administrateurs de migrer facilement les comptes utilisateurs de la gestion des utilisateurs Analytics vers Adobe Admin Console. Une fois la migration de vos utilisateurs terminée, ils auront accès aux solutions et aux services principaux disponibles dans Experience Cloud. La migration s’effectuera par roulement pour les utilisateurs, plus tard dans le courant du mois. </p> <p> <a href="https://marketing.adobe.com/resources/help/en_US/experience-cloud/admin-console/analytics-migration/" format="https" scope="external">En savoir plus sur la migration des ID utilisateur Analytics</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Prise en charge des ID d’appareil pour les destinations AdCloud dans les audiences adressables </p> </td> 
   <td colname="col2"> <p>Les clients [!DNL Audience Manager] peuvent désormais activer les audiences basées sur les ID d’appareil dans les mêmes destinations Adobe AdCloud que celles configurées pour les audiences de cookies. Cette amélioration permet une expérience optimisée pour l’utilisateur final en éliminant la nécessité de mapper manuellement chaque audience mobile à un ensemble supplémentaire de destinations AdCloud. </p> <p>N’oubliez pas que les audiences adressables affichent uniquement le chevauchement entre les ID de cookie et les destinations, ce qui pourrait entraîner des taux de correspondance faibles. Pour en savoir plus, voir <a href="https://marketing.adobe.com/resources/help/en_US/aam/addressable-audiences-match-rates.html" format="https" scope="external">Causes des taux de correspondance faibles pour les audiences adressables </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Nous avons amélioré le temps de chargement dans l’interface utilisateur lors de la consultation des caractéristiques d’entreprises qui en contiennent des milliers. (AAM-34254)
* API du serveur de collecte de données : nous avons ajouté un nouveau code d’erreur : 198 - Les demandes de ce pays sont bloquées par le partenaire. Pour en savoir plus, consultez la [référence API de DCS](https://marketing.adobe.com/resources/help/en_US/aam/dcs_error_codes.html).
...
* Correction d’un bogue en raison duquel un message d’erreur incorrect s’affichait si un client essayait de mapper un segment sans code d’intégration à une destination de remplissage automatique à clés multiples. La deuxième valeur de mappage était désactivée et empêchait l’utilisateur de mapper le segment. (AAM-33765)
* Correction d’un problème lié à l’échantillonnage des erreurs pour les sources de données. Même si les utilisateurs cochaient la case d’échantillonnage des erreurs, l’échantillonnage ne fonctionnait pas en raison de la requête API incorrecte envoyée par l’interface utilisateur. (AAM-34516)
...
<table id="table_D006FF96470E414986BBA6A8B8A87C3E"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Abonnement - abonnez ou désabonnez une liste de profils à plusieurs services </p> </td> 
   <td colname="col2"> <p>L’activité de processus <b>Services d’abonnement</b> vous permet désormais d’abonner ou de désabonner une liste de profils à plusieurs services. </p> <p>Dans votre processus, importez un fichier contenant les profils, et pour chaque profil, le type d’opération et le service. L’activité <b>Services d’abonnement</b> pourra utiliser ces informations et gérer dynamiquement tous les abonnements et désabonnements de vos profils en une seule fois. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Activité d’enrichissement - enrichissez les données en fonction des transitions précédentes </p> </td> 
   <td colname="col2"> <p> La nouvelle activité de processus <b>Enrichissement</b> vous permet d’exploiter les transitions entrantes et de compléter la transition sortante avec des données supplémentaires. Si vous ciblez des profils, l’activité d’enrichissement vous permet de compléter les informations des profils avec des données supplémentaires qui ne sont pas stockées dans la base de données (issues d’un fichier importé, par exemple). </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>La documentation <a href="https://helpx.adobe.com/experience-manager/6-3/sites/developing/using/querybuilder-predicate-reference.html" format="https" scope="external">Référence d’AEM Query Builder</a> est désormais disponible. Elle aborde tous les prédicats intégrés au produit. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Vous pouvez désormais retrouver tous les webinaires destinés aux développeurs sur le forum AEM HelpX. Créez des signets pour les liens suivants : </p> <p> 
     <ul id="ul_10C986E4FC2F417C9AEA1DA6E0E4CA91"> 
      <li id="li_160E27307F16409EBA28EA2255E41715"> <a href="https://helpx.adobe.com/experience-manager/kt/eseminars/gems/aem-index.html" format="https" scope="external"> Visionnez les webinaires AEM GEM</a> pour connaître les dernières innovations et les bonnes pratiques relatives à la dernière version d’AEM. </li> 
