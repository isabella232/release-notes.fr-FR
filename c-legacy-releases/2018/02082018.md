...
<table id="table_519893D8565A4D489CB13D5EAF1E9325"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Processus <span class="wintitle"> Target de </span> désaffectation dans <span class="uicontrol"> Mobile </span> Services </p> </td> 
     <td colname="col2"> <p> Depuis mars 2018, dans le cadre de la désactivation des flux de travaux Adobe <span class="wintitle"> Target </span> dans Adobe <span class="uicontrol"> Mobile </span> Services, la possibilité de créer [! DNL Target]/Activités, [! DNL Target]/Audiences, et [! DNL Target]/Content a été désactivé dans cette version. </p> <p> Vous pouvez continuer à consulter, modifier et supprimer les activités, les audiences et le contenu existants jusqu’à mars 2018. </p> <p>Pour en savoir plus, voir <a href="https://marketing.adobe.com/resources/help/en_US/mobile/c_mob_remove-target-faqs.html" format="html" scope="external">Désactivation des processus [!DNL Target] dans Mobile Services</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* API du serveur de collecte de données : nous avons ajouté un nouveau code d’erreur : 198 - Les demandes de ce pays sont bloquées par le partenaire. Pour en savoir plus, voir [Référence de l’API du serveur de collecte de données](https://marketing.adobe.com/resources/help/en_US/aam/dcs_error_codes.html).
