...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Les journaux d’utilisation d’Analytics effectuent désormais le suivi lorsqu’un utilisateur ouvre un projet dans <span class="uicontrol"> Analysis Workspace </span> (en plus du suivi existant des actions de création, de mise à jour, d’annulation de partage et de suppression). Cela permet de mieux comprendre qui utilise Workspace et à quelle fréquence. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Lors de la définition d’un segment ou d’une alerte, un message "<b>composants incompatibles"</b> s’affiche si tous les composants (mesures/dimensions/segments) du segment ou de l’alerte ne sont pas compatibles avec la suite de rapports actuellement sélectionnée. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>En juin 2018, Adobe supprime l’assistance pour le protocole TLS 1.0. La fonctionnalité d'Audience Manager <span class="wintitle"> de l'Adobe </span> ne fonctionnera pas pour vos utilisateurs finaux qui utilisent des navigateurs qui ne prennent en charge que TLS 1.0. Nous avons collecté pour vous une liste de navigateurs, de versions et de prise en charge TLS. </p> </td> 
  </tr> 
 </tbody> 
</table>
