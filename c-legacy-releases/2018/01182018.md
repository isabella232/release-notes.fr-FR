...
>[!NOTE]
>
>Pour en savoir plus sur les notes de mise à jour anticipées, abonnez-vous à [Adobe Priority Product Update](https://www.adobe.com/subscription/priority-product-update.html). Cet avertissement est envoyé trois à cinq jours ouvrables avant la publication de la mise à jour. Revenez-y au moment de la publication de la mise à jour pour connaître les dernières informations. Les informations communiquées après la mise à jour seront estampillées avec la date de publication.
...
* Le nombre de signaux dérivés que vous pouvez utiliser est désormais plafonné à 50 000. Pour en savoir plus sur les [Limites d’utilisation](https://marketing.adobe.com/resources/help/en_US/aam/usage-limits.html).
...
* [Documentation sur Adobe Campaign Classic](https://helpx.adobe.com/support/campaign/classic.html)
* [Documentation sur Adobe Campaign Standard](https://helpx.adobe.com/support/campaign/standard.html)
...
* [Page d’accueil de la documentation sur AEM 6.1](https://docs.adobe.com/docs/en/aem/6-1.html)
