...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>Nouveaux <span class="uicontrol"></span> modèles mobiles pour la messagerie et l'emplacement </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Si votre société dispose d'un nombre limité de jetons Analyse des contributions, l'interface utilisateur <span class="uicontrol"> d'Analysis Workspace </span> affiche désormais une notification lorsque vous utilisez un jeton. Elle indique également combien de jetons il vous reste.  </p> <p>(Utilisateurs administrateurs : vous pouvez désigner qui peut utiliser ces jetons en modifiant les autorisations des groupes.)  </p> <p> <a href="https://marketing.adobe.com/resources/help/en_US/analytics/contribution/ca_main.html" format="html" scope="external"> Plus... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Modification de la manière dont Aucun/Non spécifié fonctionne dans <span class="uicontrol"> Analysis Workspace </span> afin qu'il soit cohérent avec [! UICONTROL Reports &amp; Analytics], le Créateur de segments et le menu Valeurs de dimension dans [! UICONTROL Analysis Workspace]. </p> <p>En d’autres termes, la valeur indiquera Non spécifié plutôt que Aucun dans la plupart des projets dans [!UICONTROL Analysis Workspace]. (AN-146879) </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p> <b>Créateur de segments</b><span class="uicontrol"> : ajout d’un type de compatibilité des produits dans Analysis Workspace</span> </p> </td> 
   <td colname="col2"> <p>Dans le <a href="https://marketing.adobe.com/resources/help/en_US/analytics/segment/seg_build.html" format="html" scope="external">créateur de segments</a>, nous avons ajouté un type de compatibilité des produits Analysis Workspace.<span class="uicontrol"></span> </p> <p>Les segments avec des plages de dates incorporées fonctionneront toujours différemment dans [!UICONTROL Analysis Workspace] par rapport au composant [!UICONTROL Rapports et analyses] : dans Workspace, un segment avec une plage de dates incorporée remplace la plage de dates du panneau. En revanche, le composant [!UICONTROL Rapports et analyses] indique l’intersection de la plage de dates du rapport avec la plage de dates incorporée du segment. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_EB8261E817054C2F8B17C09D16DB3412"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Appmeasurement (SDK hérités et <span class="uicontrol"> mobiles </span> ) </p> </td> 
   <td colname="col2"> 
<!-- <draft-comment> 
...
<table id="table_885F194180FE42EFA04220C9299969E4"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Il est désormais possible de déclencher une activité de signal pour vos flux de travail directement à partir <span class="wintitle"> de l'API Adobe Campaign </span> Standard. </p> <p>Pour plus d’informations, consultez la <a href="https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#triggering-a-signal-activity" format="html" scope="external">documentation détaillée</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
