...
<table id="table_885F194180FE42EFA04220C9299969E4"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> It is now possible to trigger a signal activity for your workflows directly from  <span class="wintitle"> Adobe Campaign </span> Standard API. </p> <p>Pour plus d’informations, consultez la <a href="https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#triggering-a-signal-activity" format="html" scope="external">documentation détaillée</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
