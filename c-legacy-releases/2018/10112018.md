...
La nouvelle [!DNL Analytics] API utilise la passerelle d&#39;E/S Adobe pour faciliter l&#39;utilisation avec les autres API Adobe. L&#39;API étend le même niveau de personnalisation à l&#39;API que les clients sont habitués dans [!UICONTROL Analysis Workspace]. Puisqu’elle met pleinement à profit le protocole REST, il est beaucoup plus facile pour les développeurs d’interagir avec cette API.
...
Correctifs et mises à jour mineures appliqués aux outils et composants [!DNL Analytics] d&#39;interface Adobe ([!UICONTROL Analysis Workspace], [!UICONTROL Rapports et analyses], [!UICONTROL Créateur de rapports], etc.).
...
* **Administration**[!DNL Analytics] : correction d’un problème empêchant l’utilisation de caractères spéciaux dans les noms d’utilisateurs Les identifications d&#39;Experience Cloud vous permettent d&#39;utiliser un certain nombre de caractères spéciaux. Prend désormais [!DNL Analytics] en charge tous les caractères autorisés dans les noms d&#39;utilisateur Experience Cloud. (AN-168014)
