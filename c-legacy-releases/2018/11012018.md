...
| Adobe [!DNL Analytics] et le règlement général sur la protection des données (RGPD) | [!DNL Analytics] prend en charge une nouvelle méthode pour transmettre l'identifiant [!DNL Analytics] visiteur hérité à une requête GDPR (voir [AAID](https://marketing.adobe.com/resources/help/en_US/analytics/gdpr/gdpr_namespaces.html)). Also, [!DNL Analytics] now supports [deleting (anonymizing) the Purchase ID value](https://marketing.adobe.com/resources/help/en_US/analytics/gdpr/gdpr_labels.html) as part of a delete request. |
