...
| Fin de vie d’Ad Hoc Analysis<br/> 9 août 2018 | Le 6 août 2018, l&#39;Adobe a annoncé son intention de mettre fin à la vie de Ad Hoc Analysis. La date de fin de vie sera communiquée dès que possible. Pour obtenir de plus amples informations, voir le site [Discover Workspace](https://spark.adobe.com/page/S9Bhp66VJ2fEn/).<br/>À compter de maintenant, Ad Hoc Analysis ne sera pas modifié pour prendre en charge Java 9+. Si vous effectuez une mise à niveau vers Java 9+, Ad Hoc Analysis ne fonctionnera plus. Seul Java 8 sera pris en charge. |
