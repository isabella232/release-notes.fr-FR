...
<table id="table_09C086041AB5447093588F9B197214A6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Envoi des requêtes GDPR à <span class="wintitle"> Audience Manager </span>et réponses aux questions courantes sur la manière de [! DNL Audience Manager] traite des exigences GDPR. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Comment permettre aux clients de supprimer des données dans leur <span class="wintitle"> profil </span> de visiteur Target. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>La publicité - Projet d'analyses ad hoc convertit votre publicité - Projets ad hoc en <span class="uicontrol"> espace de travail d'analyse </span>avec le clic sur le bouton. </p> <p>Les projets copiés peuvent ensuite être utilisés, modifiés et programmés au besoin dans [!UICONTROL Analysis Workspace]. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b>Mises à jour prévues effectives le 15 mai 2018</b> </p> <p> <span class="term"> La colonne </span>mc_ audiences a été ajoutée. <span class="term"> mc_ audiences </span> est la liste d'ID de segment d'Audience Analytics depuis Adobe <span class="wintitle"> Audience Manager </span>. </p> <p>Remarque : Cela n’inclut pas les noms adaptés puisqu’ils sont une classification de l’ID. </p> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>À la date du 25 mai 2018, à laquelle le GDPR (Europe General Data Protection Regulation) est passé en législation, nous avons préparé une documentation pour vous aider à gérer les données de consommateur dans <span class="wintitle"> Audience Manager </span> afin de répondre aux obligations GDPR. Pour aller plus loin : </p> <p> 
...
## [!DNL Advertising Cloud] (anciennement Advertizing Cloud)
