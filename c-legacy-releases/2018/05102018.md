...
<table id="table_5405964A0900476282E85E3BF9116C8B"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p><b>Important :  </b>Avec l'entrée en vigueur du RGPD le 25 mai 2018, l'Adobe mettra en oeuvre la suppression  <b>automatisée des fichiers laissés dans les comptes FTP gérés par des partenaires Data Connector (précédemment Genesis).</b> (Cela ne s’applique PAS à tous les comptes FTP appartenant aux clients Analytics.) Actuellement, les données des dossiers FTP sont conservées indéfiniment, ce qui peut entraîner un risque pour les entreprises quant à la préparation pour le GDPR. Depuis le 25 mai 2018, Adobe supprime tous les fichiers des serveurs FTP gérés par les partenaires Data Connector 30 jours après leur arrivée sur le serveur.
   </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_09C086041AB5447093588F9B197214A6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Comment soumettre des demandes de RMMD à <span class="wintitle"> Audience Manager </span> et comment répondre aux questions courantes sur la façon dont l'Audience Manager répond aux exigences du RMMD. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Comment permettre aux clients de supprimer des données dans leur Profil de Visiteur <span class="wintitle"> Cible </span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ad Hoc Analysis Project Converter convertit vos projets ad hoc en <span class="uicontrol"> Analysis Workspace </span>, en cliquant sur le bouton . </p> <p>Les projets copiés peuvent ensuite être utilisés, modifiés et planifiés selon les besoins dans <span class="uicontrol"> Analysis Workspace</span>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_666BB742E5BE4CC9BE95E697DA5DBB67"> 
      <li id="li_6B5F531B822D4392AD7760752C29B371">Correction d’un problème dans le créateur de segments, en raison duquel l’étiquette sur les options Seulement avant la séquence et Seulement après la séquence était activée et a maintenant été restaurée. (AN-160747) </li> 
      ...
      <li id="li_07E8FF50269B4B7B82EBE67BBF0335A3">Correction d’un problème qui empêchait le fonctionnement de la fonctionnalité de transfert des actifs si l’utilisateur dont les actifs devaient être transférés était répertorié comme propriétaire d’alertes. (AN-160747) </li> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>À l'approche de la date d'entrée en vigueur du 25 mai 2018 du Règlement général européen sur la protection des données (RGPD), nous avons préparé une documentation pour vous aider à gérer les données des consommateurs dans <span class="wintitle"> Audience Manager </span> afin de respecter les obligations découlant du RGPD. Pour aller plus loin : </p> <p> 
...
* Correction d’un bogue dans l’affichage du code du [Créateur de segments](https://marketing.adobe.com/resources/help/fr_FR/aam/c_segment_builder.html) en raison duquel les expressions contenant des parenthèses supprimaient ces dernières si les clients modifiaient à nouveau le segment. (AAM-36393)
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> </p> </td> 
   <td colname="col2"> <p>Les filtres de flux dans les modèles de publicités textuelles et d’annonces d’achat incluent désormais les opérateurs <i>non dans</i>, <i>inférieur à</i> et <i>supérieur à</i>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> </p> </td> 
