...
>[!NOTE]
>
>Abonnez-vous à [Adobe Priority Product Update](https://www.adobe.com/subscription/priority-product-update.html) pour être averti par email des prochaines mises à jourversions. Vous recevrez une notification trois à cinq jours ouvrables avant la sortie de la mise à jour. Les informations communiquées après la mise à jour seront estampillées avec la date de publication.
...
Durant la semaine du 7 mai 2018, Adobe a publié des mises à jour de produit pour prendre en charge [le Règlement général sur la protection des données (RGPD)](https://www.eugdpr.org). Les informations suivantes vous permettent de comprendre et d’appliquer ces améliorations, ainsi que de mettre à jour les politiques et les procédures nécessaires.
...
<table id="table_09C086041AB5447093588F9B197214A6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Comment permettre aux clients de supprimer des données dans leur profil de visiteur [!DNL Target]. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E08D11345DD64677B46629651A0FFDBF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Mise à jour d’Adobe [!UICONTROL Report Builder] en raison de la fin de la prise en charge du protocole TLS 1.0 </p> </td> 
   <td colname="col02"> <p>10 mai 2018 </p> </td> 
   <td colname="col2"> <p>En raison de la fin de la prise en charge du protocole TLS 1.0, nous avons recommandé aux utilisateurs d’Adobe [!UICONTROL Report Builder] (ARB) de télécharger ARB 5.6.21 avant le 13 septembre 2018. Après cette date, les versions antérieures d’ARB ne seront plus prises en charge. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Le convertisseur de projets d’Ad Hoc Analysis convertit vos projets ad hoc en projets [!UICONTROL Analysis Workspace] en un simple clic. </p> <p>Les projets copiés peuvent ensuite être utilisés, modifiés et programmés au besoin dans [!UICONTROL Analysis Workspace]. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p>Améliorations apportées à [!UICONTROL Analysis Workspace] </p> </td> 
   <td colname="col2"> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b>Mises à jour prévues effectives le 15 mai 2018</b> </p> <p> <span class="term"> La colonne </span>mc_ audiences a été ajoutée. <span class="term"> mc_audiences </span>est la liste des ID de segment Audience Analytics issue d’[!DNL Audience Manager]. </p> <p>Remarque : Cela n’inclut pas les noms adaptés puisqu’ils sont une classification de l’ID. </p> 
...
Correctifs et mises à jour mineures appliqués aux outils et composants de l’interface Adobe Analytics ([!UICONTROL Analysis Workspace], [!UICONTROL Reports &amp; Analytics], [!UICONTROL Report Builder], etc.)
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Alors que le 25 mai 2018 approche, date à laquelle le Règlement général sur la protection des données (RGPD) entrera en vigueur, nous préparons la documentation nécessaire pour vous aider à gérer les données des clients dans [!DNL Audience Manager], conformément aux obligations du RGPD. Pour aller plus loin : </p> <p> 
     <ul id="ul_542C0E9F27804307AED8FCE933135A43"> 
      <li id="li_853306663308434CAF8F63EFC7895817"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/aam/aam-gdpr-details.html" format="https" scope="external"> RGPD dans [!DNL Audience Manager] </a> </p> </li> 
...
* Correction d’un bogue dans l’affichage du code du [Créateur de segments](https://marketing.adobe.com/resources/help/en_US/aam/c_segment_builder.html) où les expressions contenant des parenthèses perdaient les parenthèses si les clients modifiaient à nouveau le segment. (AAM-36393)
...
## [!DNL Advertising Cloud] (anciennement Media Optimizer)
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Intégration à Adobe Analytics </p> </td> 
