...
* [Target](https://marketing.adobe.com/resources/help/fr_FR/target/rn/target_release_notes.html) - liens vers l’aide de la solution
...
Nouvelles fonctionnalités, mises à jour et correctifs de Mobile Services.
...
Pour plus d’informations sur les SDK Mobile, voir [SDK Android 4.x pour Experience Solutions](https://marketing.adobe.com/resources/help/fr_FR/mobile/android/) et [SDK iOS 4.x pour Experience Cloud Solutions](https://marketing.adobe.com/resources/help/fr_FR/mobile/ios/).

## [!DNL Analytics] {#analytics}

Date de publication : **17 janvier 2019**

Nouvelles fonctionnalités et correctifs de [!DNL Adobe Analytics] :
...
* Administration : correction d’un problème en raison duquel les utilisateurs autres que les administrateurs ne pouvaient pas créer de règles de traitement, même s’ils disposaient des droits adéquats. (AN-170690)
* Administration : correction d’un problème qui empêchait d’ajuster le nombre de rapports planifiés et alloués de Report Builder pouvant être exécutés par un utilisateur. (AN-168949)
...
* Correction d’un problème avec la dimension Identifiant d’appareil mobile qui entraînait des erreurs de permission. (AN-169728)
...
Pour plus d’informations, voir le [FAQ](https://helpx.adobe.com/content/dam/help/fr/experience-manager/support/adobe-oracle-java-license-agreement.pdf).
...
[!DNL Adobe Campaign] offre un moyen intuitif et automatisé de diffuser des messages individualisés sur des canaux marketing en ligne et hors ligne. Vous pouvez maintenant anticiper ce que souhaitent vos clients à l’aide d’expériences déterminées par leurs habitudes et leurs préférences.
