...
La bibliothèque d’intégration des données 8.1 est en conformité avec les politiques de sécurité plus strictes de Google Gestionnaire de balises. Cette version est disponible uniquement depuis la Gestion dynamique des balises et sous forme de code autonome, pas dans [!DNL Launch] ni dans le module de Gestion de l’audience AppMeasurement. Ces changements seront inclus dans les futures versions. (CORE-24189)
...
Pour plus d’informations, voir le [FAQ](https://helpx.adobe.com/content/dam/help/en/experience-manager/support/adobe-oracle-java-license-agreement.pdf).
