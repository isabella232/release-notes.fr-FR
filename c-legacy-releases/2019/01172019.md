...
Les principales améliorations apportées à l&#39;Analyse [!UICONTROL des] cohortes vous permettent :

* Appliquez séparément une inclusion de segment et des mesures de retour.
* Affichez l’ordre au lieu de conserver.
* Afficher les tableaux de latence (durée écoulée avant et après un événement d’inclusion).
* Personnalisez la dimension de cohorte (pour regrouper les visiteurs en fonction d’une eVar, et pas seulement du temps).
...
* Correction de problèmes de performances avec l’ [!UICONTROL Analysis Workspace], en particulier avec les projets contenant plusieurs visualisations de lignes. (AN-169916, AN-169691, AN-167120, AN-168082)
...
* Admin : Correction d’un problème survenant lors de la création d’une suite de rapports basée sur une autre suite de rapports. Certains paramètres inattendus ont été copiés. (AN-172395)
* Admin : Correction d’un problème qui empêchait les utilisateurs de télécharger les paramètres des modèles de suite de rapports. (AN-171092)
...
* Correction d’un problème en raison duquel les rapports accessibles à l’aide de liens courts et contenant des esperluettes dans le filtre de recherche perdaient certaines informations de filtre. (AN-167151)
* Correction d’un problème en raison duquel des visualisations vides étaient générées dans les panneaux des rapports téléchargeables. (AN-171273)
...
* Correction d’un problème qui empêchait la modification des segments. (AN-172307, AN-169785)
...
* Correction d’un problème qui empêchait les utilisateurs d’enregistrer des modifications dans des suites de rapports virtuelles liées à des segments supprimés. (AN-168906)
* Correction d’un problème en raison duquel les mesures de participation cessaient d’utiliser les variables de liste dans l’Ad hoc analysis. (AN-166027)
...
* Prise en charge des variables et des champs de métadonnées dans les noms de site PDF et AEM.
