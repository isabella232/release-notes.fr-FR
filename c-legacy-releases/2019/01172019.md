...
* [Lancement](https://docs.adobelaunch.com/) - liens vers l’aide du produit
...
La bibliothèque d’intégration des données 8.1 est en conformité avec les politiques de sécurité plus strictes de Google Gestionnaire de balises. This version is only available from DTM and as standalone code, not [!DNL Launch] or AppMeasurement Audience Manager Module. Ces changements seront inclus dans les futures versions. (CORE-24189)
