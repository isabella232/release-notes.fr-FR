...
* [[!DNL Launch, by Adobe]](https://docs.adobelaunch.com/) (liens vers l’aide du produit)
...
* La [page de synthèse des caractéristiques](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_tb_trait_summary.html) affiche désormais le type de caractéristique. (AAM-25784)
* La [page de synthèse des segments](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_segment_summary.html) contient désormais un lien hypertexte vers la source de données du segment pour faciliter la navigation. (AAM-40015)
...
Consultez les [Notes de mise à jour Adobe Target](https://docs.adobe.com/content/help/en/target/using/release-notes/target-release-notes.html) pour obtenir des informations récentes sur les produits suivants :
...
Voir les [Notes de mise à jour](https://docs.adobe.com/content/help/en/livefyre/using/release-notes/c-rn.html) pour obtenir les informations les plus récentes.
