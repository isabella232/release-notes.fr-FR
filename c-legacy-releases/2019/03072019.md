...
Consultez la documentation du produit [Services Experience Cloud ID](https://marketing.adobe.com/resources/help/fr_FR/mcvid/).
...
Pour plus d’informations sur les SDK Mobile, voir [SDK Android 4.x pour Experience Solutions](https://marketing.adobe.com/resources/help/fr_FR/mobile/android/) et [SDK iOS 4.x pour Experience Cloud
...
* La [page de synthèse des caractéristiques](https://experiencecloud.adobe.com/resources/help/fr_FR/aam/c_tb_trait_summary.html) affiche désormais le type de caractéristique. (AAM-25784)
* La [page de synthèse des segments](https://experiencecloud.adobe.com/resources/help/fr_FR/aam/c_segment_summary.html) contient désormais un lien hypertexte vers la source de données du segment pour faciliter la navigation. (AAM-40015)
...
* Correction d’un bogue en raison duquel la case à cocher **[!UICONTROL Tout sélectionner]** était absente des modèles algorithmiques sur la page [Sélectionner des caractéristiques à exclure](https://experiencecloud.adobe.com/resources/help/fr_FR/aam/trait-exclusion-algo-models.html). (AAM-42462)
...
Consultez les [Notes de mise à jour Adobe Target](https://docs.adobe.com/content/help/fr/target/using/release-notes/target-release-notes.html) pour obtenir des informations récentes sur les produits suivants :
...
Pour plus d’informations, voir [Rapport sur les notifications Push](https://helpx.adobe.com/fr/campaign/standard/reporting/using/push-notification-report.html).
...
Pour plus d’informations, voir [Utilisation du SDK Adobe Experience Platform](https://helpx.adobe.com/fr/campaign/standard/administration/using/configuring-a-mobile-application.html#main-pars_header_49).
...
* Vous pouvez désormais copier-coller des activités au sein d’un workflow ou entre deux workflows d’une même instance de Campaign. Ainsi, vous pouvez facilement dupliquer un workflow entier ou des activités spécifiques et conserver les paramètres définis initialement. Pour plus d’informations, voir la [documentation détaillée](https://helpx.adobe.com/fr/campaign/standard/automating/using/workflow-interface.html#duplicating-workflow-activities). (CAMP-20014)
* Lorsque vous utilisez l’activité **Charger un fichier**, vous pouvez désormais ajouter un horodatage au nom du fichier contenant les enregistrements refusés. Pour plus d’informations, voir la [documentation détaillée](https://helpx.adobe.com/fr/campaign/standard/automating/using/load-file.html#configuration).
...
Voir les [Notes de mise jour](https://docs.adobe.com/content/help/fr/experience-manager-cloud-manager/using/release-notes/release-notes-current.html)  associées.
...
Pour plus d’informations, voir [Nouveautés d’AEM Assets Brand Portal](https://helpx.adobe.com/fr/experience-manager/brand-portal/using/whats-new.html) et les [Notes de mise à jour](https://helpx.adobe.com/fr/experience-manager/brand-portal/release-notes/brand-portal-release-notes.html).
...
Voir les [Notes de mise à jour](https://docs.adobe.com/content/help/fr/livefyre/using/release-notes/c-rn.html) pour obtenir les informations les plus récentes.
