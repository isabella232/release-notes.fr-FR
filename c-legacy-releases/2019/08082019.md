...
Fin de vie de Digital Publishing Suite Classic (DPSC) le 31 août 2019. Pour en savoir plus, voir la [FAQ sur la fin de vie de Digital Publishing Suite Classic](https://helpx.adobe.com/digital-publishing-suite/help/eol-statement-for-dpsc.html).
...
[Les fonctionnalités du nouveau panneau de contrôle](https://helpx.adobe.com/campaign/kb/control-panel-instance-settings.html) incluent la possibilité d’ajouter des URL auxquelles Campaign Classic se connecte pour les transferts de données/de fichiers.
