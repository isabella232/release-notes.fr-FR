...
Voir Service [d’ID](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-release-notes.html) Experience Cloud pour obtenir une compilation des notes de mise à jour.
...
Un correctif AEM important pour l’invalidation du cache clients AEM 6.5 est disponible au moyen de la mise à jour [](https://helpx.adobe.com/experience-manager/6-5/release-notes/sp-release-notes.html) AEM 6.5.1.0 ou de cet article [de la](https://helpx.adobe.com/experience-manager/kb/avoid-crx-quickstart-deletion-in-aem-6-5.html)base de connaissances.
