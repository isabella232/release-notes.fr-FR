...
Pour consulter les notes de mise à jour cumulative, voir [Service Experience Cloud ID](https://marketing.adobe.com/resources/help/fr_FR/mcvid/mcvid-release-notes.html).
...
Pour plus d’informations sur les SDK Mobile, voir : [Android SDK 4.x pour les solution Experience](https://docs.adobe.com/content/help/en/mobile-services/android/overview.html) et [iOS SDK 4.x pour les solutions Experience Cloud](https://docs.adobe.com/content/help/en/mobile-services/ios/overview.html).
...
Pour obtenir des informations importantes concernant des vulnérabilités de la sécurité pouvant avoir un impact sur des versions spécifiques des produits Adobe, voir [Bulletins et avis de sécurité](https://helpx.adobe.com/fr/security.html).
...
Pour consulter la documentation du produit, voir [Accueil de l’aide d’Analytics](https://docs.adobe.com/content/help/fr-FR/analytics/landing/home.html).
...
* Mise à jour de la définition de l’aide de [log (X, B)](https://marketing.adobe.com/resources/help/en_US/insight/client/c_syntx_mtrc_exp.html) dans la documentation de la syntaxe des mesures. (AN-180527)
...
* [Versions CFP AEM Forms](https://helpx.adobe.com/fr/aem-forms/kb/aem-forms-releases.html)
...
* Adobe Campaign Classic [19.1.2](https://docs.campaign.adobe.com/doc/AC/fr/RN.html) - build 9029
...
Pour obtenir les informations les plus récentes sur Target, voir [Notes de mise à jour de Target (préliminaires)](https://docs.adobe.com/content/help/fr-FR/target/using/release-notes/target-release-notes.html).
