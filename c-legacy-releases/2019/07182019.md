...
Voir [le service Experience Cloud ID](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-release-notes.html) pour obtenir des notes de mise à jour cumulées.
...
* Mise à jour de la définition d'aide pour [la documentation de la syntaxe](https://marketing.adobe.com/resources/help/en_US/insight/client/c_syntx_mtrc_exp.html) des mesures du journal (X, B). (AN-180527)
...
Un correctif AEM important pour l'invalidation du cache AEM 6.5 clientlibs est disponible au moyen de [la mise à jour d'AEM 6.5.1.0](https://helpx.adobe.com/experience-manager/6-5/release-notes/sp-release-notes.html) ou de cet [article Ko](https://helpx.adobe.com/experience-manager/kb/avoid-crx-quickstart-deletion-in-aem-6-5.html).
...
* Adobe Campaign Classic [19.1.2](https://docs.campaign.adobe.com/doc/AC/en/RN.html) - créer 9029
