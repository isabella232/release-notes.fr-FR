...
* Voir [Notes de mise à jour de Adobe Experience Platform](https://www.adobe.io/apis/experienceplatform/home/services/release-notes.html#!end-user/markdown/release-notes/release-notes-20190515.md) sur Adobe.io pour connaître les dernières mises à jour de [!DNL Experience Platform].
...
| Sécurisation, robustesse et évolutivité | Une série d’améliorations a été apportée à [!DNL Campaign Classic]. Les améliorations apportées à la protection, à la robustesse et à l’évolutivité sont répertoriées dans les [Notes de mise à jour de Adobe Campaign Classic](https://docs.campaign.adobe.com/doc/AC/fr/RN.html). |
