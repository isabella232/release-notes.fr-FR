...
| -----------| ---------- | ---------- |
| Limites du créateur de règles de classification | Ajout le 5 juin 2019 | Ces limites ne sont pas nouvelles, mais elles ont été ajoutées à la documentation [ici](https://marketing.adobe.com/resources/help/en_US/reference/classification_rule_builder.html). |
...
| Sécurisation, robustesse et évolutivité | Une série d’améliorations a été apportée à Campaign Classic. Les améliorations de la protection, de la fiabilité et de l’évolutivité sont répertoriées dans les [notes de mise à jour de Campaign Classic](https://docs.campaign.adobe.com/doc/AC/en/RN.html). |
