...
**[Série de webinaires Cloud Manager Skill Builder](https://cloudmanagerskillbuilder.experienceleague.adobeevents.com/)**
...
[Dans cette série](https://cloudmanagerskillbuilder.experienceleague.adobeevents.com/)mensuelle, vous apprendrez directement à l’équipe produit d’Adobe comment démarrer et utiliser les fonctionnalités de Cloud Manager pour simplifier la gestion d’Adobe Experience Manager dans le cloud.
...
| Sécurisation, robustesse et évolutivité | Une série d’améliorations a été apportée à Campaign Classic. Les améliorations de la protection, de la robustesse et de l’évolutivité sont répertoriées dans les Notes [de mise à jour de](https://docs.campaign.adobe.com/doc/AC/en/RN.html)Campaign Classic. |
