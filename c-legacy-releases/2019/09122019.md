...
>[!NOTE]
>
>Abonnez-vous à [[!DNL Adobe Priority Product Update]](https://www.adobe.com/subscription/priority-product-update.html) pour être averti par courriel des prochaines versions. Vous recevrez l&#39;avis trois à cinq jours ouvrables avant la publication. Les informations communiquées après la mise à jour seront estampillées avec la date de publication.
...
Voir [Notes de mise à jour d’AppMeasurement pour JavaScript](https://experienceleague.corp.adobe.com/docs/analytics/implementation/appmeasurement-updates.html).
...
Fin de vie de [!DNL Digital Publishing Suite Classic] (DPSC) le 31 août 2019. Pour plus d&#39;informations, consultez la [[!DNL Digital Publishing Suite Classic] FAQ sur la fin de vie](https://helpx.adobe.com/fr/digital-publishing-suite/help/eol-statement-for-dpsc.html).
...
* [Notes de mise à jour de Scene7 Publishing System](https://docs.adobe.com/content/help/en/dynamic-media-developer-resources/release-notes/s7rn2017.html)
* [Notes de mise à jour de Livefyre](https://docs.adobe.com/content/help/en/livefyre/using/release-notes/c-rn.html)
...
Nous avons ajouté de nouvelles fonctionnalités permettant aux administrateurs d’autoriser les adresses IP à se connecter aux instances de Campaign Classic.
