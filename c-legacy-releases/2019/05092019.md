...
| **Collecte de données :** nouveau cookie s_ecid | Ajout d’un cookie de serveur propriétaire, s_ecid, dans lequel la collecte de données stocke l’ECID du visiteur. |
