...
* Consultez les [notes de mise à jour [!DNL Experience Platform]](https://www.adobe.io/apis/experienceplatform/home/services/release-notes.html#!end-user/markdown/release-notes/release-notes-20190515.md) sur Adobe.io pour connaître les dernières mises à jour d’[!DNL Experience Platform].

### Experience Platform Launch

* Consultez [[!DNL Experience Platform Launch]](https://docs.adobelaunch.com/) pour obtenir les dernières informations.
...
| **Analysis Workspace :** Nouveau paramètre de visualisation de flux _Inclure les instances répétées_ | Le paramètre de visualisation de flux _Inclure les instances répétées_ vous permet d’inclure ou d’exclure des instances répétées, telles que le rechargement de pages. De plus, toutes les visualisations de flux sont maintenant basées uniquement sur des instances. |
| **Ad Hoc Analysis :** Compatibilité avec Java 11 | Ad Hoc Analysis est désormais compatible avec Java 11. Découvrez comment exécuter [Ad Hoc Analysis sous Java 11](https://marketing.adobe.com/resources/help/fr_FR/dsc/adhoc-java.html). |
| **Collecte de données :** nouveau cookie s_ecid | Ajout d’un nouveau [cookie serveur propriétaire](https://docs.adobe.com/content/help/en/core-services/interface/ec-cookies/cookies-analytics.html), s_ecid, dans lequel la collecte de données stocke l’ECID du visiteur. |

**Correctifs d’Analysis Workspace**

* Correction d’un problème affectant la Durée de consultation de la page. Les rapports Workspace n’utiliseront plus le nom de la page lors du calcul des intervalles de durée, ce qui permet de compter les accès granulaires et par intervalle. (AN-140479)
...
* [Nouveautés d’Adobe Experience Manager 6.5](https://www.adobe.com/fr/marketing/experience-manager/new.html)
...
[Notes de mise à jour d’AEM 6.4 Service Pack](https://helpx.adobe.com/fr/experience-manager/6-4/release-notes/sp-release-notes.html)
[Versions d’AEM Forms](https://helpx.adobe.com/fr/aem-forms/kb/aem-forms-releases.html)
...
Voir [Impact de l’obsolescence d’AWS Signature version 2 sur Amazon S3](https://helpx.adobe.com/fr/experience-manager/kb/the-impact-of-aws-signature-version-2-deprecation-for-amazon-s3.html)

### Auto-assistance

**Moderniser votre base de code AEM Sites**

Découvrez comment tirer parti de la dernière technologie AEM pour moderniser votre base de code AEM Sites. [Modernisation de votre base de code Adobe Experience Manager Sites existant ](https://expleague.azureedge.net/labs/L761/index.html)
...
Voir [Présentation approfondie de l’éditeur de texte enrichi AEM](https://helpx.adobe.com/fr/experience-manager/kt/eseminars/gems/AEM-Rich-Text-Editor-RTE-Deep-Dive1.html)
