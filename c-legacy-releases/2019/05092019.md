...
| -----------| ---------- |  
| **Appmeasurement version 2.14.0** <ul><li>Correction de problèmes liés à la gestion de l’état des paramètres de suivi lorsque plusieurs accès sont en attente. (AN-176931, AN-176629, DTM-12758)</li><li>Mise à jour d’AppMeasurement pour inclure Visitor.js 4.3.0 (AN-180049)</li></ul> |
