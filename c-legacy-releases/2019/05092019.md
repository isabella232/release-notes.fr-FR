...
| **Ad Hoc Analysis :** Compatibilité avec Java 11 | Ad Hoc Analysis est désormais compatible avec Java 11. Learn how to run [Ad Hoc Analysis on Java 11](https://marketing.adobe.com/resources/help/en_US/dsc/adhoc-java.html). |
| **Collecte de données :** nouveau cookie s_ecid | Added a new [first-party server cookie](https://docs.adobe.com/content/help/en/core-services/interface/ec-cookies/cookies-analytics.html), s_ecid, in which data collection stores the visitor's ECID. |
