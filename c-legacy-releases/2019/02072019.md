...
* [Target](https://docs.adobe.com/content/help/fr/target/using/release-notes/target-release-notes.html) (liens vers l’aide de la solution)
...
Avec la mise à niveau vers une nouvelle version de [Tableau](https://experiencecloud.adobe.com/resources/help/fr_FR/aam/c_comproc.html), nous avons modifié la méthode de visualisation des données pour les rapports de chevauchement. Consultez la copie d’écran sur la page Rapport de chevauchement de caractéristiques. Pour plus d&#39;informations, voir [Rapport de chevauchement de caractéristiques](https://experiencecloud.adobe.com/resources/help/fr_FR/aam/c_overlap_reports.html).

**Rapport de chevauchement de segments et de caractéristiques**

Avec la mise à niveau vers une nouvelle version de Tableau, nous avons modifié la méthode de visualisation des données pour les rapports de chevauchement. Consultez la copie d’écran sur la page Rapport de chevauchement de segments et de caractéristiques. Pour plus d&#39;informations, voir [Rapport de chevauchement de segments et de caractéristiques](https://experiencecloud.adobe.com/resources/help/fr_FR/aam/c_segment_trait_overlap.html)

**Rapport de chevauchement de segments**

Avec la mise à niveau vers une nouvelle version de Tableau, nous avons modifié la méthode de visualisation des données pour les rapports de chevauchement. Consultez la copie d’écran sur la page Rapport de chevauchement de segments. Pour plus d&#39;informations, voir [Rapport de chevauchement de segments](https://experiencecloud.adobe.com/resources/help/fr_FR/aam/c_segment_segment_overlap.html)
...
* [Notes de mise à jour](https://helpx.adobe.com/fr/experience-manager/release-notes--aem-6-1-cumulative-fix-pack-.html)
* [Versions d’AEM Forms CFP](https://helpx.adobe.com/fr/aem-forms/kb/aem-forms-releases.html)

### Auto-assistance

Pour obtenir des conseils pour la résolution des problèmes d’intégration d’AEM, voir [Dépannage des problèmes d’intégration](https://helpx.adobe.com/fr/experience-manager/6-4/sites/administering/using/troubleshooting-integration-issues.html).
