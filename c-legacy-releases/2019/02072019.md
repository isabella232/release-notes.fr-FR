...
# Notes de mise à jour de Adobe Experience Cloud - février 2019
...
Avec la mise à niveau vers une nouvelle version de Tableau, nous avons modifié la méthode de visualisation des données pour les rapports de chevauchement. Consultez la copie d’écran sur la page Rapport de chevauchement de segments. Voir [Rapport de chevauchement segment-à-segment](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_segment_segment_overlap.html)
...
Conseils de dépannage pour les problèmes d’intégration AEM, voir [Résolution des problèmes d’intégration](https://helpx.adobe.com/experience-manager/6-4/sites/administering/using/troubleshooting-integration-issues.html).
