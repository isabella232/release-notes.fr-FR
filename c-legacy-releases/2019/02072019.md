...
* La définition de segment Dimension de cohorte personnalisée applique désormais l’élément de dimension uniquement dans le cadre de la période d’inclusion, et non dans le cadre de la définition de retour.
...
* Ajouté une logique de nouvelle tentative pour des erreurs spécifiques dans l’Analysis Workspace. (AN-172801)
...
AEM 6.1 SP2-CFP18 (6.1.2.18), publié le 11 janvier 2019, est une mise à jour importante qui comprend des correctifs client clés publiés depuis la disponibilité générale d’AEM 6.1 août 2016.
...
Conseils de dépannage pour les problèmes d’intégration d’AEM, voir [Dépannage des problèmes](https://helpx.adobe.com/experience-manager/6-4/sites/administering/using/troubleshooting-integration-issues.html)d’intégration.
