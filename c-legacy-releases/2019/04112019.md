...
| Fonction | Description |
| -----------| ---------- | 
| Rechercher dans les campagnes | Dans le sélecteur de périodes, le calendrier est maintenant organisé du dimanche au samedi. Auparavant, il était organisé du lundi au dimanche. |
