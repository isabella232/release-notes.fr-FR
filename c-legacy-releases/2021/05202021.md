...
Voir les [notes de mise à jour](https://experienceleague.adobe.com/docs/marketo/using/release-notes/release-schedule.html?lang=en) [!DNL Marketo Engage] pour consulter les informations sur la planification de la dernière version.
