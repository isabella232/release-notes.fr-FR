...
| Fonctionnalité | Description |
| ------- | ----------- |
| — | La nouvelle balise JavaScript Advertising Cloud bêta utilise le service Adobe Experience Cloud ID (ECID) ainsi que les anciennes valeurs ef_id et gsurferid pour mesurer les conversions. La nouvelle balise crée des [cookies s_ecid Experience Cloud](https://experienceleague.adobe.com/docs/core-services/interface/administration/ec-cookies/cookies-first-party.html) et offre une meilleure intégration avec d’autres produits Experience Cloud.<br><br>L’ancienne balise JavaScript Advertising Cloud avec le mappage ITP sera abandonnée en septembre 2021.<br><br>Votre gestionnaire de compte Adobe vous contactera pour vous fournir davantage d’informations et des instructions de mise en œuvre. |
