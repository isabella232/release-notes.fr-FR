...
La documentation sur les services et l’administration des Experience Cloud comprend les attributs du client, la bibliothèque d’audiences ([!UICONTROL Personnes] (service), Activation, gestion des utilisateurs et des produits, et cookies Experience Cloud.
...
| 21 décembre 2020 | [Créer des activités d’offre](https://experienceleague.adobe.com/docs/offer-decisioning-learn/tutorials/create-offer-activities.html?lang=fr) | Vidéo | Découvrez comment créer des activités d’offre dans [!UICONTROL Offer Decisioning]. Une activité d’offre combine vos emplacements et vos collections en une seule entité, de sorte qu’une décision puisse être prise pour fournir l’offre la plus pertinente au client. |
...
| 9 décembre 2020 | [Création de règles dans Offer Decisioning](https://experienceleague.adobe.com/docs/offer-decisioning-learn/tutorials/create-rules.html?lang=fr) | Vidéo | Découvrez comment créer des règles dans [!UICONTROL Offer Decisioning]. Les règles sont créées à l’aide des événements et des attributs de Platform. [!UICONTROL Real-time Customer Profile] et des contraintes d’éligibilité des offres. |
| 9 décembre 2020 | [Création d’emplacements](https://experienceleague.adobe.com/docs/offer-decisioning-learn/tutorials/create-placements.html?lang=fr) | Vidéo | Découvrez comment créer des placements dans Offer Decisioning. Un emplacement représente la combinaison du type de contenu et du canal, par exemple une image dans un email ou du code HTML sur un site Web. |
...
Experience Manager 6.4, Service Pack 8, Cumulative Fix Pack 3 (6.4.8.3 publiée le 26 novembre 2020) est une mise à jour importante qui comporte plusieurs correctifs internes et clients depuis la mise à disposition de Experience Manager 6.4, Service Pack 8 (6.4.8.0) en mars 2020.
...
Voir [Expérience unifiée](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/refactoring-tools/unified-experience.html?lang=fr#benefits) pour en savoir plus sur ce module.
      * Le convertisseur d’index est un utilitaire qui permet de transformer les définitions d’index OAK personnalisées d’un client en définitions d’index OAK compatibles avec les Experience Manager.
...
* **Analyseur des bonnes pratiques**
   ...
   * [!UICONTROL Cloud Readiness Analyzer] est désormais [!UICONTROL l’analyseur des bonnes pratiques] (BPA pour Best Practices Analyzer). L’application d’une seule page (BPA) fournit une évaluation des bonnes pratiques concernant votre mise en oeuvre de Experience Manager actuelle et vous aide à évaluer votre empressement à passer d’une instance AEM existante à AEM en tant que [!UICONTROL Cloud Service].
