...
| [Plan directeur du centre d’activité client](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/audience-activation/customer-activity.html) | Découvrez comment les applications externes peuvent accéder au [!UICONTROL Profil client en temps réel] d’Adobe Experience Platform. |
...
| Mars 2021 | [Diffusion de données à l’aide des connecteurs sources](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/streaming-ingestion-source-connector.html?lang=fr) | Vidéo | Cette vidéo montre comment diffuser des données en temps réel d’une source de stockage dans le cloud vers Platform et utiliser les données en temps réel pour l’engagement du client. |
...
| 5 mars 2021 | [Ingestion de données en flux continu via l’API](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/streaming-ingestion-http-api.html?lang=fr) | Vidéo | Cette vidéo montre comment diffuser des données vers Adobe Experience Platform en temps réel à l’aide du point de terminaison de l’API HTTP. |
...
| 5 mars 2021 | [Détails sur Export Postman de la console d’Adobe I/O](https://experienceleague.adobe.com/docs/platform-learn/tutorials/platform-api-authentication.html) | Vidéo | Découvrez comment authentifier et accéder aux API Experience Platform. |
...
* [Avis importants à l’intention des administrateurs](#aa-notices) **d’Analytics (mise à jour le 6 avril 2021)**
* [AppMeasurement](#appm)
...
* [Mises à jour et feuille de route d’Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/home.html?lang=en)
...
| Mars 2021 | [Bases - Gestion du workflow](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/administering/workflows-administering.html?lang=en) | Vidéo | Cette vidéo utilise des modèles de workflow pour démontrer cet ensemble de fonctionnalités, mais ils s’appliquent également aux lanceurs AEM. |
...
* [Page dʼaccueil de formation et de support pour Experience Manager 6.2](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions.html)
...
* [Versions plus anciennes de la documentation pour Experience Manager](https://docs.adobe.com/content/help/en/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions.html)
...
| Fonctionnalité | Description |
| -----------| ---------- |
| [!UICONTROL Rechercher dans les campagnes]<br> Rapports | (Campagnes Microsoft Ads) La prise en charge des enchères est désormais disponible pour la stratégie d’enchères de coût par clic amélioré (eCPC) de Microsoft, qui est la stratégie d’enchères par défaut pour les campagnes Microsoft Advertising. Vous pouvez désormais spécifier une [!UICONTROL stratégie d’enchères] au niveau de vos campagnes. Parmi les options, on trouve le [!UICONTROL coût par clic (CPC) manuel] et le [!UICONTROL coût par clic (CPC) amélioré]. Vous pouvez utiliser le [!UICONTROL coût par clic (CPC) amélioré] avec une recherche, une annonce de recherche dynamique existante et des campagnes d’achat.<br>Lorsque vous ajoutez une campagne avec eCPC amélioré à un portfolio Advertising Cloud optimisé, la plateforme optimise les enchères de base. Elle optimise également le budget de la campagne lorsque l’option « Ajuster automatiquement les limites budgétaires de la campagne » est activée. Microsoft® applique tous les ajustements d’offre et peut modifier les offres générées par Advertising Cloud au moment de la requête utilisateur en fonction de données et d’informations propriétaires.<br>La colonne personnalisée [!UICONTROL Stratégie d’enchères] est disponible dans la vue [!UICONTROL Campagnes] et dans les rapports. |
| [!UICONTROL Rechercher dans les campagnes]<br> [!UICONTROL Feuilles de support] | (Campagnes publicitaires Microsoft®) Pour les publicités textuelles étendues, la prise en charge est désormais disponible pour un troisième titre facultatif ([!UICONTROL Titre de la publicité 3]) et une seconde description facultative ([!UICONTROL Description 2]). Une assistance est disponible dans la vue [!UICONTROL Annonces publicitaires] et dans les [!UICONTROL Feuilles de support]. |
