...
| ----------- | ---------- | ----- |
| Prise en charge des [!UICONTROL tableaux de bord Adobe Analytics] | 25 mars 2021 | [!UICONTROL Customer Journey Analytics] (CJA) prend désormais en charge le [!UICONTROL créateur de cartes de performance des tableaux de bord Adobe Analytics] et l’appli mobile. Cela permet aux utilisateurs et aux dirigeants d’entreprise de voir leurs indicateurs clés de performance cross-canaux en fonction des données CJA, depuis la même appli que celle qu’ils utilisent déjà pour Adobe Analytics. |
