...
| Avril 2021 | [Lʼavenir de la gestion des données et les changements dʼenvironnement - Événement](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/industry/the-future-of-data-management-and-the-changing-environment.html?lang=fr#industry) | Article | Alors que les forces du marché apportent des changements à notre paysage numérique, les entreprises doivent s&#39;adapter à une nouvelle réalité concernant la gouvernance des données, la résolution des identités, et comment impliquer les prospects et les visiteurs pseudonymes avec du contenu significatif. |
