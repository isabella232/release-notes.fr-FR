...
| Fonctionnalité | Description |
| ------- | ----------- |
| [!UICONTROL Outils] | Si votre compte d’annonceur est configuré de sorte d’utiliser l’optimisation hybride, [!DNL Advertising Cloud Search] peut éventuellement charger les objectifs des portefeuilles du compte vers Google Ads sous forme de conversions, vous permettant ainsi de les utiliser dans le cadre d’une optimisation hybride. Vous pouvez activer cette fonctionnalité depuis **[!UICONTROL Rechercher]** > **[!UICONTROL Outils]** > **[!UICONTROL Configuration du téléchargement des conversions]**. |
