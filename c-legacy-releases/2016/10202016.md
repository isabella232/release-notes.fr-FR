...
>[!IMPORTANT]
>
>Avec la bibliothèque 1.9.0 du service de Marketing Cloud ID, la synchronisation des identifiants commencera par défaut pour Adobe Advertizing Cloud. Voir [Comprendre la synchronisation des identifiants et les taux de correspondance](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html).
    ...
    <ul id="ul_05ED67AA88094BB7B87CD7E648CF61CF"> 
     ...
     <li id="li_63188564A41B44E28970F204553E60FC"> <span class="uicontrol"> Dimensions: </span> 
      <ul id="ul_3DC61B9C1EA54CDCA7C8895EED163E9A"> 
       ...
       <li id="li_DC9E47E50F0541FF8894D2693B06230E">Les rapports Vidéo et Mobile sont des dimensions, ainsi que d'autres rapports de solutions Analytics (Experience Manager, Advertizing Cloud, Social, etc.). </li> 
...
**Nouvelles fonctionnalités de la publicité Cloud**
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"></td> 
   <td colname="col2"> <p>Les règles de récence pour les stratégies d'annonces dans les campagnes optimisées sont maintenant appliquées à l'offre optimisée générée par la publicité Cloud plutôt qu'à l'offre de base. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Les cibles publicitaires créées dans les éditeurs Facebook à l'aide de cibles flexibles sont visibles en lecture seule dans le cloud de publication. </p> </td> 
  </tr> 
  <tr> 
