...
>[!IMPORTANT]
>
>Si vous utilisez la bibliothèque version 1.9.0 ou ultérieure du service de Marketing Cloud ID, la synchronisation des identifiants commencera par défaut pour Adobe Media Optimizer. Pour plus d&#39;informations, voir [Comprendre la synchronisation des identifiants et les taux de correspondance](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html).

* Correction d’un bug qui transmettait des identifiants utilisateur uniques [!DNL  Audience Manager] (AAMUUID) en tant qu’identifiants [!DNL  Marketing Cloud] au service ID. (MCID-203)
...
* **(Mis à jour le 28/10 et le 11/4)** Le service d’ID synchronise automatiquement les identifiants [!DNL  Marketing Cloud] (MID) avec [!DNL  Adobe Media Optimizer] et d’autres domaines internes [!DNL  Adobe] directement sur la page. La synchronisation automatique est activée pour tous les comptes nouveaux et existants. Cela contribue à améliorer les taux de correspondance pour [!DNL  Media Optimizer]. Cela s’applique à VisitorAPI.js 1.9 ou version ultérieure. Consultez aussi la section [Comprendre la synchronisation des identifiants et les taux de correspondance](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html). (MCID-152, MCID-184)
...
* [Autorisations GetGroups](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-permission-group-1)
...
Pour plus d’informations, voir [Modifications de l’API des autorisations pour octobre](https://marketing.adobe.com/developer/forum/administration/permissions-api-changes-for-october) dans Developer Connection.
...
* Correctif d’un bogue qui empêchait l’échantillonnage d’erreurs du [!UICONTROL rapport État de l’intégration] de renvoyer les erreurs dans le fichier des données en entrée. Consultez aussi la section [
Rapport sur l’état d’intégration : à propos de](https://marketing.adobe.com/resources/help/en_US/aam/onboarding-status-report.html). (AAM-26460)
