...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Communication étendue des flux de données aux régions AWS (AN-118446) </p> </td> 
   <td colname="col2"> <p>Les flux de données peuvent désormais communiquer avec les 11 régions AWS standard suivantes (en utilisant l’algorithme de signature approprié si nécessaire) : </p> 
    ...
    </ul> <p>Actuellement, nous ne soutenons pas la région AWS Pékin, Chine (cn-north-1). </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Data Warehouse : Prise en charge du classement des éléments de ligne (AN-125562) </p> </td> 
   <td colname="col2"> <p>Le rapports de Data Warehouse prend désormais en charge le classement des éléments de ligne selon la ou les mesures fournies. Lors du tri, si vous choisissez également de limiter le nombre de lignes dans le tableau (page des paramètres avancés de l'Entrepôt de données), le rapport renvoie les N premières valeurs par rapport à la mesure en cours de tri. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Data Warehouse : Modification de la logique d’appellation des colonnes </p> </td> 
   <td colname="col2"> <p> <b>Dans la version de maintenance de juillet</b>, la logique d’attribution des noms de colonnes dans le fichier de l’<span class="wintitle">entrepôt de données</span> a été modifiée. Auparavant, si le nom evar1 était "ABC", le nom de colonne était "ABC (evar1)". </p> <p>Dans les cas où la variable contenait déjà l’identifiant, celui-ci devenait redondant : </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9DD79A9FD0014CA285E372FAD2BF9FE2"> 
      <li id="li_BE8C3497AA9A4FCA855130A0C7157F12">Correction d’un problème en raison duquel la ventilation de la dimension "Semaine" par "Jours" incluait les jours de différentes semaines. (AN-123821) </li> 
      <li id="li_914EEE918E5C40FA988765334E1C758F">Correction d’un problème en raison duquel, lors du passage à une autre suite de rapports, le code de devise du projet n’était pas mis à jour. (AN-123821) </li> 
      <li id="li_D0C0C458BF104A4D9A28C03F0879360D">Correction d’un problème qui empêchait parfois le téléchargement de projets avec des visualisations textuelles. (AN-124982, AN-127546) </li> 
      <li id="li_27E3CB2B943949398895FA0E376033EA">Correction d’un problème en raison duquel le fuseau horaire reflété dans le fichier PDF ne correspondait pas au fuseau horaire de la suite de rapports. (AN-127547) </li> 
      <li id="li_280BBD99A16247339FFD0DBDEA01D7A8">Correction d’un problème qui empêchait les utilisateurs de cliquer une deuxième fois sur "Limiter le nombre maximum d’éléments" dans un tableau à structure libre. (AN-126717) </li> 
...
<!-- <draft-comment> 
    ...
    <ul id="ul_E56DED7604E74541854CC82739C89DA0"> 
     <li id="li_A6ACB9FCE0B04B76A7DEFA6B8D6B6B92">Mise à jour d’AppMeasurement pour lire et écrire les cookies AMCV. (AN-127098) </li> 
    ...
    </ul> <p> <p>Remarque : Voir aussi les notes de mise à jour du <a href="https://marketing.adobe.com/resources/help/fr_FR/sc/appmeasurement/release/c_release_notes_mjs.html" format="html" scope="external">4 août</a> relatives à JavaScript version 1.6.3, qui décrivent les exigences à jour du service Marketing Cloud ID. </p> </p> 
...
* Correction d’un bogue du créateur de segments qui empêchait l’ajout de caractéristiques à de nouveaux segments lors de l’utilisation de Chrome. (AAM-24994)
* Correction d’un bogue qui empêchait les administrateurs d’attribuer des autorisations aux groupes disposant d’un grand nombre de sources de données. (AAM-24870)
* Correction d’un bogue qui empêchait les dossiers de segments de se développer et d’afficher des sous-dossiers ou des segments. (AAM-25054)
...
Le code DIL constitue le code de collecte de données d’API de [!DNL  Audience Manager]. La version de juillet passe à la version 6.5. Effectuez la mise à niveau vers la dernière version pour tirer parti de ces fonctionnalités et correctifs.

* Correction d’un bogue qui empêchait le déploiement du code du DIL dans Firefox. (AAM-24708)
* Ajouté un attribut de titre à l’iFrame DIL. Avec un titre d’iFrame, les lecteurs d’écran peuvent plus facilement fournir des informations sur la page aux utilisateurs qui ont besoin d’aide lors de leur interaction avec du contenu en ligne. (AAM-25317)
* Prise en charge des DIL Ajoutés pour le partage des ressources entre Origines (CORS). Voir [useCorsOnly](https://marketing.adobe.com/resources/help/en_US/aam/dil-use-cors-only.html). (AAM-25319, AAM-20139).
* L’iFrame DIL prend en charge les attributs ` iframe.sandbox='allow-scripts allow-same-origin';`. Le fait d’autoriser seulement ces deux jetons renforce la sécurité. Pour plus d’informations, voir la section sur les attributs de cette [documentation sur les iFrames](https://developer.mozilla.org/fr-FR/docs/Web/HTML/Element/iframe). (AAM-23335)
* Par défaut, le DIL effectue désormais des appels HTTPS sécurisés. Les clients qui utilisent le code DIL [!DNL  Audience Manager] et le code visitorapi.js sur la même page doivent définir la variable DIL ` secureDataCollection= false`. Voir [secureDataCollection](https://marketing.adobe.com/resources/help/en_US/aam/dil-secure-data-collection.html).

**Correctifs, améliorations et obsolescences**

* Augmentation de la fréquence et de la durée de vie de la collecte des données de mesure Facebook. La nouvelle période de collecte des données est la suivante :

   * Toutes les mesures Facebook sont collectées toutes les heures pendant les 72 premières heures après la publication d’une publication.
   * Poursuivre la collecte des données toutes les 8 heures pendant les 72 heures suivantes.
   * Poursuivre la collecte des données quotidiennement par la suite pendant les 60 prochains jours.

* Ajouté une colonne Géociblage pour Twitter dans le rapport Analyses de publication exporté.
* Cinq nouvelles mesures de réaction Facebook sont désormais disponibles dans les rapports Analyses de publication et Analyses de propriété. Il s&#39;agit notamment : J&#39;adore, Waouh, Triste, Haha et En Colère. Dans une prochaine version, les mesures de réactions Facebook seront également disponibles dans les rapports Adobe Analytics.
...
* Correction d’un problème en raison duquel les rapports Buzz social générés plusieurs jours entraînaient la suppression de certaines publications.
* Correction d’un problème en raison duquel la modification des paramètres de flux dans la modération unifiée n’était pas enregistrée après déconnexion et reconnexion.
* Correction d’un problème en raison duquel les URL dans les tweets cités comprenaient plus de 24 caractères que prévu.
...
<table id="table_04819C0464594ECFB211C253C34E69CA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Adobe a publié des correctifs de sécurité pour Adobe Experience Manager. Ces correctifs permettent de résoudre deux problèmes de validation qui peuvent être utilisés dans les attaques de scripts intersites (CVE-2016-4168 et CVE-2016-4170) : </p> 
...
Le tableau suivant contient une sélection de liens vers des rubriques, événements et webinaires suggérés qui vous aideront à tirer le meilleur parti de votre mise en oeuvre et de votre utilisation des AEM.

<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> <p>Informations relatives aux AEM </p> </th> 
   <th colname="col2" class="entry"> <p>Description </p> </th> 
  </tr> 
 </thead>
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Rejoignez des pairs dans votre région ou, si vous voyagez, rejoignez une réunion de groupe d’utilisateurs. Une liste de chaque événement est disponible dans le calendrier communautaire. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Rejoignez vos pairs aux Événements AEM développeurs </p> </td> 
   <td colname="col2"> <p>Voici deux événements à venir de @AEM_Dev : </p> 
    <ul id="ul_74A5BB5856844F38884CEAE36A16168F"> 
     <li id="li_D85EC94BEFE44654A8FB050CBC955F41">EVOLVE hébergée par 3Share, du 29 au 31 août à San Diego. Billets disponibles à l’adresse suivante : https://evolve.3sharecorp.com. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Le 23 août 2016, rejoignez Lokesh BS et Scott Macdonald pour une discussion sur l'utilisation du commerce électronique AEM. </p> <p>La session traite de l’eCommerce Framework, y compris de l’utilisation des API de commerce électronique. En participant à cette session, vous pouvez mieux comprendre comment utiliser la structure AEM eCommerce et les API associées. </p> <p> <a href="https://communities.adobe.com/content/usergenerated/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/_jcr_content/par/calendar/ask_the_aem_communit_3.form.html/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/upcoming-event-detail" format="https" scope="external"> Inscrivez-vous au séminaire ici </a>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Le 17 août 2016, participez au webinaire "How to setup and configure Dynamic Media" (Comment configurer et configurer). </p> <p>Les sujets abordés dans le webinaire sont les suivants : </p> 
    <ul id="ul_6C2DD857C8804D19A8F0D7FE51C6745C"> 
     <li id="li_864C04A369E342ED9C4F0DED93D9E744"> Cas d'utilisation de Dynamic Media. </li> 
     <li id="li_22E96702DD0E41CBAA101331B0FAABF5"> Architecture technique. </li> 
     <li id="li_68EB914F76D343148E14971E5930E9E1"> Comment configurer Dynamic Media dans AEM 6.2. </li> 
     <li id="li_5F9B644D992840F395477A340E078544">Configuration et bonnes pratiques pour l’imagerie Dynamic Media. </li> 
     <li id="li_CF200832AB4A4B53B98434EA8DEAFE5F">Configuration et bonnes pratiques pour la vidéo Dynamic Media. </li> 
