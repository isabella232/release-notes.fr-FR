...
* Ajout de fonctions au code visitorAPI.js qui déterminent si le service d’ID a généré l’[!DNL  Marketing Cloud] ID du visiteur côté client ou côté serveur ou si les appels d’identifiants sont expirés. Voir les sections relatives aux [fonctions de suivi de dépassement de délai](https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid-timeout-functions.html) et au [suivi de la génération d’identifiants de visiteurs côté client](https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid-client-side-id.html). (MCID-116)

**Problèmes connus**

Les clients qui utilisent [!DNL  Audience Manager] le code DIL et le code visitorapi. js sur la même page doivent définir la variable ` secureDataCollection= false`DIL. Voir [secureDataCollection](https://marketing.adobe.com/resources/help/en_US/aam/?f=dil-secure-data-collection.html).
...
* Prise en charge du code DIL pour le partage des ressources Cross-Origin (CORS). Voir [useCorsOnly](https://marketing.adobe.com/resources/help/en_US/aam/?f=dil-use-cors-only.html). (AAM-25319, AAM-20139).
...
* Le code DIL peut maintenant émettre des appels HTTPS sécurisés par défaut. Les clients qui utilisent [!DNL  Audience Manager] le code DIL et le code visitorapi. js sur la même page doivent définir la variable ` secureDataCollection= false`DIL. Voir [secureDataCollection](https://marketing.adobe.com/resources/help/en_US/aam/?f=dil-secure-data-collection.html).
