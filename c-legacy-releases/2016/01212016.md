...
| Fonction | Description |
|--- |--- |
| Aperçu  page | La page Aperçu répertorie désormais les applications récemment consultées par chaque utilisateur au lieu de chaque application pour votre entreprise Analytics. |
