---
description: Nouvelles fonctionnalités d’Analysis Workspace (annulation des actions, option Enregistrer sous dans la segmentation, liens vers les projets, nouvelles visualisations, etc.). Fonction avancée de moyenne cumulée dans les mesures calculées (Analytics). Authentification unique de Marketing Cloud (Report Builder). Notifications des administrateurs des publications de propriétés (Dynamic Tag Management). Flux de données privés sans marque pour l’Audience Marketplace (Audience Manager). Correctifs et améliorations d’ordre général dans les solutions.
...
<table id="table_22414D3AA4CE4B199BC88898AADD3903"> 
 ...
 <tbody> 
  <tr valign="top"> 
   <td colname="col1"> <p>Notifications d’administration pour les publications de propriétés </p> </td> 
   <td colname="col2"> <p>Les administrateurs peuvent désormais recevoir une notification par courrier électronique lorsqu’une de leurs propriétés web est publiée. Le courrier électronique contient l’heure et le nom de la propriété. </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td colname="col1"> <p>Noms d’hôte relatifs </p> </td> 
   <td colname="col2"> <p>Vous pouvez spécifier des noms d’hôte relatifs pour l’hébergement de bibliothèques d’évaluation et de production. </p> </td> 
  </tr> 
  <tr valign="top"> 
...
* Correction d’un problème lors de l’utilisation de plusieurs règles de événement personnalisées en raison duquel seule la première règle se déclenchait. (DTM-7026)
* Correction d’un problème qui empêchait le chargement de la bibliothèque principale pour certains clients. (DTM-7130)
* Correction d’un problème lié à Internet Explorer 9 en raison duquel le compteur de durée de consultation de la page de Nielsen restait en pause lorsque le navigateur ou l’onglet du navigateur perdait puis recouvrait la cible d’action. (DTM-7033)
* Dans Internet Explorer 8, le mécanisme de détection non humaine dans les formulaires ne fonctionne pas correctement. Comme Internet Explorer 8 n’est plus pris en charge, ce problème ne sera pas résolu. Veuillez mettre à niveau votre navigateur si vous rencontrez un problème. (DTM-7101)
...
>[!NOTE]
>
>Dans la version de maintenance de juillet 2016, les analyses ad hoc ne prendront plus en charge Java 6.
...
<table id="table_FDDBAC10B423475289A83A653402E2F3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> Les préfixes d’identifiant de suite de rapports ne sont plus modifiables. Le service à la clientèle ou les gestionnaires de compte ne peuvent plus modifier de préfixes ni créer de suites de rapports sans préfixes. <a href="https://docs.adobe.com/content/help/fr-FR/analytics/admin/manage-report-suites/new-report-suite/new-report-suite.html" format="https" scope="external"> Plus... </a> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Créateur de mesures calculées </td> 
   <td colname="col2"> La fonction avancée Moyenne cumulée est désormais disponible dans le créateur de mesures calculées. <a href="https://docs.adobe.com/content/help/en/analytics/components/calculated-metrics/calcmetrics-reference/cm-adv-functions.html" format="https" scope="external"> Plus... </a> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Autorisations de création de segment/mesure </td> 
   <td colname="col2"> Si un utilisateur ne dispose pas des autorisations de création de segment ou de mesure, il ne peut plus accéder au créateur de segments ou au créateur de mesures calculées. <a href="https://docs.adobe.com/content/help/fr-FR/analytics/admin/user-product-management/user-groups/groups.html" format="https" scope="external"> Plus... </a> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Estimation des appels au serveur et planification des pics </td> 
   <td colname="col2"> Permet d’obtenir la moyenne des appels quotidiens au serveur de l’année dernière pendant une période spécifique, plus une augmentation prévue du volume des appels au serveur pour cette année. Vous pouvez ainsi prévoir un pic de trafic d’après ce facteur de multiplication. <a href="https://docs.adobe.com/content/help/en/analytics/admin/traffic-management/traffic-spike-estimate-past-server-calls.html" format="https" scope="external"> Plus... </a> </td> 
  </tr> 
 </tbody> 
</table>
...
Pour plus d’informations sur ces fonctionnalités, voir [Nouvelles fonctionnalités d’Analysis Workspace : janvier 2016](https://docs.adobe.com/content/help/en/analytics/analyze/analysis-workspace/new-features-in-analysis-workspace.html)
...
|---|---|
| Authentification unique | Prise en charge Ajoutée de la connexion unique au Marketing Cloud. |
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      <li id="li_3E59DBFECA4A4662AB039194F4BF1E9D">La mesure Instances de référent a été modifiée de telle sorte que le système utilise le premier accès d’une visite au lieu de <span class="varname">visit_page_num</span>. <span class="varname"> visit_ page_ num</span> ne varie pas au-delà des limites des mois lors de la fusion de nouveaux mois. (AN-89779)</li> 
      <li id="li_8BCED303EC1E4D008E7D3862142EDF30">(AN-116415) Modification de l’affichage des versions du navigateur Microsoft Edge dans les rapports, afin qu’elles suivent les versions du moteur EdgeHTML sous-jacent plutôt que celles de l’application Edge. Par exemple, les rapports afficheront le nom attendu d’Edge 12 et 13 plutôt que d’Edge 20 ou 25. </li> 
      <li id="li_294227DF6E1346F18F5FA38805A5C2C3">(AN-114795) Correction de problèmes survenant lorsque la page Mes rapports recommandés insérait des éléments de widgets provenant d’une même classification. </li> 
      ...
      <li id="li_E4909E533B864E948E9E8B27A84D8A15">(AN-114146) Correction d’un problème en raison duquel les autorisations ne sont pas accordées aux administrateurs dans l’interface utilisateur du rapports. </li> 
      ...
      <li id="li_19FF0A1F7B524FFF998A6EE58F3E1F64">(AN-113792) Correction d’un problème en raison duquel les graphiques ne s’alignaient pas sur les plages de dates sélectionnées. </li> 
      <li id="li_DC6C29757E034F7BBB2CC6D0AD36075E">(AN-112854) Correction d’un problème lié à des prévisualisations de segments incohérentes liées aux différences de fuseau horaire. </li> 
      <li id="li_CDA5D6C6F58043EABD08467C80FD7403">(AN-114796) Correction d’un problème lié aux graphiques illisibles dans les tableaux de bord. </li> 
      ...
      <li id="li_ABA29425A7C74422A5CF5333ACCA2E73">(AN-116951 + AN-113917) Correction d’un problème qui empêchait l’accès aux données des applications mobiles. </li> 
      <li id="li_6F60B031FFD94AACA974B029B99DF3AB">(AN-115159) Correction d’un problème en raison duquel le rapport Page suivante n’affichait que 10 pages. </li> 
      ...
      <li id="li_67706A910F1A4C199B7481B6A2D7C4FA">(AN-116040) Correction de problèmes liés à la recherche, aux colonnes et aux plages de dates dans le journal des rapports. </li> 
      <li id="li_E7573A014EF0414E8E7B6F548034C5C8">(AN-93186) Correction d’un problème de ventilation par type de navigateur ou type de système d’exploitation. </li> 
      <li id="li_EE3722FD26634D5D9423ABD9776A59CE">(AN-115887) Correction d’un problème en raison duquel les paramètres de segment partagé étaient remplacés lors d’une tentative de partage avec une nouvelle personne. </li> 
      <li id="li_9420B1CC3404443B911BD7D02010C6CA">(AN-113559) Correction d’un problème de tri inversé dans les petits rapports. </li> 
      <li id="li_CF8C511B25064E6681A9E2F07650F952">(AN-101851) Correction d’un problème en raison duquel, dans les rapports de tendances et au fil du temps, seul le premier segment de plusieurs segments était appliqué aux données. </li> 
      ...
      <li id="li_668850F29FB94B1F8348D34532B9E8BB">(AN-115952) Correction d’un problème en raison duquel les paramètres d’enregistrement des événements uniques pour les Événements de réussite n’étaient pas conservés. </li> 
      <li id="li_BBD6C9E0FB8C4CFEA3F1356003C9EE5F">(AN-107567) Correction d’un problème lié au codage des couleurs des mesures calculées. Dans Reports &amp; Analytics, la couleur (vert ou rouge) de la colonne de modification des rapports de comparaison dépend désormais du paramètre de polarité de la mesure donnée. </li> 
      <li id="li_A8D3F843405240888BC8686578321008">(AN-116521) Correction d’un problème en raison duquel le temps de réponse de l’interface utilisateur était ralenti lors de la modification de nombreuses suites de rapports. </li> 
      <li id="li_703C6AE547154BB9A6D535E376DC6479">(AN-113889) Problème connu : Vous ne pouvez pas utiliser de liens de rapports (URL) si votre société utilise une authentification unique héritée ou se connecte par le biais du Marketing Cloud. S’applique également aux projets d’Analysis Workspace. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_EAE1705BFB6E4A6E9A615283D84255BC"> 
     <li id="li_6733014E4EA64040AFD88F0E12DA1BE5"> (AN-113537) Amélioration de l’interface afin de permettre des largeurs de 1/3 et 2/3 pour les panneaux et les visualisations (auparavant, l’interface permettait des largeurs de 1/4 et 1/2). </li> 
     ...
     <li id="li_1734A619577D4F159CB1C710717DA619">(AN-114881) Amélioration du délai de chargement des projets et possibilité d’ouvrir davantage de panneaux et de visualisations sans réduction des performances. Les visualisations qui dépendent des données du panneau ne s’affichent pas avant que les données du projet ne se terminent. </li> 
     <li id="li_73155623CEA94A559125EBAADC95B700">(AN-114551) Amélioration de l’expérience de traitement en ajoutant des plages de dates et des mesures personnalisées au menu contextuel de ventilation. </li> 
     <li id="li_E0B8FF4CB5F24EF3A4653A018BF0D6A7">(AN-108368) Les plages de dates personnalisées s’affichent désormais avec des dates prédéfinies. </li> 
     ...
     <li id="li_43DE24B9F71A45EE87B6AFDBE3E4FA0E">(AN-115592) Correction d’un problème de rendu de visualisation qui empêchait l’affichage de plages de dates personnalisées dans les graphiques en courbes, comme les dimensions temporelles prédéfinies s’affichaient. Auparavant, une erreur était émise dans la visualisation pour les plages de dates personnalisées. </li> 
     ...
     <li id="li_38FF82E391614E0A8B94A5209F2FF041">(AN-116082) Correction d’un problème en raison duquel un symbole monétaire incorrect s’affichait dans certains graphiques. </li> 
     <li id="li_377AB2C88D9346EBAA9596C93A9A020A">(AN-115951) Correction d’un problème en raison duquel une erreur inattendue s’affichait lorsqu’un projet était ouvert et qu’un dépassement de délai survenait. </li> 
     ...
     <li id="li_88E561AC21D940029A899AFF5EA39AF0">(AN-114970) Correction d’un problème qui empêchait l’affichage de certains projets partagés dans la liste du projet. </li> 
     <li id="li_01940AA33CAA427C8DB09CCDE640F5DF">(AN-114957) Correction des conseils de repère de traitement afin qu’ils s’affichent pour l’élément d’interface correct et pour les utilisateurs correctement autorisés. </li> 
     ...
     <li id="li_AF9F0A35C9C149F19152BAD81E2CFA58">(AN-114253) Correction d’un problème en raison duquel les graphiques à barres de plusieurs lignes statiques disparaissaient en cas de suppression d’une ligne. </li> 
     <li id="li_8BB40B571184438EA75E19B3FBC33533">(AN-107079) Correction d’un problème en raison duquel aucune donnée renvoyée ne provoquait une erreur inattendue lors de la création d’un projet. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BCA85EDE14C2445C8C10BDD77ED342A6"> 
      ...
      <li id="li_7F6FDE746974409FACB9A7CFE72B6C24">(AN-114802) Correction d’un problème d’autorisations en raison duquel les dimensions n’étaient pas visibles. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9A4E12DD7F254411AA9452735D63CA80"> 
      <li id="li_A06DD2F318FF4187A23786FB44E2A8E6">Correction d’un problème lié aux valeurs Total secondes passées. Ils ne seront plus signalés comme négatifs lorsque les accès horodatés sont reçus hors service. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<!-- <draft-comment> 
    ...
    <ul id="ul_84D7A6675B6F4971A04A5D1B3B45DAB9"> 
     <li id="li_FF9A115336C34F4C858BCEE6D8D067B7">(AN-115381) Correction de la gestion du module Audience Manager lorsque des POST sont utilisés pour le suivi des appels. </li> 
...
* [Présentation du rapport de facturation des fournisseurs de données (en anglais)](https://marketing.adobe.com/resources/help/en_US/aam/marketplace-billing-report.html)
* [Présentation de la page des détails de la formule d’Audience Marketplace (en anglais)](https://marketing.adobe.com/resources/help/en_US/aam/marketplace-buyer-details.html)

Documentation révisée :

* [Données sur la taille de segment et les caractéristiques dans le créateur de segments (en anglais)](https://docs.adobe.com/content/help/fr-FR/audience-manager/user-guide/features/segments/segment-builder-data.html)
* [Macros de création de modèles sortants (en anglais)](https://marketing.adobe.com/resources/help/en_US/aam/outbound-template-macros.html)
* [Exemples de macros de création de modèles sortants (en anglais)](https://marketing.adobe.com/resources/help/en_US/aam/outbound-macro-examples.html)
...
* Amélioration de la fonction de recherche des balises pour permettre des recherches &quot;floues&quot;. Par exemple, pour trouver une balise nommée &quot;Adobe Social&quot;, un utilisateur peut taper &quot;Adobe&quot; ou &quot;Social&quot;. (AS-35219)
* Correction d’un problème qui empêchait les utilisateurs de modifier les noms de balises mal orthographiés en appuyant sur la touche Retour arrière lors du déplacement d’une balise d’un groupe à un autre. (AS-35788)
...
* Correction d’un problème en raison duquel une notification par courrier électronique erronée était envoyée à un utilisateur pour lui indiquer qu’il avait approuvé une publication. (AS-35783)
* Correction d’un problème qui provoquait parfois une erreur lors du géociblage des publications Facebook par ville. (AS-35711)
...
* Correction d’un problème en raison duquel les utilisateurs recevaient un message électronique erroné indiquant l’échec du suivi de campagne. (AS-35655)
* Correction d’un problème en raison duquel il manquait du contenu de publication dans les flux de modération. (AS-35648)
...
Ajouts et mises à jour significatifs de la documentation dans le Adobe Marketing Cloud.
