...
<table id="table_ECC01C3EA7E945E2A2092A68AD041AE1"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Vous pouvez à présent trier et filtrer la liste des messages. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
>[!IMPORTANT]
>
>L&#39;accès [!DNL  Target] à la fonctionnalité requiert [!DNL  Mobile Services] désormais que les utilisateurs soient connectés avec un Adobe ID fourni pour [!DNL  Target] leur entreprise. Il n’est plus possible de se connecter à l’aide du nom d’utilisateur et du mot de passe [!DNL  Target].

## Service Marketing Cloud ID {#mcvid}

La version 1.5.7 inclut les fonctionnalités et les correctifs suivants.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Mise en œuvre simplifiée pour les nouveaux clients </p> </td> 
   <td colname="col2"> <p>Les nouveaux utilisateurs qui se connectent à <span class="keyword">Analytics </span>via <span class="keyword">Marketing Cloud </span>peuvent rapidement implémenter <span class="keyword">Analytics </span>en utilisant la modale <span class="term">Prise en main d’Adobe Analytics</span>, puis en déployant Analytics à l’aide de la Dynamic Tag Management. </p> <p>Cette mise en œuvre simplifiée est hébergée par la Dynamic Tag Management et permet d’effectuer les opérations suivantes : </p> 
    ...
    </ul> <p>Pour plus d’informations, voir <a href="https://marketing.adobe.com/resources/help/en_US/dtm/get_started.html" format="html" scope="external">Mise en œuvre d’Analytics – Prise en main</a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> Le panneau <span class="wintitle">Comparaison de segment</span> d’<span class="wintitle">Analysis Workspace</span> permet aux clients de comparer rapidement deux segments <span class="keyword">Analytics</span> pour trouver les différences les plus significatives entre eux dans tous les points de données. <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/segment-comparison.html" format="html" scope="external"> Plus... </a> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="keyword">Analytics</span> comporte deux nouvelles autorisations utilisateur globales dans <span class="ignoretag"><span class="uicontrol">Administration</span> &gt; <span class="uicontrol">Gestion utilisateur</span> &gt; <span class="uicontrol">Groupes</span></span> : </p> 
    ...
    </ul> <p>Si un administrateur désactive ces autorisations pour un utilisateur, ce dernier ne peut pas afficher ni accéder aux options <span class="uicontrol">Rapports</span> et/ou <span class="uicontrol">Espace de travail</span> dans l’en-tête supérieur et dans la fonctionnalité de recherche globale d’<span class="wintitle">Analytics</span>. </p> <p>Le 16 juin, tous les utilisateurs seront ajoutés par défaut à ces groupes. <a href="https://marketing.adobe.com/resources/help/en_US/reference/groups.html" format="https" scope="external"> Plus... </a></p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      <li id="li_294227DF6E1346F18F5FA38805A5C2C3">Correction d’un problème qui entraînait l’affichage du message « Impossible de récupérer le petit rapport » dans les tableaux de bord. (AN-124302) </li> 
      <li id="li_EE649EA6A832445BB908D16552D6DE34">Correction d’un problème lié à l’affichage des rapports. Il entraînait l’affichage d’un élément en moins par rapport à ce qui était spécifié dans Configuration d’un graphique. (AN-116470) </li> 
      <li id="li_2538DAE2F697456EB832AF9011D466A6">Correction d’un problème lié à la fonctionnalité de visibilité des mesures dans le <span class="wintitle">Gestionnaire de suites de rapports </span>. Les événements masqués s’affichaient toujours dans l’interface utilisateur. (AN-123681) </li> 
      <li id="li_E88149C795AC411A8FFD48172CB0DF98">Correction d’un problème qui entraînait l’échec des requêtes des suites de rapports lorsque le nombre des suites de rapports était élevé. (AN-121845) </li> 
      <li id="li_132024B449D2421DA95427233A6D5AE4">Correction d’un problème en raison duquel les activations des suites de rapports étaient indiquées comme étant en attente alors qu’elles étaient déjà terminées. (AN-124558) </li> 
      <li id="li_544AE8193BC34D188ADFEDB1C6806B81">Correction d’un problème qui entraînait l’affichage d’un message d’erreur lors de l’ajout ou de la modification d’une mesure calculée. (AN-124564) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9DD79A9FD0014CA285E372FAD2BF9FE2"> 
      <li id="li_BE8C3497AA9A4FCA855130A0C7157F12">Modification de la définition de la valeur Aucun dans le rapport <span class="wintitle">Opérateur de téléphonie mobile</span>. La valeur Aucun englobe désormais les périphériques qui ne sont pas mobiles en plus des appareils mobiles. Le rapport est ainsi harmonisé avec Reports &amp; Analytics. (AN-122678) </li> 
      ...
      <li id="li_90E3D56B8BF7464D8A6BAF3AB37F97D8">Correction d’un problème en raison duquel il était impossible de télécharger des projets au format PDF. (AN-123231) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BCA85EDE14C2445C8C10BDD77ED342A6"> 
      <li id="li_FD1E9A3A72564BE293BBAF1BD13A0339">Modification de la définition de la valeur Aucun dans le rapport Opérateur de téléphonie mobile. La valeur Aucun englobe désormais les périphériques qui ne sont pas mobiles en plus des appareils mobiles. Le rapport est ainsi harmonisé avec <span class="wintitle">Reports &amp; Analytics</span>. (AN-122678) </li> 
      ...
      <li id="li_00A0F865791A4803806F850C7AE23BDC">Correction d’un problème qui entraînait une modification du calcul des lignes Aucun pour les dimensions de niveau visite avec une affectation récente. (AN-122279) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_0E0843493FA84006A1CD1A99979A6D46"> 
      <li id="li_957D7CB82F05431D897362BC0E832F3A">Correction d’un problème en raison duquel le détail de superposition était affiché en dessous des liens qui se trouvaient dans la partie inférieure d’une page. Il est désormais affiché au-dessus du lien. (AN-124049) </li> 
      <li id="li_EA95D325902E4EE98FFDB4A3D6ACA929">Correction d’un problème en raison duquel l’identifiant de zone géographique était signalé en tant que corps. (AN-122966) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9A4E12DD7F254411AA9452735D63CA80"> 
      ...
      <li id="li_14DE814ACD0A4F80AC9BD21A39C77FF9">Correction d’un problème lié au titre dans les rapports sur certaines mesures de participation. (AN-121371) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_F23DE2F2D2334D0CAA79386885F71D44"> 
      <li id="li_6129F26070C649E19B441F194E4FE7D7">Correction d’un problème en raison duquel des classifications de campagne étaient automatiquement créées pour des variables sans classifications. Les classifications ne sont plus créées automatiquement. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<!-- <draft-comment> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Pour obtenir des informations de mise à jour supplémentaires, reportez-vous à la section <a href="https://marketing.adobe.com/resources/help/en_US/insight/whatsnew/?f=c_release_notes_insight_62" format="http" scope="external">Mises à jour des Outils de données version 6.2</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Correction d’un bogue qui entraînait l’affichage incorrect de dates sur le graphique de caractéristiques uniques sur la page d’affichage des caractéristiques. (AAM-24598)
* Dans Audience Marketplace, les vendeurs de données peuvent désormais mettre à jour une carte de tarifs pour les flux de données actifs. (AAM-23476)

**Documentation nouvelle et révisée**

Documentation révisée :

* [Capture des données d’impression de campagne via des appels de pixel](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_doc_updates.html)
* [Environnement bêta](https://marketing.adobe.com/resources/help/en_US/aam/?f=beta_environment.html)
* [URL des API](https://marketing.adobe.com/resources/help/en_US/aam/?f=r_rest_urls.html)
...
* Correction d’un problème en raison duquel la demande d’un flux après une réaffectation ne fonctionnait pas correctement (deux utilisateurs étaient en mesure de revendiquer un même tweet et de travailler dessus simultanément). (AS-37190)
* Correction d’un problème en raison duquel la publication d’une vidéo volumineuse sur Facebook générait une erreur et plusieurs publications dos à dos. (AS-36176)
...
<table id="table_C6AADED0926246FAA06AFA5DE1974671"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> 
    <p> Il s’agit de la première intégration de Primetime à l’interface Adobe Marketing Cloud. La première itération de ce tableau de bord QoS vous permet de suivre le nombre de demandes d’insertion publicitaire côté serveur, les taux de succès des demandes et le nombre d’erreurs HTTP dans des formats interactifs. Ce tableau de bord est surtout extensible et permet à Primetime de tirer pleinement parti du Marketing Cloud. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_99BD3F007D164A2AA415E78C633D7927"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Diffuser rapidement des expériences web complexes est un véritable défi. Pendant cette formation, vous découvrirez les problèmes courants liés à la mise en œuvre, des informations de théorie, des exemples et des bonnes pratiques. Cette formation propose également une démonstration d’outils qui couvre les sujets suivants : </p> <p> 
     <ul id="ul_3480CEB0C48F40BABEEC8146C8E1518E"> 
      ...
      <li id="li_C217FB0BA3EF4FBEA5B65020AEE708A4"> <p>Identification des problèmes liés à la lenteur des demandes du serveur AEM. </p> </li> 
      <li id="li_BF00D8A008674EE29FE0042EC58B8B95"> <p>Réduction du traitement de JavaScript. </p> </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_04819C0464594ECFB211C253C34E69CA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>OAK 1.0.30 peut être téléchargé et installé. Pour plus d’informations, consultez la liste des correctifs recommandés pour AEM 6.0. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ce Feature Pack comprend des corrections, de nouvelles fonctionnalités et des améliorations pour la version AEM 6.1 Communities </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe Experience Manager comprend une IU classique et une IU optimisée pour les écrans tactiles. La rubrique intitulée Recommandations concernant l’interface utilisateur pour les clients peut vous aider dans votre choix d’interface utilisateur. Ces informations s’avèrent utiles pendant la mise en œuvre d’un projet ou une mise à jour à partir d’une version précédente. </p> </td> 
  </tr> 
  <tr> 
