...
La documentation comprend de nouvelles procédures pour [!DNL  Target]. See [Implement the Marketing Cloud ID Service With Analytics ](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-setup-target.html).
