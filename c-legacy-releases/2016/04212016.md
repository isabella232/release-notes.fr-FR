...
>[!IMPORTANT]
>
>Avis de connexion pour les utilisateurs [!DNL  Recommendations Classic] et [!DNL  Search&Promote]. Dans l’interface de Marketing Cloud mise à jour, vous pouvez accéder à ces liens à partir du menu **[!UICONTROL Analyses]** > **[!UICONTROL Outils]**.
...
Voir [Nouveautés du Marketing Cloud - Printemps 2016](https://marketing.adobe.com/resources/help/fr_FR/mcloud/marketing-cloud-interface.html) pour plus d’informations.
...
La documentation comprend de nouvelles procédures pour [!DNL  Target]. Voir [Mise en oeuvre du service d’identification des Marketings Cloud avec Analytics ](https://docs.adobe.com/content/help/fr-FR/id-service/using/home.html).
...
Outre les fonctionnalités répertoriées dans la section [Nouvelles fonctionnalités d’Analytics](../../c-legacy-releases/2016/04212016.md#features_analytics), Analytics Premium propose les nouvelles fonctionnalités supplémentaires suivantes :
...
<table id="table_37DB222470C84C3184D8E98E5D9B146D"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> Mise en oeuvre de la capacité d’échelle dans les visualisations <a href="https://marketing.adobe.com/resources/help/en_US/insight/client/c_chord_visualization.html" format="https" scope="external"> Cordes </a> et <a href="https://marketing.adobe.com/resources/help/en_US/insight/client/c_pie_chart.html" format="https" scope="external"> Diagramme circulaire </a>. Vous pouvez les mettre à l’échelle en maintenant la touche &lt;Ctrl&gt; enfoncée et en utilisant la molette de la souris, ou en cliquant avec le bouton droit sur la bordure de la fenêtre, en sélectionnant l’échelle et en saisissant une valeur. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Accès au statut détaillé </td> 
   <td colname="col2"> <p> L'accès à <b>Statut détaillé</b> est désormais limité par défaut aux utilisateurs et aux administrateurs de l'alimentation. </p> </td> 
  </tr> 
  <tr> 
    ...
    <ul id="ul_7B6DDED9E1FE47328FDB5422A547AE52"> 
     ...
     <li id="li_5F0C233BD3CA4BA5A688A96059B640C0"> <p>Modifications de l’arborescence de configuration (Insight.cfg) : </p> 
      <ul id="ul_E7711DB0E1354CC48022459B8829F47D"> 
       <li id="li_6E3E8A99C66548608DCF62DC040B4B5D"> <p>Message d’avertissement pour le champ Insight.cfg <b>Taille maximale du journal de suivi</b>. </p> </li> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_8749613B44F54464A90E4F700680351F">Modification des variables de liste : une limite maximale de 250 valeurs stockées simultanément par visiteur a été établie pour <a href="https://marketing.adobe.com/resources/help/fr_FR/sc/implement/listN.html" format="https" scope="external">les variables de liste </a>. Si cette limite de 250 valeurs par visiteur est dépassée, seules les 250 dernières valeurs sont utilisées. L’expiration de ces valeurs dépend de l’expiration configurée pour la variable. (AN-119172) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    ...
    </codeblock> <p>Les versions affectées sont <span class="term"> AppMeasurement pour le Flash </span> version 4.0 et antérieure sur toutes les plateformes. </p> <p>Remarque :  Pour des raisons de sécurité, nous ne diffuserons plus une version AS2 de <i>AppMeasurement pour le Flash</i>. La prise en charge de la collecte de données des projets existants basés sur la version AS2 est maintenue. Cependant, nous recommandons vivement aux clients de mettre à niveau leurs implémentations vers AS3 et d'incorporer les dernières fonctionnalités de sécurité d'<i>AppMeasurement pour le Flash</i>. </p> <p> <span class="term"> Les  </span> clients AppMeasurement pour Flash affectés par ce problème doivent recréer des projets avec la bibliothèque mise à jour disponible au téléchargement à partir de la console Analytics  <a href="https://help.adobe.com/en_US/Flex/4.0/UsingFlashBuilder/WS6f97d7caa66ef6eb1e63e3d11b6c4d0d21-7feb.html#WS6f97d7caa66ef6eb1e63e3d11b6c4d0d21-7f88" format="http" scope="external"> Plus...  </a> (AN-121780) </p> <p> <b> <span class="keyword"> AppMeasurement</span> pour d’autres plateformes</b> </p> <p>Voir l’<a href="https://marketing.adobe.com/resources/help/en_US/sc/appmeasurement/release/index.html" scope="external" format="https">historique de publication d’AppMeasurement</a> pour obtenir un historique sur les publications d’<span class="keyword">AppMeasurement</span> sur les plateformes suivantes : </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     ...
     <ul id="ul_8405C43A9E2842EF8DF875C8BCDBA86B"> 
      <li id="li_B52F124D6E714FFF815785885FDDD0B2">Problème d’erreur du modèle de score de propension. La définition de la cible dans la visualisation Score de propension lors de l’affichage de <b>Score terminé</b> renvoie "Erreur lors de la compilation de ScoreDim x Aucun modèle de score". Avec un score de propension, vous pouvez sélectionner Aller avec un modèle de génération. Si vous définissez une cible et appliquez le filtre (Cible &gt; Nom), puis cliquez sur OK, une erreur est générée. La solution consiste à cliquer sur <b>Réinitialiser</b> &gt; <b>Réinitialiser le modèle</b>, puis à appuyer sur <b>Aller</b> pour créer sans problème. </li> 
...
>[!IMPORTANT]
>
>Dans l’interface de Marketing Cloud mise à jour, vous pouvez accéder au Search &amp; Promote à partir du menu **[!UICONTROL Analyses]** > **[!UICONTROL Outils]**. Vous pouvez également vous connecter directement à l’aide de : [https://center.atomz.com/center/](https://center.atomz.com/center/).
...
L’aide Advertising Cloud est disponible dans le produit à l’adresse **[!UICONTROL ?  > Rubriques d’aide]**.
