...
<table id="table_C9B288CF42034F329C3C72D95D22E515"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Améliorations apportées à Marketing Cloud Assets </p> </td> 
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>La version 1.2 de l’API des services Web a été officiellement abandonnée le 20 février 2014. Elle sera en fin de vie le 15 septembre 2016. Adobe supprimera alors la capacité des serveurs d’API à répondre aux demandes d’API de la version 1.2. Toutes les demandes d’API effectuées au point de terminaison <span class="filepath">https://api.omniture.com/admin/1.2</span> retourneront une erreur 404. Les clients ont jusqu’à la date de fin de vie pour mettre à niveau la version 1.2 de l’API vers la version 1.4, afin d’éviter toute interruption de service de leurs applications API. 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Depuis début février 2016, Adobe ne prend plus en charge SSLv3. Cette modification a un impact sur le Report Builder, les demandes de collecte de données et les demandes aux API des services Web Analytics. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Code postal britannique </p> </td> 
   <td colname="col2"> <p>Le prestataire géographique Adobe est en train de changer la façon dont nous recevons les codes postaux du Royaume-Uni. Nous fournirons des codes postaux complets depuis le 18 mars ou aux alentours de ce jour. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A51B298EEEB5482383505B8C5A79E1B9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
     ...
     <li id="li_741A006D5EEE4612AD7BF748BB6742A4">Correction d’un problème de gestion des utilisateurs/réinitialisation du mot de passe en raison duquel l’administrateur se connectait avec les informations d’identification de Marketing Cloud générait une erreur. (AN-108518) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9A4E12DD7F254411AA9452735D63CA80"> 
      <li id="li_A06DD2F318FF4187A23786FB44E2A8E6">Correction d’un problème en raison duquel les rapports planifiés par Data warehouse n’étaient pas distribués. (AN-118182) </li> 
      <li id="li_142ACEB3BA1D40F4A6DACBD970860278">Correction d’un problème en raison duquel le rapports de Data warehouse ne classait pas correctement les eVars 76+. (AN-118867) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p class="important">Remarque : La version 1.2 de l’API des services Web a été officiellement abandonnée le 20 février 2014. Elle sera en fin de vie le 15 septembre 2016. Adobe supprimera alors la capacité des serveurs d’API à répondre aux demandes d’API de la version 1.2. Toutes les demandes d’API effectuées au point de terminaison <span class="filepath">https://api.omniture.com/admin/1.2</span> retourneront une erreur 404. Les clients ont jusqu’à la date de fin de vie pour mettre à niveau la version 1.2 de l’API vers la version 1.4 pour empêcher toute interruption de service de leurs applications API. 
...
* Correction d’un bogue en raison duquel les utilisateurs ne disposant pas d’autorisations d’administrateur pouvaient créer une règle de fusion de profil. (AAM-22433)Améliorations :
...
<table id="table_45E49397B42D4B7198FC947C6C79483D"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> AEM 6.1 Service Pack 1 est une mise à jour importante qui comprend des améliorations et correctifs concernant les performances, la stabilité, la sécurité et les clients clés depuis la mise à disposition générale d’AEM 6.1 en mai 2015. SP1 peut être installé sur la version GA d’AEM 6.1. </p> <p> La de présentation de cette page répertorie les modifications ajoutées au SP1. Voici quelques-uns des points saillants du Service Pack : </p> 
    <ul id="ul_F553DE837B8C4F67A31D224F93225E8F"> 
     ...
     <li id="li_F27A48CEBC1E4293B2C5989BB65C7B33"> Inclut le pack de mise à jour de l’interface utilisateur optimisé pour les écrans tactiles (Feature Pack 6563) pour AEM 6.1. </li> 
     <li id="li_9C15CE0BD76D46F9B0917B17700BB5BD"> Comprend des correctifs critiques pour l’intégration des Adobes Target. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> AEM 6.0 Service Pack 3 (SP3) est une mise à jour importante qui comprend des correctifs et améliorations concernant la sécurité, les performances, la stabilité et les clients clés depuis la mise à disposition générale d’AEM 6.0 en mai 2014. Service Pack 3 contient toutes les modifications introduites avec Service Pack 2. Il peut être installé sur AEM 6.0 GA, AEM 6.0 SP1 et AEM 6.0 SP2. </p> <p> La section de présentation de cette page répertorie les modifications ajoutées au SP3. Les modifications incluses du SP2 sont répertoriées dans les <a href="https://docs.adobe.com/docs/en/aem/6-0/release-notes-sp2.html" format="https" scope="external">notes de mise à jour du Service Pack 2 </a>. </p> <p> Voici quelques points saillants du Service Pack : </p> 
...
Ajouts et mises à jour significatifs de la documentation dans l’Adobe Marketing Cloud des versions précédentes.
...
<table id="table_D245BAB62A304D5B9018375ABFEFFC09"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Refonte de la documentation du produit Adobe Mobile. </p> </td> 
   <td colname="col3"> <p>22 mai 2015 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Si vous capturez des données clients d’entreprise dans une base de données de gestion de la relation client, vous pouvez les transférer dans Marketing Cloud. </p> </td> 
   <td colname="col3"> <p>19 mars 2015 </p> </td> 
  </tr> 
  <tr> 
