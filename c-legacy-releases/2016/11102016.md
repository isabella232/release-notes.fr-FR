...
>* Grâce à la bibliothèque 2.0.0+ du service d’ID de Marketing Cloud, la synchronisation des identifiants commencera par défaut pour Adobe Advertising Cloud. Voir [Comprendre la synchronisation des identifiants et les taux de correspondance](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-match-rates.html).
...
* Ajout d’un ` TS = *`horodatage UTC`*` en tant que propriété de la fonction ` visitor.appendVisitorIDsTo`. Le service d’ID utilise l’horodatage pour déterminer si les identifiants doivent être utilisés dans l’URL de redirection selon un intervalle d’âge de 5 minutes. Voir [Fonction d’ajout d’identifiant visiteur](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-appendvisitorid.html). (MCID-219)
...
* Résolution d’un bogue qui empêchait le service ID de transmettre le [!DNL  Marketing Cloud] ID (MID) à différents domaines. (MCID-215) Voir la documentation du produit [Service Marketing Cloud ID](https://docs.adobe.com/content/help/fr-FR/id-service/using/home.html).
...
<table id="table_3D79042552CA4F608A57688E642C7841"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Depuis iOS 9.2, les liens profonds ne sont plus pris en charge. Les liens universels (iOS) et les liens d’application (Android) constituent la nouvelle méthode de création de liens profonds dans votre application ou site Web. </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_F413249D8B4B48F79D6EBA73D4C9E7F5">Correction d’un certain nombre de problèmes liés aux autorisations apparus dans la version d’octobre. (AN-133298, AN-133399, AN-132985, AN-133124, AN-133217, AN-133122) </li> 
      <li id="li_6B1B0D2C4A0C4156AE964CC4D27C2027">Correction de plusieurs problèmes liés aux alertes apparus dans la version d’octobre. (AN-132996, AN-133307, AN-133268, AN-133247, AN-133407) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9DD79A9FD0014CA285E372FAD2BF9FE2"> 
      ...
      <li id="li_BE8C3497AA9A4FCA855130A0C7157F12">Correction de problèmes liés aux visualisations de texte qui empêchaient leur enregistrement et entraînaient l’affichage de projets vides. (AN-133355) </li> 
      <li id="li_8E6EB700F40C4D26BBC2E8D9B937F5AC">Correction d’un problème en raison duquel les paramètres sur deux axes n’étaient pas enregistrés ou chargés correctement. (AN-133315, AN-133177, AN-133096) </li> 
      <li id="li_9CD496E14AC649B1BA30B339CB19422C">Correction d’un problème en raison duquel les segments à l’intérieur des fonctions (dans les mesures calculées) n’étaient pas enregistrés. (AN-133305) </li> 
      ...
      <li id="li_2851CA5E366F42A680CAD9482ADB93DA">Correction d’un problème qui empêchait la modification de segments par des utilisateurs non administrateurs. (AN-133269) </li> 
      <li id="li_9D8A1EFAFF8D490F8F15CD50DDAA5DFB">Correction d’un problème lié au widget Calendrier. Désormais, lors de l'ouverture du widget Calendrier, le premier clic (qu'il s'agisse de la droite/du début ou de la gauche/de la fin du calendrier) indique la date de début de la période.(AN-133263) </li> 
      <li id="li_194C1A0009984F13866AEA3D2CC16425">Correction d’un problème en raison duquel la fonction de comparaison de segments se bloquait. (AN-133222) </li> 
      ...
      <li id="li_C976AF0B62814BC19FCAC8C25E75E407">Correction d’un problème en raison duquel toutes les ventilations de la section solution / pages étaient réinitialisées. Les clients ont dû rajouter toutes les ventilations. (AN-133177) </li> 
      <li id="li_D6660DB6252C4228A3340C6868C7D5E4">Correction d’un problème en raison duquel le graphique à barres horizontales n’ajustait pas sa taille en fonction du nombre de lignes sélectionnées. Les barres horizontales ont désormais une hauteur minimale et une barre de défilement verticale a été ajoutée pour s’adapter à certaines situations. (AN-132939, AN-133177) </li> 
      ...
      <li id="li_ADA65FD51F3C4BBEAE51F2EA8E13E32C">Correction d’un problème qui empêchait la copie de projets. (AN-133309) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9A4E12DD7F254411AA9452735D63CA80"> 
      <li id="li_A06DD2F318FF4187A23786FB44E2A8E6"> Mise à jour de l’entrepôt de données pour qu’il suive les règles de Reports &amp; Analytics en ce qui concerne l’utilisation de la mention Autre pour le nom des pages des rapports. Cela se produit principalement lorsque le nom de la page est vide. (AN-131951) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9A5FC169793F4266922D1352CF0428AE"> 
      <li id="li_D46A0F2C1481431BA3E8E076BA1C9FE0">Correction d’une erreur qui se produisait lors de l’activation d’un jeu de règles de classification. (AN-130658) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Flux de données du parcours de navigation </p> </td> 
   <td colname="col2"> <p> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Les nouvelles fonctionnalités comprennent une interface utilisateur repensée, des améliorations de rapport incluant les taux de correspondance au niveau du segment et des options de retour en arrière supplémentaires pour le rapports. Voir <a href="https://marketing.adobe.com/resources/help/en_US/aam/addressable-audiences.html" format="https" scope="external">Audiences adressables</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* De petites modifications ont été apportées à l’interface utilisateur et aux workflows de la fonctionnalité Lien de profil afin de prendre en charge les options d’Adobe Marketing Cloud Device Co-op. (AAM-25988) Voir Lien [](https://marketing.adobe.com/resources/help/en_US/aam/profile-link-intro.html)de Profil.

**Améliorations**

* Nouvelle option de définition des identifiants pour toutes les sources de données sur plusieurs périphériques : les identifiants d’une source de données sur plusieurs périphériques peuvent désormais être définis comme &quot;personne&quot; ou &quot;foyer&quot;. Cette définition indique la relation qui existe entre l’ID de plusieurs périphériques et l’ID d’Audience Manager. L’option par défaut pour toutes les sources de données multipériphériques existantes sera Personne. Voir le document [Créer des sources](https://docs.adobe.com/content/help/fr-FR/audience-manager/user-guide/features/data-sources/manage-datasources.html#create-data-source) de données. (AAM-25988)
...
<table id="table_9D23A6C03A0C45B5AD4D545B703723AA"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Les Filtres de règles d’écoute Twitter sont migrés vers de nouveaux Filtres. Ces migrations seront automatiques et peuvent influencer les résultats. Aucun ajustement n'est nécessaire. </p> <p>Les opérateurs des Filtres suivants seront modifiés : Le bio contient, le bio nom contient, le code du pays, la langue, l’URL contient. </p> <p> Les Filtres suivants seront abandonnés : Langage biographique, emplacement biographique contient, contient, emplacement contient. Pour les règles incluant ces filtres, elles continueront à exister mais n’extrairont plus de données. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A86BCBB810894CDEB2A807F2A19F73D2"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p> Inclut des fonctionnalités clés telles que les expériences de navigation de contenu enrichi (bannières dynamiques) et les notifications Push Android. Inclut également la prise en charge complète de l’interface utilisateur Coral 3. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p> <a href="https://docs.adobe.com/content/help/fr-FR/dynamic-media-developer-resources/release-notes/s7rn2017.html" format="https" scope="external"> Version d’automne des visionneuses Scene7 </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Activation de la prise en charge des clients pour les opérations suivantes : </p> <p> 
     <ul id="ul_B38451AECBC0406BA724969365464ED1"> 
      <li id="li_739A1BA7CEF84AD7BFF82211D1239E64">Monétisez les pages Storify 2 en créant un bouton "Afficher plus" configurable et en activant le contenu sous l'application. </li> 
      <li id="li_1B766FA9071648098C2541B96A3F3627">Traitez le contenu au moyen de flux RSS avec divers formats afin de prendre en charge une liste étendue de sources incluant YouKu, Pinterest, Vimeo, etc. </li> 
      <li id="li_E42F347B56204C7CBE93C3E98BAB066A">Configurez le niveau d’imbrication et le nombre de réponses à charger dans les commentaires afin d’améliorer l’expérience utilisateur. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col2"> <p>IMMERSE </p> </td> 
   <td colname="col3"> <p>IMMERSE est une conférence virtuelle internationale des développeurs pour AEM. </p> <p>Notre première conférence s'est tenue en avril dernier. Il a été si bien accueilli que l'Adobe Systems a décidé de faire de ce événement annuel un plus grand contenu. Notre programme complet inclut désormais un salon des expositions, des tables rondes en petits groupes et des salons de réseautage. IMMERSE17 a lieu du 15 au 19 mai 2017 Vous pouvez y participer sans quitter le confort de votre bureau ou de votre domicile, en fonction du lieu où vous vous trouvez. <a href="https://docs.adobe.com/dev/products/aem/events/0416.html" format="https" scope="external"> En savoir plus </a>. </p> <p>Partagez votre expertise avec la communauté. L'appel IMMERSE pour Presentations est ouvert. Vérifiez les conditions requises et proposez votre session <a href="https://goo.gl/forms/a9HOKLkfB6SwS7KR2" format="https" scope="external">ici</a>. Les présentateurs obtiennent un laissez-passer gratuit et l'accès aux 75 sessions. </p> <p>Êtes-vous activement impliqué dans la communauté des développeurs AEM ? Votre société veut-elle être considérée comme un soutien majeur de la communauté ? Consultez le prospectus <a href="https://files.acrobat.com/a/preview/a2b82990-996a-47a2-aeed-909189ecb159" format="https" scope="external">IMMERSE17 Sponsorship</a> (en anglais) pour découvrir comment vous impliquer dans cette communauté. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>Poser des questions aux experts de la communauté AEM </p> </td> 
   <td colname="col3"> <p>La session de novembre est "Bonnes pratiques pour l’utilisation de l’Experience Manager et de Adobe Campaign". </p> <p>Formateur technique Adobe pour l'Adobe Worldwide Field Enablement, Abhishek Dwevedi donne des instructions sur l'utilisation conjointe de Adobe Experience Manager et Adobe Campaign. </p> <p> 29 novembre 2016, de 8:00 à 9:00 (Pacifique). </p> <p> <a href="https://communities.adobe.com/content/usergenerated/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/_jcr_content/par/calendar/ask_the_aem_communit_6.form.html/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/upcoming-event-detail" format="https" scope="external">Les informations sur la session se trouvent ici</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>AEM GEMS </p> </td> 
   <td colname="col3"> <p> 
     <ul id="ul_B48A3A49928549FBAB09F57DF4E163AD"> 
      <li id="li_00999D77C173495EB80C53843DE390DC"> <p>"Présentation d’AEM Screens" </p> <p>aem screens est la nouvelle solution de signalisation numérique intégrée à Adobe Experience Manager. Dans cette session AEM Gems, nous présenterons les principales fonctionnalités de AEM Screens et comment configurer un projet simple avec un diaporama et une expérience interactive. Nous donnons ensuite un aperçu de la manière de développer des composants optimisés pour AEM Screens et de configurer des Canaux pour une utilisation hors ligne. Enfin, nous allons explorer l'API REST d'AEM Screens et expliquer comment intégrer des plug-ins Cordova personnalisés. </p> <p>Vous pouvez choisir parmi les deux sessions suivantes : </p> <p> 
      ...
      <li id="li_208C9492C62740FC9331891C0BC6F115"> <p>Des tests d’unité aux tests d’intégration pour une application Experience Manager. </p> <p>Des tests automatiques sont indispensables pour développer des applications. Cette présentation AEM GEMS vous guide à travers divers outils que vous pouvez utiliser pour tester le code Java, en commençant par les bases du test d'unité jusqu'aux tests fonctionnels et d'intégration. Découvrez comment ajouter des tests de la manière la plus efficace à votre base de code, que vous souhaitiez tester une méthode d’utilitaire simple, un service OSGi ou un point de terminaison HTTP. </p> <p>14 décembre 2016, de 8:00 à 9:00 (Pacifique). Rejoignez Carsten Ziegeler (chef de projet, développement de logiciels) et Robert Munteanu (développeur) pour cette session en direct. <a href="https://communities.adobe.com/en/communities/aem_technologistsdevelopersarchitects/events.html" format="https" scope="external"> Confirmez ici votre participation à cette session </a>. </p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> 
    <ul id="ul_D2101E2880894DCEBB2C396B96062B58"> 
     <li id="li_010CC4B9077E42EB8B830EAA5C79EF9D"> <p>"Bonnes pratiques pour les Experience Manager et les AEM Assets" </p> <p>Abhishek Dwevedi, formateur technique Adobe pour Adobe Worldwide Field Enablement, parle de l'utilisation de AEM Assets. Regardez cette session pré-enregistrée pour découvrir les meilleures pratiques d’utilisation des ressources dans le Experience Manager. </p> <p> <a href="https://bit.ly/ATACE92016" format="http" scope="external"> Regardez l’enregistrement de la version Adobe Connect </a>. </p> <p> <a href="https://bit.ly/ATACE92016MP4" format="http" scope="external"> Regardez l’enregistrement de la version MP4 </a>. </p> </li> 
     <li id="li_349F5DBF90754DCF93B6D3C251B32C73"> <p>Configuration du module DAM pour l’entreprise </p> <p>Cette session est conçue pour vous aider à améliorer la réussite de l’exploitation de AEM Assets. La session se concentre sur les cas d’utilisation de clients DAM Enterprise réels, leurs défis et les solutions qui ont été créées pour les prendre en charge et augmenter le succès qu’ils constatent avec DAM. </p> <p>Les sujets abordés au cours de la session sont les suivants : </p> <p> 
       <ul id="ul_515B26FA4B1A4354967DEC9D34886B37"> 
        <li id="li_E44DFFBFE2D24D81BD68C741673EF868"> <p>Défis commerciaux des clients d’entreprise, tels que l’assimilation à grande échelle, les applications de bureau, l’optimisation des performances et le dimensionnement. </p> </li> 
        <li id="li_903E529927A148B4B59F0F34E6BAB1A3"> <p>Informations sur les améliorations apportées aux fonctionnalités qui prennent en charge les clients d’entreprise, les cas d’utilisation des clients en phase avec les défis de l’entreprise et la feuille de route des produits. </p> </li> 
       </ul> </p> <p>En regardant cette session, vous comprendrez mieux comment utiliser DAM dans vos environnements. En lisant des études de cas de clients réels et de participants travaillant avec un DAM existant, vous comprendrez comment les nouvelles solutions fournies par cette offre peuvent aider vos workflows existants et comprendre la technologie. </p> <p> <a href="https://bit.ly/GEMS10616" format="http" scope="external"> Regardez l’enregistrement de la version Adobe Connect </a>. </p> <p> <a href="https://bit.ly/GEMS10416MP4" format="http" scope="external"> Regardez l’enregistrement de la version MP4 </a>. </p> </li> 
     <li id="li_C916481D23AD4F7A9CCF639EE69D4611"> <p>"analyse comparative de l'architecture des grandes installations Experience Manager" </p> <p>Cette session couvre les architectures à grande échelle de l'expérience du présentateur avec Cisco et Symantec. Ils comparent et contrastent l'architecture à l'échelle de l'architecture d'infrastructure, les intégrations e-commerce et l'approche de migration de l'héritage vers Adobe Experience Manager, les intégrations de Marketings Cloud numériques telles que la personnalisation, l'analyse et la gestion des données. </p> <p> <a href="https://bit.ly/atace102516" format="http" scope="external"> Regardez l’enregistrement de la version Adobe Connect </a>. </p> <p> <a href="https://bit.ly/ATACE102516MP4" format="http" scope="external"> Regardez l’enregistrement de la version MP4 </a>. </p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>(Google AdWords) De nouvelles colonnes de feuille d’envoi groupé sont disponibles pour les annonces d’installation d’application mobile : plateforme de l’application mobile, identifiant de l’application mobile, nom de l’application mobile et exclusion de la tablette. </p> <p>Si l’annonceur utilise la redirection EF, vous pouvez éventuellement ajouter du code de suivi aux URL de la publicité lorsque vous téléchargez ou publiez une feuille de calcul. Le paramètre de portfolio défini sur le paramètre "Téléchargement automatique pendant la synchronisation" s’applique également aux publicités d’un portfolio. Les paramètres de suivi dépendent du partenaire de mesure mobile spécifié pour l’annonceur. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Recherche Campaign Bêta </p> </td> 
   <td colname="col2"> <p>Vous pouvez maintenant gérer les paramètres de Yahoo! Groupes publicitaires japonais. </p> <p>Vous pouvez également configurer des sites Web négatifs pour les campagnes Google AdWords et Yahoo Gemini et les groupes publicitaires Google. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Campagnes gérées en display </p> </td> 
   <td colname="col2"> <p>Facebook a abandonné Facebook Exchange (FBX) le 1er novembre 2016 et vos publicités FBX existantes ne s’exécutent plus. Toutes les créations FBX et stratégies publicitaires que vous avez créées précédemment restent suspendues en Advertising Cloud à des fins de rapports. Vous pouvez les supprimer, mais vous ne pouvez pas les activer ni les modifier, ni créer de nouveaux éléments créatifs ou stratégies publicitaires FBX. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Tranches horaires </p> </td> 
   <td colname="col2"> <p>Tous les utilisateurs peuvent désormais configurer la division du jour pour toute stratégie publicitaire. Pour activer une planification, vous devez activer la fonction de planification de tranche horaire disponible dans la section de ciblage de la stratégie publicitaire. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Afficher l'Audience </p> </td> 
   <td colname="col2"> <p>Pour chaque liste de segments, vous pouvez désormais afficher l’audience adressable totale (taille d’audience attendue) pour chaque segment, en plus du nombre de visiteurs uniques pour des incréments de temps spécifiques. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_D245BAB62A304D5B9018375ABFEFFC09"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> La version de l’automne 2016 d’Adobe Analytics comprend plusieurs mises à jour de la gestion des groupes et des autorisations. Veuillez consulter les informations suivantes. </p> </td> 
