...
Le SDK iOS version 4.8.6 (9 mars 2016) comprend les modifications suivantes :

| Fonction | Description |
|--- |--- |
| Suivi des blocages d’application | La version 4.8.6 du SDK  iOS comporte des modifications critiques qui empêchent le signalement de faux plantages. Nous vous recommandons vivement d’installer la version 4.8.6. |
...
| Fonction | Description |
|--- |--- |
| Prise en charge du droit d’opposition | Le service Marketing Cloud ID prend en charge les demandes d’exclusion des visiteurs. (AAM-21725) |
...
Révision des procédures d&#39;implémentation du service d&#39;ID pour les clients [!DNL  Analytics]. See [Set Up the Marketing Cloud ID Service with Analytics](https://docs.adobe.com/content/help/fr-FR/id-service/using/home.html).
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_81ED9C850197465BB2E8ACE1AC9C59E6">Correction d’un problème en raison duquel le mot de passe ne pouvait pas être réinitialisé pour les noms d’utilisateur de plus de 20 caractères. (AN-115603) </li> 
      <li id="li_A477D5A9DEAE4B4092990612AB2A0A59">Correction d’un problème lié à l’Analyse des contributions en raison duquel les étiquettes du panneau déroulant étaient dupliquées. (AN-118627) </li> 
      <li id="li_11840BC1D1A74248A1AD9E9B509BA5BD">Correction d’un problème en raison duquel les petits rapports de tableau de bord n’affichaient pas les données lorsque la granularité quotidienne était sélectionnée. (AN-117755) </li> 
      <li id="li_680B0AA9884B450B9E88CA9885C698FD">Correction d’un problème en raison duquel le paramètre de séparation des milliers revenait au format Etats-Unis (à partir d’un format allemand). (AN-117894) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_018BD45725944884BBF0B4C61116F5EF"> 
      <li id="li_12A2EED797D440649E4C4CC89434CC84">Correction d’un problème survenant lors du glissement et du dépôt de composants l’un après l’autre trop rapidement. Ce problème entraînait la persistance des indicateurs de perte noire dans le tableau si vous faisiez glisser un composant alors qu’une autre demande était en cours de traitement. (AN-118836) </li> 
      ...
      <li id="li_9AFA60D53A8F42FD8392E3C4E2D25F29">Correction d’un problème en raison duquel les visualisations réinitialisaient leur position lorsqu’un projet était actualisé, dans de rares cas. (AN-115865) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BCA85EDE14C2445C8C10BDD77ED342A6"> 
      <li id="li_FD1E9A3A72564BE293BBAF1BD13A0339">Correction d’un problème qui empêchait l’ouverture de l’Ad Hoc Analysis lors du lancement de celle-ci à partir du Adobe Marketing Cloud avec un Adobe ID. (AN-102875) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
* Correction d’un bogue en raison duquel les rapports de tendance affichaient des résultats un jour de congé à partir de la date actuelle. Concerne uniquement les fuseaux horaires d&#39;Europe de l&#39;Est. (AAM-22321)
* Correction d’un bogue en Audience Marketplace qui empêchait les fournisseurs de données d’activer un flux de données privé sans marque. (AAM-23377)
* Modification de l’option de type d’identifiant dans le processus de création de la source de données en &quot;Device Advertising ID&quot; (auparavant &quot;Mobile&quot;). (AAM-22947)
...
* Correction d’un problème de l’interface utilisateur en raison duquel les publications dans les flux de modération contenant de longs liens contenaient des barres de défilement horizontales.
...
adobe conseille aux clients avec des déploiements sur site de déployer les derniers correctifs recommandés afin d’assurer une stabilité, une sécurité et des performances plus élevées.

| Forum AEM Assets | Description |
|--- |--- |
| Forum AEM Assets | Notre nouveau sous-forum AEM Assets est maintenant en ligne. Ce forum couvre : Ressources (sur site), Ressources à la demande, Portail de marques, Contenu multimédia dynamique et Scene7. Tout le monde est libre de se connecter et de publier, il suffit de se connecter avec votre Adobe ID. |


| Conférence | Description |
|--- |--- |
| Adobe Immerse | Immerse est une conférence virtuelle des développeurs d’Adobe Experience Manager, qui a lieu du 25 au 29 avril. Quiconque responsable de la conception, du développement, du déploiement ou de la maintenance de mises en œuvre Adobe Experience Manager a tout intérêt à participer à cet événement.  Pour obtenir des billets et des détails, veuillez consulter le site Web Adobe Immerse. |

| Dispatcher  | Description |
|--- |--- |
| Dispatcher 4.1.12 | Une nouvelle version du répartiteur est disponible en téléchargement. |
