...
Révision des procédures d&#39;implémentation du service d&#39;ID pour les clients [!DNL  Analytics]. Voir [Configuration du service d’identification des Marketings Cloud avec Analytics](https://docs.adobe.com/content/help/fr-FR/id-service/using/home.html).
...
|--- |--- |
| Forum AEM Assets | Notre nouveau sous-forum AEM Assets est maintenant en ligne. Ce forum couvre : Actifs (sur site), Actifs à la demande, Portail de marques, Dynamic Media et Scene7. Tout le monde est libre de se connecter et de publier, il suffit de se connecter avec votre Adobe ID. |
