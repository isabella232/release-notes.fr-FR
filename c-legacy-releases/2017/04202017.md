...
En savoir plus sur l’annonce [Adobe Experience Cloud](https://www.adobe.com/experience-cloud.html) lors du sommet Adobe 2017.
...
* Nous avons amélioré la fonctionnalité Profile Link. Cette fonctionnalité associe désormais un [UUID Audience Manager](https://marketing.adobe.com/resources/help/en_US/aam/ids-in-aam.html) à trois autres UUID Audience Manager, pour un total de 4 UUID Audience Manager dans un cluster. (AAM-28808)
* Nous exposons maintenant les ID de segment de test ([SID et csegID](https://marketing.adobe.com/resources/help/en_US/aam/ids-in-aam.html)) avec un paramètre de requête testSegments = true dans les API suivantes (AAM- 27591) :
   * ` .../v1/segments`
   * ` .../v1/destinations/<destinationId>/mappings`

* Les méthodes API de segments ont été migrées vers Swagger. Pour plus d&#39;informations, voir [Migration du code de l’API Audience Manager](https://marketing.adobe.com/resources/help/en_US/aam/c_api_swagger.html). (AAM-28601)
...
Consultez les [Notes de mise à jour d’Adobe Target](https://marketing.adobe.com/resources/help/en_US/target/rn/) pour obtenir des informations récentes sur les produits suivants :
...
Adobe a publié un [bulletin de sécurité pour Adobe Campaign](https://helpx.adobe.com/security/products/campaign/apsb17-09.html) v6.11 pour Windows et Linux.
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>La nouvelle version de la source de données inverse de Media Optimizer vers Analytics améliore de façon significative l’exactitude des données. Tous les annonceurs publicitaires possédant l’intégration Analytics seront mis à niveau vers la source de données inverse dans les semaines à venir. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Vous pouvez à présent créer des audiences Google (listes de marketing de relance pour la recherche d’annonces) via des listes d’adresses électroniques ou des segments provenant de vos audiences Adobe Experience Cloud existantes : </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      ...
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Segments Adobe Audience Manager : (version bêta uniquement pour les annonceurs publicitaires approuvés) depuis Campagnes bêta &amp;gt; Audiences &amp;gt; Audiences, vous pouvez créer une audience basée sur des étiquettes depuis un site web Google depuis n’importe quel segment Audience Manager ayant une destination Media Optimizer. Cela peut comprendre les segments Adobe Analytics publiés sur Adobe Experience Cloud et les segments créés dans Adobe Experience Cloud via le service clé People. Media Optimizer va automatiquement renvoyer une URL de suivi Google vers les segments Audience Manager afin que Google puisse suivre l’audience. </li> 
     </ul> </p> <p>Media Optimizer ne stocke aucune des données client contenues dans vos listes d’adresses électroniques ou segments Audience Manager utilisés pour créer ou modifier une audience Google. </p> </td> 
  </tr> 
  <tr> 
