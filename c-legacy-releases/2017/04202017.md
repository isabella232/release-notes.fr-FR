...
Les recettes d’exemple d’utilisation sont là pour vous montrer comment mettre en œuvre et déployer les flux de travail et les intégrations de solutions croisées. D’autres vidéos de démonstration et des recettes de développement personnel seront bientôt disponibles.
...
* Processus de publication : correction d’un problème en raison duquel les utilisateurs qui ignoraient une approbation de processus continuaient de recevoir des notifications d’approbation. Seuls les approbateurs recevront un message d’approbation pour une publication.
...
<table id="table_B8FB3E741CFF4C3AA561C191182484ED">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Vous pouvez à présent utiliser les notifications push périodiques dans un flux de travail. Les notifications périodiques vous permettent d’envoyer la même notification push d’application mobile plusieurs fois au même destinataire ou à une audience dynamique à une fréquence particulière (journalière, mensuelle, etc.). </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Connecteur Amazon Simple Storage Service (S3) </p> </td> 
   <td colname="col2"> <p> Le connecteur Amazon Simple Storage Service (S3) peut maintenant être utilisé pour importer ou exporter les données dans Adobe Campaign. Il peut être configuré dans une activité de flux de travail. La configuration a lieu dans un compte externe. </p> </td> 
  </tr> 
  <tr> 
