...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Une nouvelle version du flux de données inversé de Advertising Cloud vers Analytics améliore considérablement la précision des données. Tous les annonceurs publicitaires possédant l’intégration Analytics seront mis à niveau vers la source de données inverse dans les semaines à venir. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Vous pouvez à présent créer des audiences Google (listes de marketing de relance pour la recherche d’annonces) via des listes d’adresses électroniques ou des segments provenant de vos audiences Adobe Experience Cloud existantes : </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      ...
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Segments d’Adobe Audience Manager : (Bêta pour les annonceurs autorisés uniquement) De Campagnes Bêta &amp;gt; Audiences &amp;gt; Audiences, vous pouvez créer une audience basée sur les balises d’un site Web Google à partir de n’importe quel segment d’Audience Manager dont la destination est Advertising Cloud. Cela peut comprendre les segments Adobe Analytics publiés sur Adobe Experience Cloud et les segments créés dans Adobe Experience Cloud via le service clé People. Advertising Cloud renvoie automatiquement une URL de suivi Google aux segments d’Audience Manager afin que Google puisse suivre l’audience. </li> 
     </ul> </p> <p>Advertising Cloud ne stocke aucune des données client de vos listes d’adresses électroniques ou des segments Audience Manager utilisés pour créer ou modifier une audience Google. </p> </td> 
  </tr> 
  <tr> 
