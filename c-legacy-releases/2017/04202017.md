...
* Les méthodes API de segments ont été migrées vers Swagger. Voir [Migration du code de l’API d’Audience Manager](https://marketing.adobe.com/resources/help/en_US/aam/c_api_swagger.html). (AAM-28601)
