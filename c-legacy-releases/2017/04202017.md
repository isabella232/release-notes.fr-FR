...
Correctifs et mises à jour mineures appliqués aux outils et composants de l’interface d’Adobe Analytics (Analysis Workspace, Rapports et analyses, créateur de rapports, etc.).
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_0B70B5AEE69143D9A5FFA290478E845D"> 
      <li id="li_4188BBF771B4437AA5FF3240C46FB1D3">Correction d’un problème survenant lorsque, par exemple, aucun clic sur les liens n’était collecté pour une période sélectionnée. Cela entraînait l’blocage de la barre d’outils de Carte d’activités. (AN-140163, AN-140119, AN-136186) </li> 
...
* Les méthodes API de segments ont été migrées vers Swagger. Voir Migration [du code de l’API](https://marketing.adobe.com/resources/help/en_US/aam/c_api_swagger.html)Audience Manager. (AAM-28601)
...
* Correction d’un bogue visuel en raison duquel des icônes incorrectes s’affichaient dans le module de réinitialisation de mot de passe, dans Audience Marketplace et dans le tri des colonnes dans les pages de liste dans l’interface utilisateur. (AAM-28953)
* Correction d’un problème dans l’interface d’administration d’Audience Manager en raison duquel un identifiant d’utilisateur final Audience Marketplace ne pouvait pas être ajouté à une société. (AAM-28953)
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col2"> <p>Packs de correctifs cumulés d’AEM Oak </p> </td> 
   <td colname="col3"> <p>Les derniers packs de correctifs cumulatifs AEM Oak recommandés sont disponibles aux emplacements suivants : </p> <p> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Vous pouvez désormais créer des audiences Google (remarketing listes pour les publicités de recherche) à l’aide de listes électroniques ou de segments provenant de vos audiences Adobe Experience Cloud existantes : </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      ...
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Segments d’Adobe Audience Manager : (Les annonceurs autorisés ne sont pas autorisés dans la version bêta) De Campagnes bêta &amp;gt; Audiences &amp;gt; Audiences, vous pouvez créer une audience basée sur les balises d’un site Web Google à partir de n’importe quel segment d’Audience Manager dont la destination est Advertising Cloud. Cela peut inclure les segments Adobe Analytics publiés sur Adobe Experience Cloud et les segments créés dans Adobe Experience Cloud à l’aide du service principal Personnes. Advertising Cloud renvoie automatiquement une URL de suivi Google aux segments d’Audience Manager afin que Google puisse suivre l’audience. </li> 
     </ul> </p> <p>Advertising Cloud ne stocke aucune des données client de vos listes de messagerie électronique ou segments Audience Manager utilisés pour créer ou modifier une audience Google. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Recherche Campaign Bêta </p> </td> 
   <td colname="col2"> <p>(Les annonceurs autorisés uniquement) Une nouvelle interface utilisateur de la version bêta de la recherche sera disponible la semaine suivant la publication, avec : </p> <p> 
