...
Nouvelles fonctionnalités et correctifs de l’interface d’[!DNL  Adobe Experience Cloud].
...
* Les utilisateurs liés à des [ID d’organisation](https://marketing.adobe.com/resources/help/en_US/aam/ids-in-aam.html) peuvent désormais se connecter dans l’interface utilisateur d’Audience Manager grâce à leur Adobe ID plutôt qu’avec leur nom d’utilisateur et leur mot de passe. (AAM-28161)
* L’écran de recherche dans Audience Marketplace possède désormais un lien vers [Audience Finder](https://www.adobe-audience-finder.com/). Grâce à Audience Finder, trouvez des partenaires susceptibles de vous fournir le bon type de flux de données pour votre campagne. (AAM-30241)
...
[Le code DIL](https://marketing.adobe.com/resources/help/en_US/aam/dil-overview.html) constitue le code de collecte de données d’API d’Audience Manager. La version d’août incrémente le DIL à la version 6.11.
...
Nous avons revu la documentation concernant l’utilisation de nos API de serveur de collecte des données (DCS). Commencez par [Méthodes et code des API de serveur DCS](https://marketing.adobe.com/resources/help/en_US/aam/dcs-intro.html) et progressez jusqu’à la réalisation d’opérations plus complexes avec nos API de DCS.
