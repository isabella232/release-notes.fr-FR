...
* Les utilisateurs liés à [ID d&#39;organisation](https://docs.adobe.com/content/help/fr-FR/audience-manager/user-guide/reference/ids-in-aam.html) peuvent désormais se connecter à l&#39;interface utilisateur de l&#39;Audience Manager avec leur Adobe ID au lieu de leur nom d&#39;utilisateur et de leur mot de passe. (AAM-28161)
...
Nous avons réécrit la documentation sur la manière de travailler avec nos API DCS (Data Collection Server). Début avec les [méthodes et le code d&#39;API du serveur DCS ](https://marketing.adobe.com/resources/help/en_US/aam/dcs-intro.html) et vous aider à mener à bien des opérations plus complexes avec nos API DCS.
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Découvrez l'architecture d'AEM Dynamic Media 6.3, présentée par Cynthia Tillo, chef de produit principal de l'Adobe. Cette session d'une heure a lieu le mercredi 30 août 2017 à partir de 8:00 HAP. Pour vous inscrire, cliquez <a href="https://www.meetup.com/AEM-Technologist-Group/events/241999511/" format="https" scope="external">ici </a>. </p> </td> 
  </tr> 
  <tr> 
