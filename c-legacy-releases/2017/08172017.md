...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>La fonction de publication Cloud synchronise désormais les liens de site partagés Yahoo Gemini créés dans Yahoo et attribue les recettes aux clics sur les liens de site vers la publicité et le mot-clé appropriés. </p> <p>Vous pouvez également modifier les liens de sites dans les feuilles d’envoi groupé. Le paramètre « Description » n'est pas encore pris en charge, mais le cloud de publication ne modifie pas les valeurs existantes. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Gestionnaires client et administrateurs Direct Access uniquement) Vous pouvez autoriser la publicité à extraire les métadonnées, les données de hiérarchie et les données d'audience unique pour les segments Audience Manager dans la recherche de publicités et d'amp ; gt ; Campagnes bêta &amp; amp ; gt ; Vue Audiences. Pour configurer un annonceur, saisissez l’ID du partenaire de l’annonceur pour Adobe Audience Manager dans Search Advertising &amp;gt; Admin &amp;gt; Configuration Audience Manager. </p> </td> 
  </tr> 
 </tbody> 
</table>
