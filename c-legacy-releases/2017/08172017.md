...
* Nous avons ajouté une nouvelle configuration ` isCoopSafe`. Il s’agit d’une configuration booléenne facultative permettant de déterminer si DIL envoie des données à [!DNL  Adobe Marketing Cloud Device Co-op]. Voir [isCoopSafe](https://marketing.adobe.com/resources/help/en_US/aam/dil-coopsafe.html). (CORE-4334)
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Advertising Cloud synchronise désormais les liens de site partagés Yahoo Gemini créés dans Yahoo, et attribue les recettes des clics sur les liens de site à la publicité et au mot-clé appropriés. </p> <p>Vous pouvez également modifier les liens de sites dans les feuilles d’envoi groupé. Le paramètre "Description" n’est pas encore pris en charge, mais Advertising Cloud ne modifiera pas vos valeurs existantes. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Gestionnaires et administrateurs clients Direct Access uniquement) Vous pouvez autoriser Advertising Cloud à extraire des métadonnées, des données de hiérarchie et des données d’audience uniques pour les segments Audience Manager dans l’&amp;gt; de la publicité de recherche. Campagnes bêta &amp;gt; Vue Audiences. Pour configurer un annonceur, saisissez l’ID du partenaire de l’annonceur pour Adobe Audience Manager dans Search Advertising &amp;gt; Admin &amp;gt; Configuration Audience Manager. </p> </td> 
  </tr> 
 </tbody> 
</table>
