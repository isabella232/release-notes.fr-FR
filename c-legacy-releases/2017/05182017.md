...
[La section Comprendre la synchronisation des identifiants et les taux de correspondance](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html) inclut de nouvelles informations sur l’appel ` cm.eversttech.net` envoyé par le service de Marketing Cloud ID à [!DNL  Adobe Media Optimizer].
