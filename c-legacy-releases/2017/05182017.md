...
* Les virgules Ajoutées correspondent au nombre maximal de limites d’utilisation pour les caractéristiques, les segments, les destinations, etc. Voir [Limites d’utilisation](https://marketing.adobe.com/resources/help/fr_FR/aam/usage-limits.html). (AAM-29310)
...
<!-- <draft-comment> 
  ...
  <tr> 
   <td colname="col1"> <p>Email Cci </p> </td> 
