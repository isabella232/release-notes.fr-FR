...
>[!IMPORTANT]
>
>Launch est actuellement déployé de manière incrémentielle auprès des clients Adobe Experience Cloud. Si vous souhaitez avoir une chance d’obtenir un accès anticipé, veuillez nous le faire savoir en entrant les informations requises dans le [formulaire de décharge de lancement](https://adobe.allegiancetech.com/cgi-bin/qwebcorporate.dll?WVFJ3K).
