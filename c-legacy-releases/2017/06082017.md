...
* Validation Ajoutée pour les clés de données contextuelles afin de correspondre à ce qu’Analytics accepte. (MOB-7365)
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_267B24EF2B314D828148D37F0820477E"> 
     ...
     <li id="li_EA730D9F90E2490A97029032785A1590">Capacité Ajoutée à nommer et à gérer plus facilement les groupes de points de contact (ajout, suppression, déplacement, etc.) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Microsoft Power BI est une suite de tableaux de bord d’analyse commerciale permettant d’analyser les données et de partager les informations. L’intégration d’Adobe Analytics à Power BI inclut la possibilité de visualiser les données Analytics du Report Builder dans Microsoft Power BI. </p> <p>Grâce à Power BI, vous pouvez intégrer Adobe Analytics à d’autres sources de données (par exemple, point de vente, gestion de la relation client) afin de découvrir des informations client, des associations et des opportunités uniques, et de les partager facilement dans l’ensemble de votre organisation. L’association de la fonctionnalité de génération de rapports du Report Builder aux fonctionnalités de Power BI rend les informations plus accessibles via le web pour tous les membres de l’organisation. </p> <p>L’intégration avec le Report Builder Adobe vous permet de : </p> 
    <ul id="ul_48CC72D3E88B4CCAB6762A32E68E5764"> 
     ...
     <li id="li_5F609B1158D849F7886EB789CA78488D">Publiez toutes les tables formatées du classeur sous forme de tables de jeux de données Power BI. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_DAB0360A2EB74CE7B7D9D20D19C3F6AE"> 
     <li id="li_CD2EE3675FD045A2B1A2BD960C0F7F2A">Correction d’un problème en raison duquel les données de l’rapports Ad Hoc Analysis et Analysis Workspace étaient incorrectes pour l’Activité des Cibles. (AN-141435) </li> 
     ...
     <li id="li_B64C547F580041AFBF081AFF40C58BCF">Correction d’un problème qui provoquait une erreur de création de segment lors de la vérification de l’option "Faire de ce segment une audience d’Marketing Cloud". (AN-142218, AN-143300) </li> 
     ...
     <li id="li_C06F93EF77314A8D9F04BF4077A996D1">Correction d’un problème en raison duquel les noms de groupes d’utilisateurs n’étaient pas classés par ordre alphabétique dans le Admin Console. (AN-142769, AN-142274) </li> 
     <li id="li_74750379709445DC97F22CC212C80E21">Correction d’un problème de Admin Console en raison duquel Ad Hoc Analysis n’était pas activé ou désactivé pour une suite de rapports. (AN-142529) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_3CA7C4AA4AE843719A755ECE64EE91B6"> 
      ...
      <li id="li_1A05EC9B86AD4D9BA09340BB64729864"> Correction d’un problème survenant lorsque la visibilité de la mesure était configurée, mais pas la polarité de la mesure. La couleur du changement de résumé qui en résultait en Analysis Workspace n'était pas comme prévu (rouge quand négatif, vert quand positif). (AN-143496, AN-143413) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_22809FEEE8AE48EBB2B8117A104F3866"> 
      ...
      <li id="li_3A917F2BEA204F7581E57E848CAF2C19"> Correction d’un bogue qui provoquait un affichage incorrect des titres de courrier électronique localisés. (AN-143626) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_A672990027F54771A41AFEABCFC8E243">Correction d’un problème en raison duquel l’option "Lien vers ce rapport" n’était pas disponible lorsque l’utilisateur se connectait par le biais du Marketing Cloud. (AN-118492) </li> 
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col2"> <p>Actifs 3D 2.0 sur AEM 6.3 </p> </td> 
   <td colname="col3"> <p>Feature Pack for 3D Assets on AEM 6.3, publié le 26 mai 2017. </p> <p>Amélioration des fonctionnalités 3D AEM des intégrations de fichiers 3D, de la gestion des DAM et du rendu 2D. </p> <p> <a href="https://docs.adobe.com/content/docs/en/aem/6-3/release-notes/aem3d-release-notes.html" format="https" scope="external"> Notes de mise à jour </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Les billets pour les sessions IMMERSE17 sur demande sont disponibles. Achetez-les <a href="https://vts.inxpo.com/Launch/QReg.htm?ShowKey=35334" format="https" scope="external">ici</a> et utilisez  
     <code>OD#1AEM</code> code. </p> <p>Les sessions disponibles sont les suivantes : </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Session de mai : Utilisation de modèles Lazybones et modifiables dans AEM projets. </p> <p> Rejoignez Ankur Ahlawat et Scott Macdonald pour une discussion sur l'utilisation des modèles Lazybones et Editable dans les projets AEM. </p> <p>En examinant cette session, vous pouvez apprendre à créer AEM projets qui tirent parti de Lazybones et des nouveaux modèles modifiables de vos projets. Enregistré le 30 mai 2017, 8 h 00 PDT (<a href="https://bit.ly/ATACE517" format="http" scope="external">https://bit.ly/ATACE517</a>). </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Le forum de la communauté Advertising Cloud a été renommé communauté Advertising Cloud et se trouve sur la page  <a href="https://forums.adobe.com/community/experience-cloud/advertising-cloud/overview" format="https" scope="external"> https://forums.adobe.com/community/experience-cloud/advertising-cloud/overview </a>. </p> </td> 
  </tr> 
  <tr> 
