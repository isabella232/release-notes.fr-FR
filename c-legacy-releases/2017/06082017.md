...
<table id="table_A2465769155C47F0A882D934C4B78511"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Ces configurations sont utilisées en tandem. Elles permettent à différentes instances du code du service d’ID implémentées dans un iFrame et sur la page parente de communiquer entre elles. Ils sont conçus pour aider à résoudre les problèmes liés à des cas d’utilisation spécifiques où vous pouvez contrôler ou non la page/le domaine parent et où le code du service d’ID est chargé dans l’iFrame d’un domaine que vous contrôlez. Elles sont disponibles dans le code VisitorAPI.js version 2.2 ou ultérieure. Voir <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/?=mcvid-whitelistdomain.html" format="https" scope="external">whitelistParentDomain et whitelistIframeDomains </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_DAB0360A2EB74CE7B7D9D20D19C3F6AE"> 
     <li id="li_CD2EE3675FD045A2B1A2BD960C0F7F2A">Correction d’un problème en raison duquel le rapports Analyses ad hoc et Analysis Workspace contenait des données incorrectes pour l’Activité des Cibles. (AN-141435) </li> 
     ...
     <li id="li_C06F93EF77314A8D9F04BF4077A996D1">Correction d’un problème en raison duquel les noms des groupes d’utilisateurs n’étaient pas classés par ordre alphabétique dans la Console d’administration. (AN-142769, AN-142274) </li> 
     <li id="li_74750379709445DC97F22CC212C80E21">Correction d’un problème de la Console d’administration en raison duquel les analyses ad hoc n’étaient pas activées ou désactivées pour une suite de rapports. (AN-142529) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_3CA7C4AA4AE843719A755ECE64EE91B6"> 
      ...
      <li id="li_1A05EC9B86AD4D9BA09340BB64729864"> Correction d’un problème survenant lorsque la visibilité de la mesure était configurée, mais pas la polarité de la mesure. La coloration Synthèse des changements résultante dans Analysis Workspace n’était pas comme prévu (rouge lorsqu’elle était négative, vert lorsqu’elle était positive). (AN-143496, AN-143413) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_A672990027F54771A41AFEABCFC8E243">Correction d’un problème en raison duquel l’option "Lien vers ce rapport" n’était pas disponible lorsque l’utilisateur se connectait via Marketing Cloud. (AN-118492) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_336B914674184FF9AC9602E0448FEFC0"> 
      <li id="li_6BB458583BE249189EDF2DC6480F75BA">Correction d’un problème en raison duquel Carte d’activités ne se chargeait pas correctement après la connexion. (AN-139709) </li> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Vous pouvez maintenant tester la création et la mise à jour des audiences de correspondance client de Google à l’aide de listes électroniques de votre propre système de gestion de la relation client (CRM). Pour plus d’informations, contactez votre gestionnaire de compte Advertising Cloud. </p> </td> 
  </tr> 
  <tr> 
