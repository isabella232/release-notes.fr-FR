...
[Utilisation de la prélecture DNS avec différentes solutions et services Marketing Cloud](
https://marketing.adobe.com/resources/help/en_US/mcloud/dns-prefetch.html)

Consultez la documentation du produit [Service de Marketing Cloud ID](https://marketing.adobe.com/resources/help/en_US/mcvid/).
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Historiquement, les administrateurs de flux de données devaient faire appel à l’assistance clientèle d’Adobe pour obtenir une mise à jour de l’état de leurs tâches de flux de données ou pour modifier leurs flux de données. Désormais, tous les administrateurs d’Adobe Analytics ont accès à l’interface utilisateur des flux de données. </p> <p>Utilisez l’interface Flux de données Analytics pour les opérations suivantes : </p> <p> 
     ...
     </ul> </p> <p>Le nom du service    <span class="term">Flux de données Clickstream </span>a été remplacé par <span class="term">Flux de données Analytics</span>. </p> <p>Pour en savoir plus, voir <a href="https://marketing.adobe.com/resources/help/en_US/reference/?f=analytics-data-feed" format="https" scope="external">Flux de données Analytics</a>. </p> </td> 
  </tr> 
  <tr> 
...
* Mise à jour du diagramme de Venn afin d’expliquer les modalités d’une audience adressable. Consultez [la documentation adressabled’Audience](https://marketing.adobe.com/resources/help/en_US/aam/addressable-audiences.html). (AAM-27559)
* Ajout d’une nouvelle macro de contenu &lt;DPUUIDS&gt; dans les fichiers de données sortants. Consultez les sections [Macros de modèles sortants](
https://marketing.adobe.com/resources/help/en_US/aam/outbound-template-macros.html) et [Exemples de macros sortantes](
https://marketing.adobe.com/resources/help/en_US/aam/outbound-macro-examples.html). (AAM-28000)
...
Consultez les [Notes de mise à jour de Primetime](https://help.adobe.com/en_US/primetime/release_notes/index.html) pour obtenir les informations les plus récentes.
