...
Voir la documentation du produit [Service d’identification des Marketings Cloud](https://docs.adobe.com/content/help/fr-FR/id-service/using/home.html).
...
* Mise à jour du diagramme de Venn afin d’expliquer les termes d’Audience adressable. Voir [Documentation sur les Audiences adressables](https://marketing.adobe.com/resources/help/en_US/aam/addressable-audiences.html). (AAM-27559)
* Ajoute une nouvelle macro de contenu &lt;DPUUIDS> dans les fichiers de données sortants. Voir [Macros de modèle sortantes](https://marketing.adobe.com/resources/help/en_US/aam/outbound-template-macros.html) et [Exemples de macros sortantes](https://marketing.adobe.com/resources/help/en_US/aam/outbound-macro-examples.html). (AAM-28000)
...
<table id="table_9752E921846F43C7A12ED9FCFF2DEFE3"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="https://helpx.adobe.com/fr/security/products/campaign/apsb17-06.html" format="html" scope="external"> Bulletin de sécurité </a> </p> </td> 
