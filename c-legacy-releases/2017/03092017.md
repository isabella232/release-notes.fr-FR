...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Les options d’optimisation automatique des ajustements d’offre permettent à Advertising Cloud de modifier automatiquement les paramètres d’ajustement d’offre pour les groupes publicitaires du portefeuille lorsque celui-ci est optimisé, afin d’optimiser les performances. Advertising Cloud peut optimiser les ajustements d’offres pour Google, Bing et Yahoo! les cibles de dispositifs mobiles au Japon ; les cibles de tablettes et d’ordinateurs Google et Bing ; les cibles RLSA Google ; et les cibles d’emplacement Google. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Comptes Bing Merchant Center avec URL finales) Un champ « Modèle de suivi » est disponible pour les groupes de produits dans les modèles Bing Shopping et dans les feuilles d’envoi groupé. </p> <p>Pour le suivi des conversions Advertising Cloud, vous n’avez pas besoin de saisir de valeur si vous disposez d’un modèle de suivi au niveau du compte, de la campagne ou du groupe publicitaire. </p> </td> 
  </tr> 
  <tr> 
