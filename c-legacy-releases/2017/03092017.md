...
* Migration des caractéristiques et des méthodes d’API de dossier vers Swagger. Pour plus d&#39;informations, voir [Migration du code de l’API Audience Manager](https://marketing.adobe.com/resources/help/en_US/aam/c_api_swagger.html). (AAM-28221 et AAM-27133)
...
Cette version corrige un bogue qui empêchait ` GA.submitUniversalAnalytics` d’envoyer des données aux serveurs de collecte de données. Pour plus d&#39;informations, voir [GA.submitUniversalAnalytics](https://marketing.adobe.com/resources/help/en_US/aam/dil-google-universal-analytics.html). (MCID-354)

**Documentation nouvelle et révisée**

**Nouveau**

La section [Utilisation de la prérécupération DNS avec différentes solutions Marketing Cloud](https://marketing.adobe.com/resources/help/en_US/mcloud/dns-prefetch.html) décrit comment vous pouvez utiliser la prérécupération DNS pour réduire le temps de chargement des pages.

**Révision**

* La section [Codes d’erreur, messages et exemples DCS](https://marketing.adobe.com/resources/help/en_US/aam/dcs_error_codes.html) inclue des avertissements d’intégration.
* La section [Noms de fichiers de données sortants](https://marketing.adobe.com/resources/help/en_US/aam/c_name_reqs_outbound.html) inclut le paramètre facultatif ` PID-ALIAS`.
* La section [Vue récapitulative du segment](https://marketing.adobe.com/resources/help/en_US/aam/c_segment_summary.html) inclut des intervalles de recherche de rapport.
* La section [Création de DIL](https://marketing.adobe.com/resources/help/en_US/aam/r_dil_create.html) contient de nouvelles informations sur la propriété ` containerNSID`.
* La section [Mesures d’Audience adressables](https://marketing.adobe.com/resources/help/en_US/aam/addressable-audience-metrics.html) comprend des définitions et une organisation de contenu révisées.
...
<table id="table_643B457098C94F8A8E1AFBFF8646DD2C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Le connecteur Amazon Simple Storage Service (S3) peut maintenant être utilisé pour importer ou exporter les données dans Adobe Campaign. Il peut être configuré dans l’activité d’un processus. La configuration a lieu dans un compte externe. </p> <p> <a href="https://docs.campaign.adobe.com/doc/AC/en/WKF_Repository_of_activities_Event_activities.html#File_transfer" format="html" scope="external"> Plus... </a> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_B8FB3E741CFF4C3AA561C191182484ED"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Permet de déclencher un processus à partir d’un autre processus, à l’aide de la nouvelle activité <b>Signal</b>. </p> <p>En ayant la possibilité de déclencher un flux de travail à partir d’un autre, vous pouvez désormais prendre en charge des itinéraires client plus complexes. Surveillez plus efficacement les itinéraires client et réagissez en cas de problème. </p> <p>Plusieurs activités de processus ont été mises à jour : </p> 
