...
Les clients Analytics peuvent mettre en oeuvre des intégrations personnalisées pour ExactTarget à l’aide des fonctionnalités et API Analytics standard, y compris les classifications, les sources de données, les règles de traitement et les exportations d’entrepôt de données. Les engagements avec l&#39;équipe de consultants Adobe peuvent être pris en compte si nécessaire.
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col02"> <p>21 septembre 2017 </p> </td> 
   <td colname="col2"> <p>A compter de mai 2018, les analyses ad hoc ne prendront en charge que Java 8 ou version ultérieure. Si vous choisissez d’exécuter les analyses ad hoc sur Java 7 après la version de maintenance de mai 2018, Adobe ne prendra plus en charge votre implémentation des analyses ad hoc. </p> <p>Nos fichiers .jar sont signés avec un chiffrement sécurisé de 256 bits qui n'est pas pris en charge par les versions Java inférieures à 1.7.0_76. Ce certificat 256 bits nous permet de vous offrir une sécurité renforcée. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Les dimensions basées sur l’horodatage ont été ajoutées prêt à l’emploi dans Analysis Workspace. Les dimensions sont les suivantes : </p> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> Adobe Analytics Cloud peut désormais effectuer le suivi des performances des assistants intelligents prenant en charge la voix, tels qu’Amazon Alexa, Google Assistant, Microsoft Cortana et Apple Siri. </p> <p>Voir les <a href="https://marketing.adobe.com/resources/help/en_US/reference/voice-analytics-faq.html" format="html" scope="external">questions fréquentes </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7FBF4B0EBC384CCBA1640F06FA379EAA"> 
      <li id="li_EB0401D8344340209AF1AFEABE440A34"> Correction d’un problème en raison duquel les segments utilisant "java_enabled" n’étaient pas gérés correctement pour les tâches de l’entrepôt de données. (AN-147372) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Fichiers journaux utilisables </p> </td> 
   <td colname="col2"> <p> Les fichiers journaux utilisables vous permettent de capturer des données multimédia à partir des journaux Google DCM et d’utiliser les données comme caractéristiques dans Audience Manager. Capturez les impressions, les clics et les conversions à partir des serveurs d’annonces en tant que caractéristiques sans avoir à utiliser d’appels de pixels. Voir <a href="https://marketing.adobe.com/resources/help/en_US/aam/actionable-log-files.html" format="https" scope="external">Fichiers journaux pratiques </a>. </p> </td> 
  </tr> 
  <tr> 
...
* Correction d’un problème en raison duquel les noms de segment Audience Manager mis à jour n’étaient pas envoyés vers des destinations DFP Google. (AAM-31677)
...
* Correction d’un bogue lié à Chrome en raison duquel DIL renvoyait une erreur lors du clic sur le bouton Précédent dans ce navigateur. (CORE-5135)
* Suppression des modules de code inutilisés. (CORE-4554)
* Le code DIL relance maintenant la synchronisation des identifiants lorsque l’identifiant de région dans la réponse d’appel du événement change. (CORE-4304)
...
<table id="table_7B50E9D0E6D340C1A589CE0713767285"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Grâce à cette amélioration de l’Abonnement de masse, vous pouvez désormais stocker des informations d’abonnement (origine et date) directement dans la base de données Adobe Campaign Standard par le biais de l’activité de Services d'inscription dans un processus. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_0225913B8D5D4B52982ED2E7F2095EEE"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Il est désormais possible de renvoyer des données comportementales d’Adobe Campaign Standard vers Adobe Campaign v7, ce qui permet aux spécialistes du marketing et aux analystes de données de créer une vue de 360° de campagnes marketing ; créer des audiences et des segments avancés qui intègrent des données comportementales ACS ; et mesurer plus efficacement le retour sur investissement des activités marketing. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>Cette version offre de nouvelles fonctions d’automatisation et de diffusion pour les clients de Contenu multimédia dynamique et est la première version ciblée pour les clients existants de Contenu multimédia dynamique classique (S7)-AEM à transition sur Contenu multimédia dynamique. </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Correction de plusieurs problèmes et actualisation de la documentation d’installation et de mise à niveau pour AEM Forms 6.3 JEE. </p> <p>Voir <a href="https://helpx.adobe.com/aem-forms/6-3/user-guide.html" format="https" scope="external">Installation et mise à niveau d’AEM Forms sur JEE</a> sous <b>Rubriques</b> dans le volet gauche. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>Prise en main du développement de sites AEM 6.3 - Didacticiel WKND </p> </td> 
   <td colname="col3"> <p>Le nouveau didacticiel de prise en main du développeur 6.3 est disponible en fonction des dernières technologies AEM suivantes : </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>La nouvelle documentation d’AEM Screens 6.3 est disponible. Vous pouvez également utiliser un démarrage rapide qui permet à un utilisateur de créer une expérience de signature numérique en 5 minutes. Consultez les ressources suivantes : </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Lorsqu’un composant d’une page Web est rendu, vous pouvez générer un élément HTML, enveloppant le composant rendu en lui-même. Pour les développeurs, AEM offre une logique claire et simple pour contrôler les balises de décoration qui enveloppent les composants inclus. </p> <p>Voir <a href="https://docs.adobe.com/docs/en/aem/6-3/develop/components/decoration-tag.html" format="https" scope="external">Balise décorative </a>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_39E9A53B4A1A465589547638A29CB34C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Dans le rapport Cible d’Audiences AdWords, vous pouvez désormais inclure des colonnes pour les propriétés de transaction suivies par Advertising Cloud. </p> </td> 
  </tr> 
 </tbody> 
</table>
