...
<table id="table_558E0B0AECB84969825705EC62FA1BB2"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="https://helpx.adobe.com/fr/marketing-cloud/how-to/use-cases.html" format="html" scope="external"> Optimisation des e-mails </a> </p> </td> 
...
* Nouvelle documentation Ajoutée, [Stratégies de sécurité du contenu et service d’identification des Marketings Cloud](https://docs.adobe.com/content/help/fr-FR/id-service/using/reference/csp.html) qui explique comment autoriser les appels aux domaines d’Adobe utilisés par le service d’ID.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Antérieurement, les visualisations de synthèse des chiffres/résumé des changements abrégé(e) n’affichaient aucun nombre de décimales. </p> <p>Vous pouvez désormais choisir 0 à 3 nombres de décimales afin d’améliorer vos rapports. <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/summary-number-change.html" format="html" scope="external"> Plus... </a> </p> </td> 
  </tr> 
  <tr> 
...
* Correction d’un bogue qui empêchait [Audience Lab](https://marketing.adobe.com/resources/help/en_US/aam/audience-lab.html) de se charger en temps opportun. (AAM-32249)
...
<table id="table_7B50E9D0E6D340C1A589CE0713767285"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> Bibliothèque de modèles d’email </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Le Rapports dynamique fournit des rapports d’entreprise entièrement personnalisables et en temps réel. Dans cette version, une amélioration apportée au reporting dynamique offre un accès aux données de profil, ce qui permet d’effectuer des analyses démographiques par dimension de profil (genre, ville, code postal et âge) en plus des données fonctionnelles des campagnes email comme les ouvertures et les clics Avec la même interface intuitive de type glisser-déposer, il n’a jamais été aussi simple de déterminer les performances de votre campagne email pour les segments clients les plus importants. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Abonnement en masse avec Origine et date </p> </td> 
   <td colname="col2"> <p> Grâce à l’amélioration apportée à l’inscription en masse, vous pouvez désormais stocker les informations d’inscription (origine et date) directement dans la base de données d’Adobe Campaign Standard par le biais de l’activité Services d’inscription d’un workflow. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_0225913B8D5D4B52982ED2E7F2095EEE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Lorsqu'il s'agit de gérer des jeux de données volumineux, l'Hadoop a l'avantage sur les systèmes relationnels de gestion de base de données et sa valeur pour toute entreprise de taille réduite continuera à augmenter à mesure que les données non structurées continueront de croître. Adobe Campaign peut tirer parti de la puissance de Hadoop via Hadoop Connector via HiveSQL, où les clients peuvent accéder directement aux schémas à partir de l’interface utilisateur d’Adobe Campaign pour créer des audiences avancées et hautement segmentées de manière rapide, flexible et évolutive. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>Cette version offre de nouvelles fonctionnalités d’automatisation et de diffusion pour les clients Dynamic Media et est la première version ciblée pour les clients Dynamic Media Classic (S7)-AEM existants à transition sur Dynamic Media. </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>La nouvelle documentation AEM Screens 6.3 est disponible. Vous pouvez également utiliser un démarrage rapide qui permet à un utilisateur de créer une expérience de signature numérique en 5 minutes. Reportez-vous aux ressources suivantes : </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> <b>Pack de fonctionnalités Dynamic Media : architecture et résolution des problèmes</b> </p> <p> 
     <ul id="ul_4B68CC8CF9534D88A7874E0C63BAD6FE"> 
      <li id="li_41A24144372347DDB1260D5D8E3D2428">Présentation des nouvelles fonctionnalités de Dynamic Media Feature Pack. </li> 
      <li id="li_E9106D8DC4FF48DB937CB66449D425F8">Architecture du Dynamic Media Feature Pack. </li> 
