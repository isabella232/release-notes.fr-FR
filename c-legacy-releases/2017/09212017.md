...
* Correction d’un problème empêchant le chargement d’[Audience Lab](https://marketing.adobe.com/resources/help/en_US/aam/?f=audience-lab.html) dans le temps imparti. (AAM-32249)
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Les publicités Bing commencent à migrer les comptes gérés par Cloud vers le nouveau modèle de lien de site (site de site partagé) le 25 septembre ; le processus doit prendre quatre jours. Entre le 22 septembre et la fin de la migration de votre compte, les liens de site ne seront pas accessibles dans le cloud de publication et s'afficheront incorrectement comme supprimés. Si vous devez apporter des modifications à vos liens de site avant la fin de la migration, travaillez directement dans l'éditeur Publicités Bing ; vos modifications seront migrées vers le nouveau modèle et synchronisées par Publication Cloud une fois la migration terminée. Une fonctionnalité prenant en charge les liens de site partagés sera disponible avec la mise à jour d’octobre. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Recherche Campaign Bêta </p> </td> 
