...
>[!IMPORTANT]
>
>Le code du service d’ID v2.0 synchronise automatiquement les ID avec [!DNL  Adobe Media Optimizer] par défaut. Consultez aussi la section [Comprendre la synchronisation des identifiants et les taux de correspondance](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html).
...
L’aide du service de Marketing Cloud ID est disponible [ici](https://marketing.adobe.com/resources/help/en_US/mcvid/).
...
[!UICONTROL ] Le code DIL constitue le code de collecte de données d’API de [!DNL  Audience Manager]. La version de janvier incrémente [!UICONTROL  DIL] vers la version 6.8.
...
* La [FAQ sur les caractéristiques et fonctions du produit](https://marketing.adobe.com/resources/help/en_US/aam/faq_features_functions.html) comprend une nouvelle entrée expliquant comment trouver votre ID [!UICONTROL  d’organisation].
* La [FAQ sur la collecte de données et l’intégration de produits](https://marketing.adobe.com/resources/help/en_US/aam/faq_data_collection_integration.html)inclue une nouvelle entrée sur les adresses IP et FTP [!DNL  Audience Manager] de liste blanche.
* La [FAQ sur la confidentialité et la conservation des données](https://marketing.adobe.com/resources/help/en_US/aam/faq_privacy.html) comprend un contenu révisé pour la confidentialité.
* La section [DIL de trafic dans Google Tag Manager (GTM)](https://marketing.adobe.com/resources/help/en_US/aam/t_dil_google_tagmanager.html) décrit comment charger le code DIL dans la section HTML personnalisée d’une balise.
* [TraitWeight](https://marketing.adobe.com/resources/help/en_US/aam/traitweight.html) comprend de nouvelles informations sur une étape supplémentaire du processus de découverte algorithmique.
* La section [Taux d’erreur d’échantillonnage de données dans certains rapports Audience Manager](https://marketing.adobe.com/resources/help/en_US/aam/report-sampling.html) comprend de nouvelles informations sur le fonctionnement de l’échantillonnage de données.
* La section [Conditions requises pour le Nom et la taille de fichier Amazon S3 pour les fichiers de données entrants](https://marketing.adobe.com/resources/help/en_US/aam/inbound-s3-filenames.html) comprend de nouvelles informations sur la façon dont le processus de validation réagit aux fichiers de données vides.
...
* Page d’accueil de l’aide : [page d’accueil de l’aide Adobe Experience Manager](https://docs.adobe.com)
* Système de publication de Scene7 : [notes de mise à jour du système de publication de Scene7](https://marketing.adobe.com/resources/help/en_US/s7/release_notes/index.html)
