...
<table id="table_558E0B0AECB84969825705EC62FA1BB2"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="https://helpx.adobe.com/fr/marketing-cloud/how-to/use-cases.html" format="html" scope="external"> Engagement relatif à l’application mobile </a> </p> </td> 
...
* Prise en charge Ajoutée de Xcode 9 (mise à jour le **19 juillet**)

Voir [SDK Android 4.x pour Marketing Cloud Solutions](https://docs.adobe.com/content/help/fr-FR/mobile-services/android/overview.html) et [SDK iOS 4.x pour Marketing Cloud Solutions](https://marketing.adobe.com/resources/help/fr_FR/mobile/ios/) pour consulter la documentation du SDK. Pour afficher les notes de mise à jour des versions précédentes, développez *Notes de mise à jour précédentes* dans le volet gauche.
...
>[!NOTE]
>
>Au 1er juin 2017, Adobe Social a limité l’analyse des impressions à l’anglais et au japonais. Pour plus d’informations, voir [Mise à jour de l’Analyse d’opinion d’écoute et FAQ](https://marketing.adobe.com/resources/help/en_US/social/listening-sentiment-language-changes-faq.pdf).
