...
<table id="table_F042191E03D34D72BDC54DBDA4D38E17"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"></td> 
   <td colname="col2"> <p>Dynamic Tag Management : </p> <p> <a href="https://marketing.adobe.com/resources/help/en_US/dtm/target.html" format="https" scope="external"> mise à jour des paramètres d’Adobe Target</a> pour le déploiement automatique d’Adobe Target. </p> <p>Voir la <a href="https://marketing.adobe.com/resources/help/en_US/dtm/faq_target.html" format="https" scope="external">FAQ sur le déploiement d’Adobe Target</a> pour en savoir plus. </p> </td> 
   <td colname="col3"> <p> Octobre 2014 </p> </td> 
  </tr> 
  <tr> 
...
* La Dynamic Tag Management ne remplace plus les variables globales avec le nom *` window.t`*.
...
|---|---|
| Entrepôt de données | Ajout de la prise en charge des sources de données sommaires dans les rapports de l’entrepôt de données. Vous pouvez ainsi rendre compte des mesures telles que les données du moteur de recherche (préclic) issues d’Adobe Media Optimizer. |
...
* Correction d’un problème en raison duquel un segment qui utilise l’opérateur *` Then`* présentait la compatibilité avec la publicité - Analyses ad hoc dans le créateur de rapports et [!DNL Analytics] de segments. Toutefois, lors de l’exécution d’un rapport avec le segment dans les analyses ad hoc, une erreur s’affichait. Une autre erreur s’affichait pour le segment lorsque vous tentiez de l’enregistrer dans le créateur de segments des analyses ad hoc.
