...
<table id="table_F042191E03D34D72BDC54DBDA4D38E17"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"></td> 
   <td colname="col2"> <p>Dynamic Tag Management : </p> <p> <a href="https://docs.adobe.com/content/help/en/dtm/using/tools/target.html" format="https" scope="external"> Mise à jour des paramètres d’Adobe Target</a> pour le déploiement automatique d’Adobe Target. </p> </td> 
   <td colname="col3"> <p> Octobre 2014 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <a href="https://docs.adobe.com/content/help/en/social/using/home.html" format="https" scope="external"> Social 3.3</a> : prise en charge des suites de rapports générales, amélioration de la modération unifiée. </p> </td> 
   <td colname="col3"> <p>  Mai 2014 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <a href="https://docs.adobe.com/content/help/en/experience-cloud/user-guides/home.html" format="https" scope="external"> Page d'accueil de l'aide </a>: Le nouveau domaine d’aide est <a href="https://docs.adobe.com/content/help/en/experience-cloud/user-guides/home.html" format="https" scope="external"> https://docs.adobe.com/content/help/en/experience-cloud/user-guides/home.html </a>. Mettez vos signets à jour. (Le contenu sera migré solution par solution au cours de l’année ; il se peut donc que certaines parties du contenu renvoient à l’ancien domaine.) </p> </td> 
...
Voir [Prise en main d’Adobe Marketing Cloud](https://docs.adobe.com/content/help/en/core-services/interface/experience-cloud.html) pour consulter l’aide du produit.
...
|---|---|
| Data Warehouse | Ajout de la prise en charge des sources de données sommaires dans les rapports de l’entrepôt de données. Vous pouvez ainsi créer des rapports sur des mesures telles que les données de moteur de recherche (pré-clic) d’Adobe Advertising Cloud. |
...
>[!NOTE]
>
>L’accès à l’entrepôt de données depuis la version 14 a été supprimé. [En savoir plus](https://docs.adobe.com/content/help/en/analytics/components/segmentation/seg-home.html)
...
* Le fichier compressé de distribution a été mis à jour afin d’inclure l’API visiteur 1.3.4 et un module Audience Manager mis à jour qui inclut la version DIL 5.5.
