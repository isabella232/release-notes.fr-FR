...
Pour obtenir de l’aide sur le produit, voir [Prise en main d’Adobe Marketing Cloud](https://marketing.adobe.com/resources/help/fr_FR/mcloud/home.html).
...
Voir [Adobe Mobile Services](https://marketing.adobe.com/resources/help/fr_FR/mobile/) pour accéder à la documentation du produit. Pour afficher les notes de mise à jour des versions précédentes, développez *Notes de mise à jour précédentes* dans le volet gauche.
...
Consultez les [Nouveautés de la gestion dynamique des balises](https://marketing.adobe.com/resources/help/fr_FR/dtm/whatsnew.html) pour consulter les notes de mise à jour actuelles et cumulatives, l’aide et les mises à jour de la documentation.
...
|---|---|
| Data Warehouse | Ajout de la prise en charge des sources de données sommaires dans les rapports de l’entrepôt de données. Vous pouvez ainsi rendre compte des mesures telles que les données du moteur de recherche (préclic) issues d’Adobe Media Optimizer. |
...
>[!NOTE]
>
>L’accès à Data Warehouse depuis la version 14 a été supprimé.[En savoir plus](https://marketing.adobe.com/resources/help/fr_FR/reference/?f=whatsnew_segments)
...
Voir les [Notes de mise à jour de Target](https://marketing.adobe.com/resources/help/fr_FR/target/target/r_release_notes.html) pour obtenir les informations les plus récentes.
...
Voir les [Notes de mise à jour de Target](https://marketing.adobe.com/resources/help/fr_FR/target/rn/) pour obtenir les informations les plus récentes.
