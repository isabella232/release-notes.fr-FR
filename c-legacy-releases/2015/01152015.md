...
<table id="table_F042191E03D34D72BDC54DBDA4D38E17"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"></td> 
   <td colname="col2"> <p> <a href="https://docs.adobe.com/content/help/en/core-services/interface/manage-users-and-products/organizations.html" format="https" scope="external"> Association de comptes</a> : permet aux utilisateurs d’accéder à Marketing Cloud en liant ou en associant le compte de la solution à un Adobe ID. </p> </td> 
   <td colname="col3"> <p> Février 2014 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
   <td colname="col2"> <p> <a href="https://docs.adobe.com/content/help/en/mobile-services/using/home.html" format="https" scope="external"> Mobile Services</a> – automne 2014 : messagerie in-app et création de rapports sur les messages in-app. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <a href="https://docs.adobe.com/content/help/en/analytics/components/segmentation/seg-home.html" format="http" scope="external"> Segmentation unifiée</a> : les segments sont désormais créés, gérés et utilisés dans les interfaces Analytics et les suites de rapports. </p> </td> 
   <td colname="col3"> <p> Mai 2014 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
...
Voir les [Notes de mise à jour de Target](https://docs.adobe.com/content/help/en/target/using/release-notes/release-notes.html) pour obtenir les informations les plus récentes.
...
* Améliorations apportées aux notes des règles métier. Par exemple, si vous vue une règle, vous pouvez maintenant récupérer l’historique des notes pour cette règle. En outre, les notes sont maintenant consignées dans **[!UICONTROL Rapports]** > **[!UICONTROL Journal des modifications]**.
