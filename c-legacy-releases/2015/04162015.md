...
* Correction d&#39;un problème empêchant la connexion unique entre le [!DNL  Marketing Cloud][!DNL  Media Optimizer]et.

**Problèmes connus**

* Un problème connu empêche le partage d&#39;audiences à partir des suites de rapports qui ne sont pas détenues par [!DNL Analytics] le compte lié. Nous nous efforçons de corriger le problème.
...
* Correction d&#39;une incohérence entre les données des rapports et [!DNL Analytics] des entrepôts de données en ajoutant la prise en charge *` campaign instances`* en tant que mesure de segmentation à l&#39;entrepôt de données.
