...
<table id="table_04854D12F4C241AE86F24C12C4F0FA28"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Les fonctionnalités de gestion des utilisateurs et des groupes ont été déplacées dans le tableau de bord Entreprise. Elles se trouvent désormais sous : </p> <p> <span class="uicontrol"> Marketing Cloud</span> &gt; <span class="uicontrol">Outils</span> &gt; <span class="uicontrol">Lancer le tableau de bord Entreprise </span></p> <p> En outre, Enterprise ID et Federated ID sont pris en charge. Utilisez des Enterprise ID, des Federated ID, ainsi que des Adobe ID dans un même déploiement d’entreprise. Par exemple, utilisez les Adobe ID pour les utilisateurs susceptibles de recourir à d’autres produits et services Adobe. Utilisez des Enterprise IDs ou des Federated IDs pour les utilisateurs qui souhaitent gérer leurs comptes de manière rigoureuse. </p> <p>Voir <a href="https://docs.adobe.com/content/help/en/core-services/interface/manage-users-and-products/admin-getting-started.html" format="https" scope="external">Utilisateurs et groupes – Gestion des identités </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
