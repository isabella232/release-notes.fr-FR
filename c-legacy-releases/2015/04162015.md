...
>[!NOTE]
>
>Pour recevoir les notes de mise à jour une semaine avant la mise à jour mensuelle, abonnez-vous à [Adobe Priority Product Update](https://www.adobe.com/subscription/priority-product-update.html). Les informations de mise à jour sont publiées une semaine avant la date de publication et peuvent être modifiées. Revenez-y au moment de la publication de la mise à jour pour connaître les dernières informations.
...
* Correction d’un problème empêchant la connexion unique entre le [!DNL  Marketing Cloud] et [!DNL  Media Optimizer].
...
Consultez la section [Documentation du produit Marketing Cloud](https://marketing.adobe.com/resources/help/fr_FR/mcloud/) pour obtenir de l’aide sur le produit.
...
* Nous avons actualisé le chargement initial des applications [!DNL  [!DNL Analytics]] afin d’améliorer la vitesse du processus de connexion.
...
Consultez la section [Adobe Mobile Services](https://marketing.adobe.com/resources/help/fr_FR/mobile/) pour accéder à la documentation du produit. Pour afficher les notes de mise à jour des versions précédentes, développez *Notes de mise à jour précédentes* dans le volet gauche.
...
Consultez la section [Nouveautés de la gestion dynamique des balises](https://marketing.adobe.com/resources/help/fr_FR/dtm/whatsnew.html) pour accéder aux notes de mise à jour actuelles et cumulatives, à l’aide et aux mises à jour de la documentation.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> Entrepôt de données <p> 
     <!--AN-100995--></p> </td> 
...
>[!NOTE]
>
>L’accès à l’entrepôt de données depuis la version 14 a été supprimé.[En savoir plus](https://marketing.adobe.com/resources/help/fr_FR/reference/?f=whatsnew_segments)
...
* La fonction Applications sociales est officiellement abandonnée dans la version d’Adobe Social 15.4.1.0 (avril 2015). Ceci implique aussi la suppression de toutes les mesures, données et méthodes d’API liées à l’application. Si vous avez des questions, contactez le gestionnaire de votre compte Social. Pour plus d’informations, voir [Applications Adobe Social - Fiche descriptive sur l’obsolescence](https://helpx.adobe.com/fr/social/kb/social-applications---deprecation-fact.html).
