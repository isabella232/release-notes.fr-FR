...
La version du 18 juin 2015 d’[!DNL  Adobe Mobile Services] comporte les modifications suivantes :

**Modification d’accès aux fonctionnalités**

Les clients doivent avoir [!DNL  Analytics—Mobile Apps] ou [!DNL  Analytics Premium] non les fonctionnalités suivantes :
...
* Correction d&#39;un problème lié aux courriers électroniques de rapport ( [!DNL  .xls] et [!DNL  .csv] aux pièces jointes) qui contenait l&#39;identifiant de suite de rapports plutôt que le nom de la suite de rapports dans le courrier électronique. Ils comportent désormais le nom des suites de rapports.
