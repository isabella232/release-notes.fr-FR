...
* Réorganisation et amélioration des guides suivants :
   ...
   * [Guide de l’utilisateur d’Adobe Mobile Services](https://marketing.adobe.com/resources/help/fr_FR/mobile/)
   * [iOS SDK 4.x pour le Guide de l’Admin des solutions Marketing Cloud]( https://marketing.adobe.com/resources/help/en_US/mobile/ios/)
...
Analytics Premium fournit ces nouvelles fonctionnalités supplémentaires dans les [Outils de données version 6.4]( https://marketing.adobe.com/resources/help/en_US/insight/whatsnew/) :
...
* Nous apportons des améliorations à la documentation de l’API avec Swagger. Pour connaître les méthodes, nouvelles et révisées, voir [Documents de l’API Audience Manager](https://bank.demdex.com/portal/swagger/index.html).
* Ajout d’une nouvelle documentation sur [Les identifiants visiteurs de Marketing Cloud](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_visitor_id_versions.html). Lorsque vous créez ou modifiez une source de données, vous avez parfois besoin d’un identifiant visiteur.
...
Pour plus d’informations, consultez les [Notes de mise à jour d’Adobe Social](https://marketing.adobe.com/resources/help/en_US/social/c_rel_notes.html).
