...
Voir [Adobe Mobile Services](https://docs.adobe.com/content/help/en/mobile-services/using/home.html) pour obtenir la documentation du produit. Pour afficher les notes de mise à jour des versions précédentes, développez *Notes de mise à jour précédentes* dans le volet gauche.
...
Analytics Premium propose les nouvelles fonctionnalités supplémentaires suivantes dans la version [Data Workbench 6.4](https://docs.adobe.com/content/help/fr-FR/data-workbench/using/release-notes/release-notes.translate.html) :
...
<table id="table_FE8C9A73676345CDA450CE84111A2B72"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> Vous pouvez modifier le format de date en fonction de vos paramètres régionaux dans le fichier Heure standard <i>Dimensions.cfg</i>. Remplacez le format par défaut <i>MM/JJ/AAAA</i> par le format <i>JJ/MM/AAAA</i> ou choisissez d’autres options. </td> 
  </tr> 
  <tr> 
...
### Correctifs Ad Hoc Analysis {#fixes_ad_hoc}
...
* Nous améliorons la documentation sur les API avec Swagger. Consultez la section [Documentation de l&#39;API d&#39;Audience Manager](https://bank.demdex.com/portal/swagger/index.html) pour connaître les méthodes nouvelles et révisées.
...
Voir [Notes de mise à jour pour Adobe Social](https://docs.adobe.com/content/help/fr-FR/social/using/home.html) pour plus d’informations.
