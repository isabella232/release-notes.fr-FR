...
* Les méthodes d’API de source de données ont été migrées vers Swagger. Consultez les [Documents sur l’API d’Audience Manager](https://bank.demdex.com/portal/swagger/index.html) pour connaître les méthodes, la syntaxe et les exemples de code.
