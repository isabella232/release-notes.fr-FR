...
Consultez lesa section [Services d’Adobe Mobile](https://marketing.adobe.com/resources/help/en_US/mobile/) pour obtenir la documentation du produit. Pour afficher les notes de mise à jour des versions précédentes, développez *Notes de mise à jour précédentes* dans le volet gauche.
...
Un nouveau document explique comment transmettre les ID de fournisseurs de données et d’utilisateurs avec les variables ` d_cid` et ` d_cid_ic`. Ces nouvelles variables remplacent les combinaisons ` d_dpid` + ` d_dpuuid` qui sont toujours prises en charge, mais deviennent obsolètes. Pour plus d&#39;informations, voir [CID remplace DPID et DPUUID](https://marketing.adobe.com/resources/help/en_US/aam/?f=cid.html).
