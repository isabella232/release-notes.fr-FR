...
<table id="table_4ABE0F980A704B069BA9044E7F32ECFE"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <span class="wintitle"> Règles </span> de classification Analytics - Remplacer les valeurs existantes </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_9F4F40B4329443AC88F07B74660407C3"> 
     ...
     <li id="li_8EEB2C69113C43349F2B5E3AD9352B7B">Ajoute la possibilité d’exécuter un ensemble de mesures sans les enregistrer comme mesures par défaut. Cette fonction est désormais plus cohérente avec les rapports standard Rapports et Analytics. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="wintitle"> Règles </span> de classification Analytics - Remplacer les valeurs existantes </p> </td> 
...
* Mises à jour de Dimension entre pour les segments séquentiels. Tout comme la logique Instance entre qui identifie les correspondances entre les conteneurs, la fonction Dimension entre inclut désormais une fonction de restriction de dimension qui fournit une logique basée sur les valeurs de dimension, en déterminant les correspondances basées sur des valeurs spécifiques (lignes de tableau) afin de suivre si une dimension sélectionnée est définie (ou non) et de vous permettre ensuite de fournir une logique de segment basée sur ces valeurs de dimension.
