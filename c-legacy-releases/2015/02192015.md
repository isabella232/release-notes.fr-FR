...
Pour plus d’informations, voir la documentation du produit [Marketing Cloud et les services principaux](https://marketing.adobe.com/resources/help/fr_FR/mcloud/).
...
Pour obtenir de l’aide sur le produit, voir [Documentation du produit Marketing Cloud](https://marketing.adobe.com/resources/help/fr_FR/mcloud/).
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> Mises à jour de la navigation dans les rapports [!DNL Analytics] </td> 
   <td colname="col2"> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Remarque :  </p> <p>1. La polarité permet d’indiquer si Adobe [!DNL Analytics] doit considérer comme un point positif ou négatif le fait qu’un événement personnalisé donné (mesure) augmente. </p> <p>2. Adobe [!DNL Analytics] pourra alors présenter des indicateurs de direction (flèches) pour diverses mesures afin d’ajouter du contexte (par exemple, comparaisons d’une semaine à l’autre). Exemple : si l’événement « Bogues envoyés » augmente d’une semaine à l’autre, Adobe [!DNL Analytics] doit-il considérer cela comme un facteur positif ou négatif ? Autres exemples : une augmentation des inscriptions au publipostage est probablement bénéfique. En revanche, une augmentation des erreurs de soumission de formulaire est probablement mauvais signe. </p> <p>Dans <span class="ignoretag"><span class="uicontrol"> 
...
>[!NOTE]
>
>l’accès à l’entrepôt de données de la version 14 sera supprimé dans cette version.[En savoir plus](https://marketing.adobe.com/resources/help/fr_FR/reference/?f=whatsnew_segments)
...
Pour plus d’informations, voir [Configuration des flux de données](https://marketing.adobe.com/resources/help/fr_FR/sc/clickstream/datafeeds_configure.html).
...
Consultez les [Notes de mise à jour d’Adobe Target](https://marketing.adobe.com/resources/help/fr_FR/target/rn/) pour obtenir les dernières dates et informations de version.
