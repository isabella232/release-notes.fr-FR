...
<table id="table_EB3FFBA2DF904546A5185EC9A63BBA98"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Added the topic <a href="https://marketing.adobe.com/resources/help/fr_FR/mcloud/core_services.html" format="https" scope="external"> Core Services - Enabling Your Solutions </a> to assist you with implementing core services. </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Dans <span class="uicontrol">Analytics </span> &gt; <span class="uicontrol">Admin </span> &gt; <span class="uicontrol">Créateur de règles de classification </span> &gt; <span class="term">&lt;nom du jeu de règles&gt; </span> , deux nouvelles options permettent de sélectionner un mode de remplacement : </p> 
    <ul id="ul_54AAEB16B74B4F53BE3549A7992B7353"> 
     ...
     <li id="li_6F71992C30E44B6FAC8E7C20D4C9D6DF"> <b>Les règles remplacent uniquement les valeurs non définies :</b> seules les cellules vides (non définies) sont remplies. Les classifications existantes ne seront pas modifiées. </li> 
    </ul> <p>Auparavant, si une clé était déjà classée dans une colonne ou une cellule, la règle ne s’exécutait pas sur cette clé et la ligne du tableau était ignorée. </p> <p>Voir la documentation sur le produit <a href="https://marketing.adobe.com/resources/help/en_US/reference/classification_rule_set.html" format="https" scope="external">Règles de classification</a> pour en savoir plus. </p> </td> 
  </tr> 
  <tr> 
...
* La segmentation séquentielle ajoute une correspondance à plusieurs instances. La mise en oeuvre précédente de la logique Instance entre utilisait uniquement la correspondance de première instance pour les segments séquentiels, sans correspondance avec les séquences légitimes trouvées plus tard dans la visite. La nouvelle logique permet désormais de capturer toute séquence correspondante pendant la visite dans le cadre du segment séquentiel. Par exemple, un segment séquentiel capturant des visiteurs qui sont allés à la *page A puis à la page B mais pas à la page C* ne correspondrait pas si le visiteur passait à *A à B à C puis revenait à B*, ce qui correspond à une deuxième instance (le retour à la page B correspond à la logique *A à B et non à C*).
...
Refer to the [Adobe Target Release Notes](https://docs.adobe.com/content/help/fr-FR/target/using/release-notes/release-notes.html) for the latest dates and release information.
