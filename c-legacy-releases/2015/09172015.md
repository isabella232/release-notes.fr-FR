...
<table id="table_D01BAD87E351453EA70A66B3B56F11F6"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>L’envoi de messages Push aux segments <span class="wintitle"> Analytics </span> à partir de l’interface utilisateur <span class="keyword"> Mobile Services </span> vous permet d’exploiter vos données Analytics robustes tout en impliquant les utilisateurs. </p> <p>Voir : </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ajouté une case à cocher pour activer ou désactiver la possibilité pour le SDK Adobe d’antidater les accès aux informations de session. </p> <p>Voir <a href="https://marketing.adobe.com/resources/help/en_US/mobile/t_config_analytics.html" format="https" scope="external"> Configuration des options SDK Analytics </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>L’utilisateur administrateur peut limiter quels utilisateurs peuvent créer de nouveaux segments ou de nouvelles mesures calculées. </p> <p>Par défaut, tous les utilisateurs peuvent créer des segments ou des mesures calculées. <a href="https://marketing.adobe.com/resources/help/en_US/reference/groups.html" format="https" scope="external"> Plus... </a></p> </td> 
  </tr> 
  <tr> 
...
L’aide de Advertising Management est disponible dans le produit sous **[!UICONTROL Aide > Rubriques d’aide]**.
