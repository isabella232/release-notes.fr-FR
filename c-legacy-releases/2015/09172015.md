...
Administrateurs de solutions, voir [Utilisateurs et Groupes](https://marketing.adobe.com/resources/help/en_US/mcloud/?f=user_mgmt_admin) pour obtenir des informations importantes sur le mappage des groupes de solutions pour élargir les groupes Adobe et ajouter en masse des utilisateurs dans le [Tableau de bord d’entreprise](http://adminconsole.adobe.html/#).
...
<table id="table_D01BAD87E351453EA70A66B3B56F11F6"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>L’envoi de messages push vers les segments [!DNL Analytics] à partir de l’interface utilisateur des <span class="keyword">Services mobiles</span> permet d’exploiter vos puissantes données [!DNL Analytics] tout en impliquant les utilisateurs. </p> <p>Voir : </p> 
...
Administrateurs Analytics : si vous êtes administrateur de Marketing Cloud, reportez-vous à [la section Utilisateurs et Groupes](https://marketing.adobe.com/resources/help/en_US/mcloud/?f=user_mgmt_admin) pour obtenir des informations mises à jour sur le mappage des groupes Analytics pour élargir les groupes Adobe et ajouter en masse des utilisateurs dans le [Tableau de bord d’entreprise](http://adminconsole.adobe.html/#).
...
* Correction d’un problème avec les flux de données d’Adobe Media Optimizer. (AN-106116)
...
Consultez l’[historique des mises à jour AppMeasurement](https://marketing.adobe.com/resources/help/en_US/sc/appmeasurement/release/index.html) pour accéder à l’historique des versions de [!DNL  AppMeasurement] sur les plateformes suivantes :
...
* La nouvelle documentation décrit la manière d’utiliser les fichiers de métadonnées pour remplacer les identifiants numériques par du texte lisible dans les rapports d’[!UICONTROL analyses de publicité]. Consultez les [Fichiers de données et métadonnées pour les rapports d’analyse de publicité](https://marketing.adobe.com/resources/help/en_US/aam/?f=metadata-files-intro.html).
* Révision de la [capture des données de campagne par l’appel de pixels]( https://marketing.adobe.com/resources/help/en_US/aam/?f=c_capturing_camp_data.html) pour intégrer les nouvelles paires clé-valeur requises par les rapports [!UICONTROL  Advertising Analytics].
* Révision de la [capture des données de clic de campagne via l’appel de pixels](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_capturing_camp_click_data.html) pour inclure de nouvelles paires clé-valeur requises par les rapports Advertising Analytics.
...
* [Documentation sur Adobe Campaign v6](https://support.neolane.net/doc/AC6.1/en/home.html)
...
* AEM Assets à la demandeon Demand : [nNotes de mise à jour](https://docs.adobe.com/content/docs/en/aod/overview/release-notes.html)
