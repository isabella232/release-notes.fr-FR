...
<table id="table_D01BAD87E351453EA70A66B3B56F11F6"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>L'envoi de messages Push aux <span class="wintitle"> segments Analytics </span> à partir de <span class="keyword"> l'interface utilisateur Mobile Services </span> vous permet d'exploiter votre puissant [! Données DNL Analytics] tout en impliquant les utilisateurs. </p> <p>Voir : </p> 
