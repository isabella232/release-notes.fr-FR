...
* Correction d’un bogue qui empêchait le [!UICONTROL service d’identification des visiteurs] de définir correctement un cookie de domaine de niveau supérieur à parties multiples. Si, par exemple, vous avez un domaine du type ` my_company.co.uk`, dans certains cas, le [!UICONTROL service d’identification des visiteurs] définirait un cookie dans ` co.uk` seulement. (AN-104683)
   ...
   * activation d’une [période de grâce](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid_grace_period.html)* ou *utilisation de cookies propriétaires et de cookies tiers de blocage des utilisateurs ;
...
* La nouvelle documentation décrit la manière de récupérer des données d’un compte Google Doubleclick Campaign Manager (DCM) dans [!DNL  Audience Manager]. Voir [Importation de fichiers DCM dans Audience Manager](https://marketing.adobe.com/resources/help/en_US/aam/t_dcmlogs.html).
* La nouvelle documentation décrit la manière d’utiliser les [!UICONTROL outils de gestion en bloc]. Voir [Outils de gestion en bloc](https://marketing.adobe.com/resources/help/en_US/aam/c_bulk.html) pour en savoir plus.
* Révision de l’[intégration du profil de marketing maître](https://marketing.adobe.com/resources/help/en_US/aam/c_mmp.html) afin de mettre à jour la variable de données contextuelles. Cette variable doit se terminer par un trait de soulignement. Auparavant, elle se terminait par un point.

**Problèmes connus**

Les clients d’[!DNL  Analytics] doivent définir un code d’intégration lors de l’utilisation du [profil de marketing maître](https://marketing.adobe.com/resources/help/en_US/aam/c_mmp.html) et de la transmission des ID déclarés à [!DNL  Audience Manager] avec le [service d’identification des visiteurs](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid_service.html). Voir [Activation de fusion des profils](https://marketing.adobe.com/resources/help/en_US/aam/c_profile_merge_enablement.html) pour en savoir plus.
