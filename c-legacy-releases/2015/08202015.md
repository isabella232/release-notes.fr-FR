...
* [Nouvelles fonctionnalités dans [!DNL Analytics]](../../c-legacy-releases/2015/08202015.md#features_analytics) **(Mis à jour le 21/08/2015) :** La clé SFTP obsolète (communiquée publiquement à l’automne 2013) utilisée pour le transfert des rapports et flux de données de l’entrepôt de données a été définitivement supprimée.
...
* La nouvelle documentation décrit la manière de récupérer des données d’un compte Google Doubleclick Campaign Manager (DCM) dans [!DNL  Audience Manager]. See [Import DCM Files Into Audience Manager](https://marketing.adobe.com/resources/help/en_US/aam/t_dcmlogs.html).
* La nouvelle documentation décrit la manière d’utiliser les [!UICONTROL outils de gestion en bloc]. Voir Outils [de gestion](https://marketing.adobe.com/resources/help/en_US/aam/c_bulk.html) en masse pour en savoir plus.
* Revised the [Master Marketing Profile Integration](https://marketing.adobe.com/resources/help/en_US/aam/c_mmp.html) to update the context data variable. Cette variable doit se terminer par un trait de soulignement. Auparavant, il s’affichait pour se terminer par un point.

**Problèmes connus**

[!DNL  Analytics] les clients doivent définir un code d’intégration lors de l’utilisation du Profil [marketing](https://marketing.adobe.com/resources/help/en_US/aam/c_mmp.html) Principal et de la transmission des identifiants déclarés [!DNL  Audience Manager] avec le service d’identification des Visiteurs.
