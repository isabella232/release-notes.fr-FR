...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> Ajoutée de la mesure "Instances de dernier contact du Canal marketing" pour le rapports de Data warehouse. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Modification des sources de données en juin 2015 </td> 
   <td colname="col2"> <p>Les rapports et analyses ne prend plus en charge les sources de données du trafic depuis l’introduction de SiteCatalyst 15. L’interface utilisateur des sources de données vous permet toujours de créer une source de données de trafic, mais ce type de source de données ne peut être appliqué qu’aux plages de dates antérieures à la date à laquelle votre société a migré de SiteCatalyst 14 vers SiteCatalyst 15. Le mois prochain (juin 2015), Adobe envisage de supprimer l’option Sources de données de trafic. En juin, de nouvelles fonctionnalités de Reports &amp; Analytics vous permettront de créer des mesures de trafic simples sans avoir besoin de recourir aux sources de données de trafic. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A01098A1EE3A4F1084AB13DD1A0DF1B3"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Data warehouse prend en charge l’API Rapports Analytics 1.4. </p> <p>Voir <a href="https://marketing.adobe.com/developer/documentation/data-warehouse/r-report-2" format="https" scope="external">Report.Queue</a> dans la documentation de l’API de l’entrepôt de données sur Developer Connection. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_3CA51E873E324FD4B7CF14190F127A77"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Actuellement, certaines mesures que nous recevons des réseaux sociaux ne peuvent pas faire l’objet de rapports dans <span class="keyword">Adobe Analytics</span>. New reserved events let you create custom reports in  <span class="wintitle"> Analytics </span> to view social data alongside web data. </p> </td> 
  </tr> 
  <tr valign="top"> 
