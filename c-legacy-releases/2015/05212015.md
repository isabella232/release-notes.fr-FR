...
Les menus du panneau de navigation de gauche ont été actualisés et réorganisés afin que vous puissiez accéder à tous les services principaux et solutions. Les modifications notables sont les suivantes :
* La <span class="term"> bibliothèque d’audiences </span> et les <span class="term"> attributs du client</span> se trouvent maintenant sous <span class="term"> Audiences</span>.
...
* Correction d’un problème qui empêchait l’affichage de la page [Documentation du produit Adobe Target](https://marketing.adobe.com/resources/help/ja_JP/target/a4t/) en japonais.
...
<table id="table_03055471A9624B40B122C0E2CD295AA9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Ajouté un remplacement régional du navigateur de bureau pour les liens d’acquisition. Ce paramètre vous permet de sélectionner la boutique d’applications spécifique à la région vers laquelle doit renvoyer un lien d’acquisition lorsqu’un utilisateur clique sur ce lien dans un navigateur de bureau. </p> <p> Cette fonction peut uniquement être définie par les utilisateurs disposant de privilèges d’administration pour créer des liens d’acquisition (administrateurs d’applications mobiles). </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 <thead> 
  <tr> 
   ...
   <th colname="col2" class="entry"> Description des fonctionnalités </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
   <td colname="col1"> Data Warehouse </td> 
   <td colname="col2"> Mesure "Instances de dernier contact du Canal marketing" Ajoutée pour le rapports Data Warehouse. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Modification des sources de données en juin 2015 </td> 
   <td colname="col2"> <p>Les rapports et analyses ne prend plus en charge les sources de données du trafic depuis l’introduction de SiteCatalyst 15. L’interface utilisateur des sources de données vous permet toujours de créer une source de données de trafic, mais ce type de source de données ne peut être appliqué qu’aux plages de dates antérieures à la date à laquelle votre société a migré du SiteCatalyst 14 vers le SiteCatalyst 15. Le mois prochain (juin 2015), l’Adobe envisage de supprimer l’option Sources de données de trafic. En juin, de nouvelles fonctionnalités de Reports &amp; Analytics vous permettront de créer des mesures de trafic simples sans avoir besoin de recourir aux sources de données de trafic. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A01098A1EE3A4F1084AB13DD1A0DF1B3"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>L’entrepôt de données prend en charge l’API Analytics Rapports 1.4. </p> <p>Voir <a href="https://marketing.adobe.com/developer/documentation/data-warehouse/r-report-2" format="https" scope="external">Report.Queue</a> dans la documentation de l’API de l’entrepôt de données sur Developer Connection. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Voir l’[historique de publication d’AppMeasurement](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html) pour obtenir un historique sur les publications d’[!DNL  AppMeasurement] sur les plateformes suivantes :
...
<table id="table_3CA51E873E324FD4B7CF14190F127A77"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Actuellement, certaines mesures que nous recevons des réseaux sociaux ne peuvent pas faire l’objet de rapports dans <span class="keyword">Adobe Analytics</span>. Les nouveaux événements réservés vous permettent de créer des rapports personnalisés dans <span class="wintitle"> Analytics </span> pour vue des données sociales à côté des données Web. </p> </td> 
  </tr> 
  <tr valign="top"> 
...
<table id="table_191B769A5A8A405C87A34245BE6B1127"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   <td colname="col1"> <p>Ciblage géographique twitter </p> </td> 
   <td colname="col2"> <p>Le 1er mars 2015, Adobe Social a interrompu la prise en charge du géociblage des tweets. Après avoir travaillé avec Twitter, le géociblage est à nouveau disponible. </p> 
    <!--<p>See the <wintitle>Specify Targets</wintitle> section in <xref href="t_pub_cnt_cal_create.xml#concept_6DD750347952474C942F537A6E13087A" format="dita" scope="local">Create or Edit a Post in Content Calendar</xref> and <xref href="c_pub_publisher.xml#concept_CDA6B3AC4D3E47FDB474B83CF6B4B71E" format="dita" scope="local">Publisher Page</xref>. </p>--> </td> 
  </tr> 
  <tr valign="top"> 
   <td colname="col1"> <p>Approbation de publications </p> </td> 
   <td colname="col2"> <p>Les approbateurs de publication peuvent désormais approuver une publication à partir de sa prévisualisation. </p> </td> 
  </tr> 
  <tr valign="top"> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Vous pouvez désormais créer un groupe de balises ou une balise portant le même nom qu’un groupe de balises ou balise précédemment supprimé. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Correction d’un problème en raison duquel les publications échouaient parfois avec une erreur de dépassement de délai.
* Correction d’un problème lié aux liens raccourcis en raison duquel les liens vers les pages d’un site Web redirigeaient vers la page d’accueil de la société.
* Correction d’un problème en raison duquel du contenu incorrect (publications, commentaires et réponses) s’affichait parfois dans les flux de modération. Les améliorations du code aideront notre système de collecte à bloquer plus efficacement le contenu non valide qui ne correspond pas à la page.
...
Dans les intégrations du module d’Audience Manager VisitorAPI / AppMeasurement, il y aura deux demandes iFrame de publication de destination effectuées dans IE6-9 : `//fast.<subdomain>.demdex.net/dest5.html` et `//fast.<subdomain>.demdex.net/dest4.html`. Le comportement correct, comme dans les autres navigateurs, consiste à charger uniquement `//fast.<subdomain>.demdex.net/dest5.html`.
