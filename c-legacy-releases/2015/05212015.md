...
solution: Notes de mise à jour sur Experience Cloud
...
Consultez la [documentation du produit Marketing Cloud](https://marketing.adobe.com/resources/help/fr_FR/mcloud/) pour obtenir de l’aide sur le produit.
...
<table id="table_1A8173DB38E8426D96BB7C57BF8FD2D5"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>A compter du SDK Android version 4.5, une nouvelle extension vous permet de collecter des données à partir de l’application Android Wearable. </p> <p>Voir la section sur la <a href="https://marketing.adobe.com/resources/help/en_US/mobile/android/?f=android_wearable" format="https" scope="external">mise en œuvre d’Android Wearable</a> dans le guide <a href="https://marketing.adobe.com/resources/help/en_US/mobile/android/" format="https" scope="external">Android SDK 4.x pour Marketing Cloud Solutions</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Consultez la section [Mise en œuvre du service d’identification des visiteurs](https://marketing.adobe.com/resources/help/fr_FR/mcvid/?f=mcvid_implement) pour plus d’informations sur cette modification.
...
Consultez l’[historique des mises à jour AppMeasurement](https://marketing.adobe.com/resources/help/fr_FR/sc/appmeasurement/release/index.html) pour accéder à l’historique des versions de [!DNL  AppMeasurement] sur les plateformes suivantes :
...
<table id="table_3CA51E873E324FD4B7CF14190F127A77"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Actuellement, certaines mesures que nous recevons des réseaux sociaux ne peuvent pas faire l’objet de rapports dans <span class="keyword">Adobe Analytics</span>. De nouveaux événements réservés permettent de créer des rapports personnalisés dans Analytics afin d’afficher des données sociales au côté des données Web. </p> </td> 
  </tr> 
  <tr valign="top"> 
...
Pour visionner des vidéos de formation sur ces nouvelles fonctionnalités, consultez la section [Nouveautés de mai 2015](https://bit.ly/1JSO2k5).
...
|---|---|
| [Audience Marketplace](https://marketing.adobe.com/resources/help/fr_FR/aam/c_audience_marketplace.html) | [!DNL  Audience Marketplace] fournit des fonctions spécialisées qui permettent aux acheteurs et aux fournisseurs de données d’exécuter des transactions sur les données en libre-service et sans effort. Pour commencer, contactez votre consultant [!DNL  Audience Manager]. Il pourra vous aider à activer [!DNL  Audience Marketplace]. |

**Correctifs, améliorations et obsolescences**

* [Créer des groupes](https://marketing.adobe.com/resources/help/fr_FR/aam/t_create_groups.html) : étapes et instructions simplifiées pour la création de groupes et l’attribution d’autorisations.
* [Comprendre les autorisations génériques](https://marketing.adobe.com/resources/help/fr_FR/aam/c_wildcard_permissions.html) : utilisez [!DNL  Wild Card Permissions] pour octroyer aux membres du groupe l’accès automatique aux nouvelles sources de données. Avec les autorisations standard, vous devez attribuer manuellement de nouvelles sources de données à un groupe.
