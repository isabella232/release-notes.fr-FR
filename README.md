...
Ce projet a adopté le [code de conduite Adobe Open Source](https://docs.adobe.com/content/help/fr-FR/contributor/contributor-guide/conduct-contributions/code-of-conduct.html) ou le [code de conduite de la Fondation .NET](https://dotnetfoundation.org/code-of-conduct). Pour plus d’informations, reportez-vous à l’article [Contribution](https://docs.adobe.com/content/help/fr-FR/contributor/contributor-guide/conduct-contributions/contributing.html).
...
Consultez le [Guide du contributeur de documents Adobe](https://docs.adobe.com/content/help/fr-FR/contributor/contributor-guide-for-adobe-documentation/introduction.html) pour plus de détails.
