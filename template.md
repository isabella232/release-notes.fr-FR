...
# Notes de mise à jour Adobe Experience Cloud
...
Notes de mise à jour de l’interface d’Experience Cloud, notamment les services principaux de [!UICONTROL Platform], l’administration des produits et les bulletins de sécurité.
...
Pour obtenir l’historique des versions d’AppMeasurement sur les plates-formes suivantes, voir [Historique des versions d’AppMeasurement](https://docs.adobe.com/content/help/en/analytics/implementation/appmeasurement-release-notes/c-release-notes-mjs.html) :
