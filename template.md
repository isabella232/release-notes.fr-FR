...
Pour obtenir la documentation du produit, reportez-vous à [la page Gestion des utilisateurs et des produits](https://docs.adobe.com/content/help/en/core-services/interface/manage-users-and-products/admin-getting-started.html).
