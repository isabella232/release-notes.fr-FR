...
* [Plate-forme d’expérience ](#platform) **Mise à jour le 21 février 2021**
* [Journey Orchestration](#journey-orch)
* [Analytics](#analytics) **Mise à jour du 19 février 2021**
...
| -----------| ---------- | ---------- | ---------- |
| 26 février 2021 | [Surveillance du flux de données dans Adobe Experience Platform](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/data-monitoring.html?lang=en#data-ingestion) | Découvrez comment surveiller et suivre les données qui sont ingérées dans Adobe Experience Platform à l’aide de l’interface utilisateur et de l’API de la plate-forme. |
...
| 31 janvier 2021 | [Formation, notation et création de modèles à lʼaide du modèle de création de recettes](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-science-workspace/train-score-and-productize-models.html?lang=fr) | Vidéo | Découvrez comment utiliser le modèle de création de recettes mis à jour pour créer une recette à lʼaide du schéma de vente au détail et des ensembles de données. |
...
| ----------- | ---------- | ----- |
| Analysis Workspace - Sélection de composants | 4 février 2021 | Le composant de zone de dépôt/liste déroulante qui se trouve dans [!UICONTROL Quick Insights] a été ajouté à toutes les zones de dépôt dans [!UICONTROL Workspace]. Cette amélioration vous permet de choisir parmi des composants compatibles dans une liste déroulante ou de continuer à utiliser l’espace comme zone de dépôt. |
| API CJA | 18 février 2021 | Les API CJA sont désormais disponibles. Ces API vous permettent de modifier des composants par programme et de générer des rapports. Pour plus d’informations, voir la [documentation relative aux API CJA](https://adobe.io/cja-apis/docs). |
...
| 1 février 2021 | [Création d’une diffusion SMS](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/sms-channel/create-a-sms-delivery.html?lang=fr) | Campaign Classic | Découvrez comment créer une diffusion SMS. |
