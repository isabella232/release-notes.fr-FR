...
Mise à jour de février 2021 - Découvrez les dernières fonctionnalités dans les [Notes de mise à jour de Offer Decisioning](https://experienceleague.adobe.com/docs/offer-decisioning/using/new/release-notes.html?lang=fr#new).
...
| ----------- | ---------- | ---------- |
| Mise à jour de la connexion au [!UICONTROL Report Builder] | 9 avril 2021 | À compter du 14 janvier 2021 : Les améliorations apportées au processus de connexion [!UICONTROL Report Builder] suppriment les dépendances des technologies héritées et alignent le processus de connexion avec Adobe Experience Cloud. L’Experience Cloud utilise votre Enterprise ID (adresse électronique et mot de passe). <br>Pour garantir un accès ininterrompu au  [!UICONTROL Report Builder], mettez à jour le module  [!UICONTROL Report ] Builder vers la version 5.6.47 ou ultérieure d’ici le 22 juillet 2021. Les versions 5.6.47 et ultérieures du Report Builder ne prennent en charge que la connexion de l&#39;Experience Cloud et ne prennent pas en charge la connexion unique. |
