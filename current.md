...
| Dimensions [!UICONTROL Appareil] et [!UICONTROL Géographie] | 30 octobre 2020 | [!UICONTROL Les ] dimensions Deviceet   Geographydimensions sont désormais disponibles par défaut dans le cadre du projet  [Global ](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-usecases/global-lookups.html?lang=en#cja-usecases) Lookupsupport dans le connecteur Adobe Analytics Source. Cet ajout très demandé augmente la [parité entre Adobe Analytics et CJA](https://docs.adobe.com/content/help/fr-FR/analytics-platform/using/cja-overview/cja-aa.html). |
...
| 4 novembre 2020 | [Rendus de métadonnées d’Asset Compute](https://docs.adobe.com/content/help/fr-FR/experience-manager-learn/cloud-service/asset-compute/advanced/metadata.html) | Tutoriel | Ajoutez un chapitre avancé au tutoriel Asset Compute qui couvre la génération de rendus de métadonnées. |
| 21 octobre 2020 | [Assembler les pièces jointes d’un formulaire](https://docs.adobe.com/content/help/fr-FR/experience-manager-learn/forms/document-services/assemble-form-attachments.html) | Vidéo | Assemblez les pièces jointes d’un formulaire au format PDF dans un ordre spécifique. |
...
* [Notes de mise à jour du service de conversion automatisée de formulaires](https://docs.adobe.com/content/help/en/aem-forms-automated-conversion-service/using/release-notes.html)
