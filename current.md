...
* [Gestionnaire](#aam)  des **(Mis à jour le 30 avril)**
...
| Fonction | Description |
| -----------| ---------- |  
| [prédictive](../features/algorithmic-models/predictive-audiences.md) | [!UICONTROL Les  prédictifs vous aident à classer un de  inconnu en personnes distinctes, en temps réel, à l’aide de techniques avancées de science des données.] <br><br> Dans un contexte de marketing, une personne est un segment   défini par les, les utilisateurs ou les acheteurs potentiels, qui partagent un ensemble spécifique de caractéristiques, telles que les caractéristiques démographiques, les habitudes de navigation, l’historique d’achat, etc.<br><br>[!UICONTROL prédictive  les modèles] font un pas de plus vers ce concept, en vous permettant d&#39;utiliser les capacités d&#39;apprentissage automatique de  Manager de pour classifier les inconnus en personnalités distinctes. <br><br>Gestionnaire de  de vous aide à atteindre cet objectif en calculant la propension de votre  propriétaire inconnu pour un ensemble de propriétaires connus. |
| Additional [!UICONTROL Profile Merge Rules] Enhancements | [!UICONTROL Les règles] de fusion despermettent aux clients  Gestionnaire de  de définir, gérer et activer des segments de en fonction de leur identité plutôt que des périphériques. <br><br> À compter du 29 avril, les clients  Gestionnaire de  de pourront mieux comprendre la ventilation des populations d’ID de périphérique et d’ID de périphérique pour les caractéristiques et les segments au sein de la segmentation individuelle et du en vrac dans l’interface utilisateur du Gestionnaire de. <br><br> Cela permettra de mieux comprendre l’identité au sein de  Gestionnaire de  de, offrant ainsi aux clients un holistique sur la population totale de segments par appareil, personne et foyer. Les exportations de caractéristiques en bloc des ID de périphérique et des ID de périphérique seront également mises à jour pour refléter ces améliorations.<br><br>  Les mises à jour spécifiques incluent la possibilité de : <ul><li>Rapport par rapport aux ID [inter-périphériques](https://docs.adobe.com/content/help/fr-FR/audience-manager/user-guide/reference/ids-in-aam.html) dans les rapports [Général](https://docs.adobe.com/content/help/en/audience-manager/user-guide/reporting/general-reports.html) et [Tendance](https://docs.adobe.com/content/help/en/audience-manager/user-guide/reporting/trend-reports.html) ;</li><li>Améliorer le sélecteur [!UICONTROL de] caractéristiques dans le créateur [de](https://docs.adobe.com/content/help/fr-FR/audience-manager/user-guide/features/segments/segment-builder.html) segments afin d’inclure les populations de caractéristiques retirées des identifiants [](https://docs.adobe.com/content/help/fr-FR/audience-manager/user-guide/reference/ids-in-aam.html)CRM ;</li><li>Créez des exportations de caractéristiques précises sans tenir compte des ID [inter-périphériques](https://docs.adobe.com/content/help/fr-FR/audience-manager/user-guide/reference/ids-in-aam.html);</li><li>Créer des exportations de caractéristiques précises sans les identifiants [de](https://docs.adobe.com/content/help/fr-FR/audience-manager/user-guide/reference/ids-in-aam.html) périphérique (devrait exclure les caractéristiques authentifiées) ;</li><li>Renvoyer les valeurs correctes pour les caractéristiques associées aux identifiants [](https://docs.adobe.com/content/help/fr-FR/audience-manager/user-guide/reference/ids-in-aam.html) CRM lorsqu’elles sont demandées à l’aide de l’outil [BAAAM](https://docs.adobe.com/help/fr-FR/audience-manager/user-guide/reference/bulk-management-tools/bulk-management-intro.html) .</li></ul> |
