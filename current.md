...
Avec votre Adobe ID, vous pouvez vous abonner à des notifications d’événement de statut en fonction de vos produits, de votre région et de vos préférences d’événement.

| Fonction | Description |
| -----------| ---------- |
| Abonnement à des notifications en temps réel par e-mail | <ul><li>Compatible avec Experience Cloud, Creative Cloud, Document Cloud, AEP et les services Adobe</li><li>Compatible avec les paramètres de région et les préférences de type d’événement</li><li>Prise en charge de l’UX pour les interfaces Web, mobile et tablette</li></ul> |
| Gestion des préférences de notification | <ul><li>Modifiez et enregistrez vos préférences de notification à tout moment</li><li>Désabonnez-vous des notifications à tout moment</li><li>Élément</li></ul> |
| Envoi personnalisé et plus rapide des e-mails | <ul><li>Les notifications d’événement sont envoyées dès que les CSO et les CMR sont ouverts, mis à jour ou fermés.</li><li>Recevez uniquement les notifications d’événement correspondant à vos préférences</li><li>Recevez des notifications dans la langue configurée dans les préférences de votre compte</li></ul> |
| Notifications personnalisées dans l’application | Les événements correspondant à vos préférences de notification et aux produits qui vous concernent apparaissent dans le panneau des annonces. |
