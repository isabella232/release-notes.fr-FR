...
* Mise à jour des API de framework de notification utilisateur au lieu de l’API UILocalNotification, qui a été abandonnée depuis iOS 10.
...
Reportez-vous aux [Notes de mise à jour d’AppMeasurement pour Javascript](https://docs.adobe.com/content/help/fr-FR/analytics/implementation/appmeasurement-release-notes/c-release-notes-mjs.html).
...
Reportez-vous à la feuille de route de la maintenance d’AEM publiée [ici](https://helpx.adobe.com/fr/experience-manager/maintenance-releases-roadmap.html).

### Auto-assistance

**Version bêta d’Asset Link 1.1**

* [À propos de la version bêta d’Adobe Asset Link](https://helpx.adobe.com/fr/enterprise/using/adobe-asset-link-prerelease.html)
* [Configuration d’AEM pour Adobe Asset Link pour version bêta](https://helpx.adobe.com/fr/enterprise/using/configure-aem-for-aal-prerelease.html)
...
Accédez à la documentation et téléchargez [ici](https://docs.adobe.com/content/help/en/experience-manager-desktop-app/using/introduction.html).

**Balises dynamiques des ressources**

Découvrez comment mettre à jour un certificat expiré [ici](https://helpx.adobe.com/fr/experience-manager/6-5/assets/using/config-smart-tagging.html#Obtentionduncertificatpublic).

**Guide de l’utilisateur AEM 6.5 Screens**

Une nouvelle documentation sur les _directives de déploiement de réseau_ est désormais disponible. Reportez-vous [Guide de l’utilisateur](https://helpx.adobe.com/fr/experience-manager/6-5/screens/user-guide.html).

**Service de conversion automatisée de formulaires**

La documentation du service de conversion automatisée de formulaires AEM Forms est désormais disponible. Reportez-vous à [Introduction du service de conversion automatisée de formulaires](https://helpx.adobe.com/fr/experience-manager/Automated-Forms-Conversion-Service/introduction-to-automated-form-conversion-service.html).
...
Fin de vie de [!DNL Digital Publishing Suite Classic] (DPSC) le 31 août 2019. Pour plus d’informations, voir [Fin de vie de [!DNL Digital Publishing Suite Classic] – FAQ](https://helpx.adobe.com/fr/digital-publishing-suite/help/eol-statement-for-dpsc.html).
...
* [Mise à jour Campaign Classic 19.1.4](https://docs.campaign.adobe.com/doc/AC/fr/RN.html#9032) – build 9032
* [Mise à jour Campaign Classic 19.1.5](https://docs.campaign.adobe.com/doc/AC/fr/RN.html#9033) – build 9033

### [!UICONTROL Panneau de configuration] d’Adobe Campaign

Nous avons ajouté de nouvelles fonctionnalités permettant aux utilisateurs administrateurs de mettre des adresses IP en whitelist afin de se connecter aux instances Campaign Classic.
En outre, les utilisateurs administrateurs peuvent désormais afficher la liste des instances et l’éligibilité aux mises à niveau de build. Pour plus d’informations, consultez la [documentation dédiée](https://helpx.adobe.com/fr/campaign/kb/control-panel-instance-settings.html).
