...
* [Advertising Cloud](#adcloud) (mise à jour du **22 janvier 2021**)
* [[!DNL Target]](#target)
* [[!DNL Magento]](#magento)
...
Voir les [notes de mise à jour d’Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html?lang=fr) pour connaître les mises à jour les plus récentes pour :
...
| -----------| ---------- | ---------- | ---------- |
| 23 décembre 2020 | [Présentation des schémas d’union](https://experienceleague.adobe.com/docs/platform-learn/tutorials/profiles/union-schemas-overview.html?lang=fr) | Vidéo | Découvrez les schémas d’union utilisés par le profil client en temps réel d’Adobe Experience Platform. |
...
* [Nouvelles fonctionnalités d’Adobe Analytics](#aa-features) (mise à jour du 25 janvier 2021)
* [Nouvelles fonctionnalités de Customer Journey Analytics](#cust-journey) (mise à jour du 25 janvier 2021)
...
| ----------- | ---------- | ------- |
| Analysis Workspace - URL des images | 14 janvier 2021 | Vous pouvez ajouter des images à des projets [!UICONTROL Workspace] en référençant une URL d’image publique. [En savoir plus](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/visualizations/text.html?lang=fr#analysis-workspace) |
...
| Publication | Nom | Type | Description |
| -----------| ---------- | ---------- | ---------- |
| 29 décembre 2020 | [Organisation des pages](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/getting-started/organize.html?lang=fr) | Article | Utilisez [!UICONTROL Organiser les pages] dans Acrobat Document Cloud pour ajouter, remplacer, extraire, faire pivoter, supprimer et déplacer des pages dans votre PDF. |
