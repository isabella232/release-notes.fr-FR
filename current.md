...
| -----------| ---------- | ---------- |
| Limites du créateur de règles de classification | Ajout le 5 juin 2019 | Ces limites ne sont pas nouvelles, mais ont été ajoutées à la documentation [ici](https://marketing.adobe.com/resources/help/en_US/reference/classification_rule_builder.html). |
...
* Correction d&#39;un problème en raison duquel [!DNL VIEW_DATASOURCES] l&#39;autorisation était requise lorsque vous tentiez de supprimer un partenaire.
...
### [!DNL Campaign Classic] Version du printemps 19.1
...
| Sécurisation, robustesse et évolutivité | Une série d’améliorations a été apportée à [!DNL Campaign Classic]. Les améliorations apportées à l&#39;évolutivité, à la robustesse et à l&#39;évolutivité sont répertoriées dans [les Notes de mise à jour Adobe Campaign Classic](https://docs.campaign.adobe.com/doc/AC/en/RN.html). |
