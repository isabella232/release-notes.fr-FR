...
* [Services principaux Experience Cloud](#core-services)
* [Service d’identification d’Experience Cloud](#ecid)
...
* Correction d&#39;un problème dans la définition [!UICONTROL de déclencheur] pour l&#39;utilisation correcte de la clause « J&#39;aime ». (MCUI-6611)
...
### Service d’Experience Cloud ID {#ecid}
...
Fonctionnalités et correctifs dans Adobe Mobile Services :
...
* [Nouvelles fonctionnalités et correctifs dans Adobe Analytics](#aa-features)
* [Remarques importantes concernant les administrateurs Analytics](#aa-notices)
...
| -----------| ---------- |  
| Segmentation sur des comptes distincts | Vous pouvez maintenant segmenter un nombre d’éléments distinct dans une dimension. Exemples : « Visiteurs ayant consulté plus de 5 produits distincts » ou « Visites où plus de 5 pages distinctes ont été vues ». (Notez que la fonction Nombre approximatif de comptage est toujours disponible dans les mesures calculées, si vous souhaitez créer une mesure qui est un décompte distinctif d&#39;une dimension (par exemple, nombre de clients, nombre de produits, etc)). |
| Publicité - Prise en charge des analyses ad hoc pour Java 11 | Ad Hoc Analysis est désormais compatible avec Java 11. Voici quelques avertissements à l&#39;utilisation de Java 11. |
...
* Les utilisateurs voient désormais un message d&#39;erreur lorsqu&#39;ils tentent de créer un modèle [!UICONTROL algorithmique] à l&#39;aide de la ligne de base d&#39;un type de caractéristique différent d&#39;un segment à base de règles, d&#39;un segment ou d&#39;une jointure. Le message d’erreur ressemble à ce qui suit : « Seuls les caractéristiques basées sur des règles, les caractéristiques intégrées et les segments peuvent être utilisés comme référence. » (AAM-45235).
...
* Correction d&#39;un problème en raison duquel [!UICONTROL le rapport] Historique des fichiers sortants ne se chargeait pas dans certains cas (AAM -45713).
* Correction d&#39;un problème en raison duquel la caractéristique précédemment sélectionnée était ajoutée au [!UICONTROL créateur de segments] lorsque vous cliquiez sur [!UICONTROL Ajouter une caractéristique] dans un champ vide (AAM -45599).
...
| Fonction | Description |
| -----------| ---------- | 
| Rechercher dans les campagnes | Dans le sélecteur de plage de dates, le calendrier est maintenant organisé du dimanche au samedi. Auparavant, il était organisé du dimanche au samedi. |
| Rapports | Le rapport Portefeuille inclut désormais la stratégie de dépenses _de portefeuille facultative_. |
...
* Nous avons amélioré le flux de travail lorsque vous supprimez des ressources à l’aide du compositeur d’expérience visuelle. Les fichiers supprimés sont désormais supprimés de la bibliothèque Offres et de Scene 7 (le cas échéant) les fichiers supprimés ne s&#39;affichent plus dans les résultats de la recherche. (TGT-31981)
...
AEM 6.2 SP1-CFP19 (6.2.1.19), sortie le lundi 07 mars 2019, est une mise à jour importante, qui contient des correctifs client clés, publiée depuis la mise à disposition d’AEM 6.2 SP1 en décembre 2016.
...
AEM 6.3 SP 3-CFP 3 (6.3.3.3), publié le 14 mars 2019, est une mise à jour importante qui inclut le client clé corrigé depuis la publication d&#39;AEM 6.17 avril 2017.
