...
* Correction d’un problème survenant lorsque la suite de rapports que vous avez utilisée pour la dernière fois était par la suite masquée ou que vous n’aviez plus les autorisations d’accès à cette suite de rapports. In this case, you could no longer log in through Experience Cloud. (AN-181777)
...
* **AEM 6.3.3.6**
   ...
   AEM 6.3, Service Pack 3, Cumulative Fix Pack 6 (6.3.3.6, publié le 25 septembre 2019) est une mise à jour importante qui comprend les correctifs client clés publiés depuis la disponibilité générale d’AEM 6.3, avril 2017.
