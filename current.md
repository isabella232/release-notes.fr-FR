...
# RÉVISION INTERNE - Notes de mise à jour de Adobe Experience Cloud - avril 2021
...
* [Notes de mise à jour d’Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html?lang=fr). (Publié : 31 mars 2021)
...
| Mise à jour de la connexion au [!UICONTROL Report Builder] | 9 avril 2021 | Le 14 janvier 2021, la connexion [!UICONTROL Report Builder] a supprimé les dépendances des technologies héritées et aligné le processus de connexion avec l&#39;Experience Cloud. L’Experience Cloud utilise votre Enterprise ID (adresse électronique et mot de passe). Pour garantir un accès ininterrompu à [!UICONTROL Report Builder], mettez à jour le module [!UICONTROL Report Builder] vers la version 5.6.47 ou ultérieure d’ici le 22 juillet 2021. Report Builder version 5.6.47 et ultérieure ne prend en charge que la connexion de l&#39;Experience Cloud et ne prend pas en charge la connexion unique. |
...
| Avril 2021 | [Appliquer des plages de dates personnalisées aux projets de carte de performance mobile](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/additional-tools/analytics-dashboards/apply-custom-date-ranges-to-mobile-scorecard-projects.html) | Vidéo | Cette vidéo vous explique comment gérer vos différentes options pour les plages de dates lorsque vous configurez vos projets d’analyse pour les périphériques mobiles, notamment en choisissant les plages prêtes à l’emploi que vous souhaitez afficher, ainsi qu’en créant vos propres plages de dates personnalisées.Options |
...
| Publication | Nom | Type | Description |
| -----------| ---------- | ---------- | ---------- |
| Avril 2021 | [Introduction au cours - Comprendre le CDP en temps réel pour les utilisateurs d&#39;Audiences Manager](https://video.tv.adobe.com/v/332230) | Vidéo | Passer de l’Audience Manager à [!UICONTROL Plate-forme de données clientes en temps réel] (CDP en temps réel) entraîne un changement de paradigme dans certains domaines. Cette vidéo présente le cours qui vous aide à faire ce déplacement. |
...
* **Adobe Experience Manager as a Cloud Service**
   ...
   * ** Experience Manager Sites as a Cloud Service**
      ...
      * [Une version d&#39;application Web progressive (PWA) d&#39;un ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/features/enable-pwa.html) site peut désormais être activée au niveau du projet au moyen d&#39;une configuration simple.
...
| Avril 2021 | [INST : Artefacts installés par des tiers](https://experienceleague.adobe.com/docs/experience-manager-pattern-detection/table-of-contents/inst.html) | Référence | Le projet hérité repose sur un package ou un connecteur tiers et l&#39;installe dans le cadre du projet ou via le gestionnaire de packages. |
| Avril 2021 | [[!UICONTROL URC:Modes d’exécution]](https://experienceleague.adobe.com/docs/experience-manager-pattern-detection/table-of-contents/urc.html) | Référence | Exemple de présentation de la manière dont les clients peuvent rendre [!UICONTROL runmodes] la configuration conforme au service AEM cloud car désormais seuls l’auteur et la publication sont [!UICONTROL runmodes]. |
